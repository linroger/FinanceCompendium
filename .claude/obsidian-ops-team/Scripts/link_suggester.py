...
class LinkSuggester:
    def __init__(self, vault_path):
        ...
        # Sophisticated entities for institutional-quality finance education content
        self.entities = {
            'advanced_financial_concepts': [
                'stochastic processes', 'girsanov theorem', 'ito calculus', 'martingale theory',
                'risk-neutral pricing', 'asset substitution theory', 'agency costs',
                'delegated monitoring', 'financial intermediation', 'crash risk',
                'expected shortfall', 'value-at-risk', 'coherent risk measures',
                'post-libor transition', 'sonia', 'sofr', 'digital currency initiatives'
            ],
            'quantitative_methods': [
                'monte carlo simulation', 'finite difference methods', 'binomial trees',
                'trinomial models', 'black-scholes-merton', 'heston model',
                'vasicek model', 'cox-ingersoll-ross', 'hull-white model',
                'quantlib implementation', 'numerical methods', 'pde solving',
                'credit risk modeling', 'default intensity models', 'copula theory'
            ],
            'institutional_frameworks': [
                'basel iii', 'dodd-frank', 'mifid ii', 'capital requirements directive',
                'stress testing', 'ccar', 'ifrs 9', 'cecl', 'regulatory capital',
                'liquidity coverage ratio', 'net stable funding ratio', 'leverage ratio',
                'chinese financial regulatory structure', 'pboc', 'csrc', 'cbirc'
            ],
            'professional_standards': [
                'jp morgan analyst training', 'institutional quality analysis',
                'zero tolerance for errors', 'three-statement modeling',
                'accounting vs economic reality', 'gaap considerations',
                'professional practitioner approach', 'industry-standard training'
            ],
            'case_studies': [
                'precision castparts acquisition', 'bmw valuation analysis',
                'warren buffett investment philosophy', 'debt crisis analysis',
                'bridgewater big debt cycles', 'agency theory applications',
                'chinese state-owned enterprises', 'rmb internationalization'
            ],
            'mathematical_finance': [
                'probability distributions of returns', 'crash risk modeling',
                'empirical analysis 95 years data', 'statistical validation',
                'theoretical derivations', 'calculus applications',
                'optimization theory', 'convex optimization', 'lagrange multipliers',
                'financial mathematics primer', '150+ financial instruments'
            ],
            'contemporary_markets': [
                'post-libor benchmarks', 'esg integration', 'behavioral finance',
                'cryptocurrency analysis', 'defi applications', 'machine learning finance',
                'quantitative trading strategies', 'p and q model distinctions',
                'model validation', 'backtesting methodologies', 'risk management principles'
            ],
            'academic_institutions': [
                'graduate-level curricula', 'top-tier business schools',
                'institutional research standards', 'academic rigor',
                'pedagogical design', 'curriculum progression',
                'knowledge mapping', 'cross-referencing systems'
            ]
        }
    ...
    def load_notes(self):
        ...
        skip_dirs = {'.obsidian', '.trash', 'obsidian-ops-team', '.git'}
...
def main():
    ...
    parser.add_argument('--output', 
                       default='/Users/rogerlin/Reserve/VoyageNotes/obsidian-ops-team/Link_Suggestions_Report.md',
