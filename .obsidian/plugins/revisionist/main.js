...
var BaseAdapter = class {
  ...
  async generateResponse(prompt, modelApiName, options) {
    ...
    try {
      ...
      const temperature = (_a2 = options == null ? void 0 : options.temperature) != null ? _a2 : 0.7;
  ...
  async testConnection() {
    ...
    try {
      ...
      const response = await this.makeApiRequest({
        model: ((_a2 = this.models[0]) == null ? void 0 : _a2.apiName) || "",
        prompt: "Hi",
        temperature: 0.7,
        maxTokens: 10,
        rawResponse: true,
  ...
  getApiModelName(modelApiName) {
    ...
    if (!model) {
      return ((_a2 = this.models[0]) == null ? void 0 : _a2.apiName) || modelApiName;
    }
...
var OpenRouterAdapter = class extends BaseAdapter {
  ...
  extractContentFromResponse(response) {
    var _a2, _b, _c, _d;
    if (!((_d = (_c = (_b = (_a2 = response.json) == null ? void 0 : _a2.choices) == null ? void 0 : _b[0]) == null ? void 0 : _c.message) == null ? void 0 : _d.content)) {
  ...
  extractTokenCounts(response) {
    var _a2;
    const usage = (_a2 = response.json) == null ? void 0 : _a2.usage;
    return {
