...
As you review analyses and identify patterns, save firm-specific financial rules to `.quibbler/financial_rules.md` using the Write tool (or equivalent in your environment).
**When to add rules:**
...
**How to save rules:**
Use the tool to update `.quibbler/financial_rules.md`:
- If new: `### Rule: [Title]
