...
$$
\lim _ {n \to \infty} A (1 + r / n) ^ {m n} = A e ^ {r m}.
$$
...
$$
P V = c _ {0} + \frac {c _ {1}}{1 + r} + \frac {c _ {2}}{(1 + r) ^ {2}} + \dots + \frac {c _ {n}}{(1 + r) ^ {n}}
$$

where we have assumed compounding is done per period. Likewise, the future value (at  $t = n$ ) of the cash-flow is

$$
F V = P V (1 + r) ^ {n} = c _ {0} (1 + r) ^ {n} + c _ {1} (1 + r) ^ {n - 1} + c _ {2} (1 + r) ^ {n - 2} + \dots + c _ {n}.
$$
...
$$
P V = c _ {0} + \frac {c _ {1}}{(1 + r / m) ^ {m}} + \frac {c _ {2}}{(1 + r / m) ^ {2 m}} + \dots + \frac {c _ {n}}{(1 + r / m) ^ {n m}}
$$
...
$$
C _ {1} = - \sum_ {i = 0} ^ {5} \frac {1 0 0 0}{1 . 1 2 ^ {i}} + \frac {1 0 0 0}{1 . 1 2 ^ {6}} \approx - 4, 2 2 2.
$$

2. Take the new apartment where we assume a security deposit is again required. The NPV then is

$$
C _ {2} = - 9 0 0 - \sum_ {i = 0} ^ {5} \frac {9 0 0}{1 . 1 2 ^ {i}} + \frac {9 0 0}{1 . 1 2 ^ {6}} \approx - 4 7 0 0.
$$
...
$$
2 0, 0 0 0 = \sum_ {i = 0} ^ {1 9} \frac {A}{1 . 0 5 ^ {i}}.
$$
...
$$
P _ {p} \quad = \quad \sum_ {k = 1} ^ {n} P _ {k}
$$
...
$$
{C _ {p}} = {\sum_ {k = 1} ^ {n} \frac {P _ {k}}{P _ {p}} C _ {k}.}
$$
...
$$
\sum_ {k = 1} ^ {1 5} \frac {. 1}{(1 + \lambda) ^ {k}} + \frac {1}{(1 + \lambda) ^ {1 5}} > 1. 0 5.
$$
...
$$
P ^ {\prime} (0) (1 + r) = \sum_ {t} t c _ {t} d _ {t} - \bar {t} d _ {\bar {t}} = 0. \tag {15}
$$
