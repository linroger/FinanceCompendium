...
$$
V_{L} = V + \mathrm{PV} (\text{Debttaxshield}) \tag{2}
$$
...
$$
\mathrm{E}_{0}^{Q} [ \text{Equitytrancheloss} ] = 3 \times \mathrm{P} (3 \text{ormoredefaults}) + \sum_{k = 1}^{2} k \mathrm{P} (k \text{defaults})
$$

$$
\mathrm{E}_{0}^{Q} [ \text{Mezzaninetrancheloss} ] = 3 \times \mathrm{P} (6 \text{ormoredefaults}) + \sum_{k = 1}^{2} k \mathrm{P} (k + 3 \text{defaults})
$$

$$
\mathrm{E}_{0}^{Q} [ \text{Seniortrancheloss} ] = \sum_{k = 1}^{119} k \mathrm{P} (k + 6 \text{defaults}).
$$
...
$$
\mathrm{VaR}_{\alpha} = \mu + \sigma \Phi^{-1} (\alpha) \quad \text{where} \Phi \text{isthestandardnormalCDF.} \tag{15}
$$
...
$$
q_{\alpha} \left(F_{L}\right) > q_{\alpha} \left(F_{L_{1}}\right) + q_{\alpha} \left(F_{L_{1}}\right) \quad \text{ispossible}. \tag{16}
$$
