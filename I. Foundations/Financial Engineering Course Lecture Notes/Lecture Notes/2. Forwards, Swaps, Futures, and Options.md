...
title: Lecture 2 - Forwards, Swaps, Futures, and Options
tags: null
aliases:
...
key_concepts: null
cssclasses: academia
linter-yaml-title-alias: Lecture 2 - Forwards, Swaps, Futures, and Options
primary_tags:
- time models
- derivatives pricing
- swap cash-flow
...
- markets examination
- futures trader
- variance hedges futures markets
- model bounds
tags_extracted: '2025-12-18T17:54:31.654046'
...
$$
C = P \times (0, \underbrace{r_{0} - r_{f}}_{\text{Atendof } 1^{st}\text{period}},\ldots ,\underbrace{r_{M - 1} - r_{f}}_{\text{Atendof } M^{th}\text{period}})
$$
