...
$$
1 2. 6 6 = \max \left[ 1 2. 6 6, \frac {1}{R} \left(q \times 6. 5 4 + (1 - q) \times 1 8. 3 7\right) \right]
$$
...
$$
\begin{array}{l} {V _ {t} (S)} = {\max \left[ K - S, \frac {1}{R} [ q \times V _ {t + 1} (u S) + (1 - q) \times V _ {t + 1} (d S) ] \right]} \\ = \max  \left[ K - S, \frac {1}{R} \mathrm {E} _ {t} ^ {Q} \left[ V _ {t + 1} \left(S _ {t + 1}\right) \right] \right]. \\ \end{array}
$$
