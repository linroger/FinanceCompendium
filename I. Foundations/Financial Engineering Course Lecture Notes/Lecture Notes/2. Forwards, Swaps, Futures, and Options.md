...
$$
F = \frac {1 0 1 8 . 8 6}{d (0 , 2)} - \frac {5 0}{d (1 , 2)} - 5 0
$$
...
$$
C = N \times \left(0, S _ {1} - X, S _ {2} - X, \dots , S _ {M} - X\right).
$$
...
$$
V = N \sum_ {i = 1} ^ {M} d (0, i) \left(F _ {i} - X\right).
$$
...
$$
\operatorname {V a r} (Y _ {T}) = \operatorname {V a r} (Z _ {T}) + h ^ {2} \operatorname {V a r} (F _ {T}) + 2 h \operatorname {C o v} (Z _ {T}, F _ {T})
$$

and we find that the minimizing  $h$  and minimum variance are given by

$$
h ^ {*} = - \frac {\operatorname {C o v} \left(Z _ {T} , F _ {T}\right)}{\operatorname {V a r} \left(F _ {T}\right)}
$$

$$
\operatorname {V a r} (Y _ {T} ^ {*}) = \operatorname {V a r} (Z _ {T}) - \frac {\operatorname {C o v} (Z _ {T} , F _ {T}) ^ {2}}{\operatorname {V a r} (F _ {T})}.
$$
...
$$
1 0 7 x + 1. 0 1 y \quad \text {w h e n} S = 1 0 7
$$

$$
9 3. 4 6 x + 1. 0 1 y \quad \text {w h e n} S = 9 3. 4 6
$$
...
$$
0. 3 6 9 3 \times 1 0 0 - 3 4. 1 7 0 8 \times 1 \approx 2. 7 6.
$$
...
$$
C _ {0} = \frac {1}{R ^ {3}} \mathrm {E} _ {0} ^ {Q} [ \max  (S _ {T} - 1 0 0, 0) ] \tag {13}
$$
