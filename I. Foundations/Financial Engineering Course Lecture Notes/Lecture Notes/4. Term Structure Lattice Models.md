...
tags_extracted: '2025-12-18T17:54:38.772764'
...
$$
83.08 = \frac{1}{1 + 0.094} \left[ \frac{1}{2} 89.51 + \frac{1}{2} 92.22 \right].
$$
...
$$
G_{0} = \frac{\mathrm{E}_{0}^{Q} \left[ S_{n} / B_{n} \right]}{\mathrm{E}_{0}^{Q} \left[ 1 / B_{n} \right]} \tag{3}
$$
...
$$
\begin{array}{l} P_{e}(k+1, s) = \frac{P_{e}(k, s-1)}{2(1 + r_{k,s-1})} + \frac{P_{e}(k, s)}{2(1 + r_{k,s})}, \quad 0 < s < k+1 \\ P_{e}(k+1, 0) = \frac{1}{2} \frac{P_{e}(k, 0)}{(1 + r_{k,0})} \\ P_{e}(k+1, k+1) = \frac{1}{2} \frac{P_{e}(k, k)}{(1 + r_{k,k})} \\ \end{array}
$$
...
$$
\begin{array}{l} (0.022 / 1.072 \times 0.4717) + (0.004 / 1.054 \times 0.4717) + (0.0364 / 1.0864 \times 0.22) + \\ (0.0148 / 1.0648 \times 0.4438) - (0.0014 / 1.0486 \times 0.2238) = 0.0247 \text{ million}. \\ \end{array}
$$
...
$$
dY_{t} = \left(a_{t} + \frac{1}{\sigma_{t}} \frac{\partial \sigma}{\partial t} Y_{t}\right) dt + \sigma_{t} dW_{t}
$$
...
$$
\begin{array}{l} {\frac{1}{(1 + s_{i})^{i}}} = {\sum_{j=0}^{i} P_{e}(i, j)} \\ = \frac{P_{e}(i-1, 0)}{2(1 + a_{i-1})} + \sum_{j=1}^{i-1} \left(\frac{P_{e}(i-1, j)}{2(1 + a_{i-1} e^{bj})} + \frac{P_{e}(i-1, j-1)}{2(1 + a_{i-1} e^{b(j-1)})}\right) + \frac{P_{e}(i-1, i-1)}{2(1 + a_{i-1} e^{b(i-1)})}. \tag{4} \\ \end{array}
$$
...
$$
s_{1} = 7.3, \quad s_{2} = 7.62, \quad s_{3} = 8.1, \quad s_{4} = 8.45, \quad s_{5} = 9.2
$$

$$
s_{6} = 9.64, \quad s_{7} = 10.12, \quad s_{8} = 10.45, \quad s_{9} = 10.75, \quad s_{10} = 11.22
$$
