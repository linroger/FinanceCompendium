...
$$
\operatorname {V a r} (R _ {A}) = \sigma^ {2}
$$

$$
\operatorname {V a r} \left(R _ {B}\right) = \sigma^ {2} / n.
$$
...
$$
\mathbf {R} \sim \operatorname {M V N} _ {n} (\mu , \Sigma). \tag {1}
$$
...
$$
\text {s u b j e c t} \quad \mathbf {w} ^ {\prime} \mu = p
$$

$$
\text {a n d} \quad \mathbf {w} ^ {\prime} \mathbf {1} = 1.
$$
...
$$
\text {s u b j e c t} \quad \left(1 - \sum_ {i = 1} ^ {n} w _ {i}\right) r _ {f} + \mathbf {w} ^ {\prime} \mu = p.
$$
...
$$
\sigma_ {m i n} ^ {2} = \frac {(p - r _ {f}) ^ {2}}{(\mu - r _ {f} \mathbf {1}) ^ {\prime} \boldsymbol {\Sigma} ^ {- 1} (\mu - r _ {f} \mathbf {1})} \tag {5}
$$
...
$$
\left| \left| \mathbf {w} - \widehat {\mathbf {w}} \right| \right| \leq \xi \left| \left| \mu - \widehat {\mu} \right| \right| \frac {1}{\gamma_ {m i n}} \left(1 + \frac {\gamma_ {m a x}}{\gamma_ {m i n}}\right)
$$
