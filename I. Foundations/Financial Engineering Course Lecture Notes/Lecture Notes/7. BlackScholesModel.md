...
$$
e^{-rT} K + \text{CallPrice} = e^{-qT} S + \text{PutPrice}. \tag{21}
$$
...
$$
\begin{array}{l} \mathrm{P\&L} = \delta \Delta S + \frac{\Gamma}{2}(\Delta S)^2 + \text{vega}\Delta\sigma \\ = \text{deltaP\&L} + \text{gammaP\&L} + \text{vegaP\&L} \\ \end{array}
$$
