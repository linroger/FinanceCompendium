...
$$
S_{t+\Delta t} = S_t e^{\left(\mu - \frac{\sigma^2}{2}\right)\Delta t + \sigma\sqrt{\Delta t} Z}
$$
...
$$
\mathsf{P\&L} = \int_0^T \frac{S_t^2}{2} \frac{\partial^2 V_t}{\partial S^2} \left(\sigma_{imp}^2 - \sigma_t^2\right) dt \tag{24}
$$
