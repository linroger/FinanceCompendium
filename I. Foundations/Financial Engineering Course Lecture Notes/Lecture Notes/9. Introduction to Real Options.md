...
If the plant is currently in operation then shutting the plant down will incur a ramp-down cost of  $C_d$ . Similarly, if the plan is currently shut down, then moving it into a low / high production mode will incur a ramp-up cost of  $C_u$ . We use  $s_t \in \{0 \equiv \text{plantshut-down}, 1 \equiv \text{plantoperating}\}$  to denote the time  $t$  state of the plant. In each period there are two possible actions  $a \in \{0 \equiv \text{operateinshut-downmode}, 1 \equiv \text{operateinproductionmode}\}$ .
