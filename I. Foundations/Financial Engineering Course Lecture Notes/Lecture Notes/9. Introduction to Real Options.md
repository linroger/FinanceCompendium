...
$$
1 2, 0 0 0, 0 0 0 = \frac {1 0 , 0 0 0 (5 0 3 . 9 - 2 0 0)}{1 . 1} + \frac {q \times 1 1 , 5 0 0 , 0 0 0 + (1 - q) \times 7 , 4 0 0 , 0 0 0}{1 . 1}.
$$
...
$$
V _ {t} (s) = \frac {1 0 k \times \max \left\{0 , s - C \right\} + (q V _ {t + 1} (u s) + (1 - q) V _ {t + 1} (d s))}{1 + r}
$$
...
$$
U _ {t} (s) = \max \left\{V _ {t} ^ {\mathsf {e q}} (s) - 4 \mathsf {m}, \frac {1 0 \mathsf {k} \times \max \left\{0 , s - C \right\} + (q U _ {t + 1} (u s) + (1 - q) U _ {t + 1} (d s))}{1 + r} \right\}. \tag {1}
$$
...
$$
c (1, 0) = C _ {d} + K \quad , \quad u (1, 0) = 0
$$
