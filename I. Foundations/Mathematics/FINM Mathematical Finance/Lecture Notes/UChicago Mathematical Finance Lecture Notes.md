...
$$
\tilde {S} _ {0} ^ {j} = S _ {0} ^ {j} / S _ {0} ^ {1} \quad \text {a n d} \quad \tilde {S} _ {1} ^ {j} (\omega) = S _ {1} ^ {j} (\omega) / S _ {1} ^ {1} (\omega). \tag {1}
$$
...
$$
\pi (\omega) = \tilde {\pi} (\omega) \left(\frac {S _ {0} ^ {1}}{S _ {1} ^ {1} (\omega)}\right) / \delta \quad \text {a n d} \tag {5}
$$
...
$$
\phi (0) = \mathrm {S T O C K}
$$

$$
\phi (+) = \mathrm {S T O C K}
$$
...
$$
S _ {1} (+) - S _ {0} \quad \text {i n s c e n a r i o s + + , + - , a n d}
$$

$$
S _ {1} (-) - S _ {0} \quad \text {i n s c e n a r i o s - + , - -}.
$$
...
$$
0 \quad \text {i n} \quad \text {s c e n a r i o} \quad - -
$$
...
$$
S _ {2} (+ +) - S _ {1} (+) \quad \text {i n s c e n a r i o} \quad + +
$$
...
$$
\boxed {V _ {0} (\text {C A L L}) = \sum_ {n = n _ {*}} ^ {T} \left(S _ {0} d ^ {T} (u / d) ^ {n} - K\right) \binom {T} {n} p ^ {n} q ^ {T - n}.} \tag {30}
$$
...
$$
u = e ^ {\sigma / \sqrt {T}} \quad \text {a n d} \quad d = e ^ {- \sigma / \sqrt {T}}, \tag {31}
$$
...
$$
\boxed {V _ {0} (\mathrm {C A L L}) = E \left(S _ {0} e ^ {Y} - K\right) _ {+}} \tag {33}
$$

where

$$
Y \sim \operatorname {N o r m a l} \left(- \sigma^ {2} / 4, \sigma^ {2}\right). \tag {34}
$$
...
$$
M (t) := \max  \{W (s): 0 \leq s \leq t \} \quad \text {a n d} \tag {15}
$$
...
$$
W ^ {*} (t) = a W \left(t / a ^ {2}\right) \quad \text {a n d}
$$
...
$$
\mathcal {F} _ {t} := \sigma (\{W (r) \} _ {0 \leq r \leq s}) \quad \text {a n d} \quad \mathcal {F} _ {\infty} := \sigma (\{W (r) \} _ {0 \leq r <   \infty}); \tag {20}
$$
...
$$
A = \cap_ {j = 1} ^ {n} \left\{W \left(s _ {j}\right) - W \left(s _ {j - 1}\right) \leq x _ {j} \right\} \in \mathcal {F} _ {s} \quad \text {a n d}
$$
...
$$
W (s) \neq 0 \quad \text {f o r a l l r a t i o n a l t i m e s} s > 0.
$$
...
$$
P \{W (t) - W (\tau_ {a}) > 0 \mathrm {a n d} \tau_ {a} <   t \} = \frac {1}{2} P \{\tau_ {a} <   t \}.
$$
...
$$
\begin{array}{l} \tilde {W} (s) = W (s) \quad \text {f o r} s \leq \tau , \tag {31} \\ = 2 a - W (s) \quad \text {f o r} s \geq \tau . \\ \end{array}
$$
...
$$
P \{M (t) \geq a \text {a n d} W (t) \leq a - b \} = P \{W (t) \geq a + b \quad \forall a, b > 0. \tag {32}
$$
...
$$
\{M (t) \geq a \mathrm {a n d} W (t) \leq a - b \} = \{\tilde {M} (t) \geq a \mathrm {a n d} \tilde {W} (t) \geq a + b \} = \{\tilde {W} (t) \geq a + b \}.
$$
...
$$
P \{M (t) \in d a \text {a n d} W (t) \in a - d b \} = \frac {2 (a + b) \exp \left\{- (a + b) ^ {2} / 2 t \right\}}{(2 \pi) ^ {1 / 2} t} d a d b \tag {34}
$$
...
$$
W (t) <   A t \quad \text {f o r a l l} 0 \leq t <   \varepsilon .
$$
...
$$
E W (T \wedge n) = 0 \qquad \text {a n d} \qquad E W (T \wedge n) ^ {2} = E T \wedge n.
$$
...
$$
\begin{array}{l} \theta_ {s} ^ {(a, b ]} = \theta_ {s} \qquad \mathrm {i f} a <   s \leq b \\ = 0 \qquad \mathrm {o t h e r w i s e}. \\ \end{array}
$$
...
$$
\frac {d S _ {t}}{S _ {t}} = \alpha d W _ {t}, \qquad \text {e q u i v a l e n t l y},
$$
...
$$
\beta_ {t} = C _ {x} \left(S _ {t}, t\right) \quad \text {a n d} \tag {16}
$$
...
$$
\int_ {0} ^ {T} r _ {t} d t \qquad \text {a n d} \qquad \int_ {0} ^ {T} \sigma_ {t} ^ {2} d t
$$
