...
$$
\widehat {\theta} _ {n} \rightarrow \theta \mathrm {a s} n \rightarrow \infty \mathrm {w . p .} 1.
$$
...
$$
\mathbf {P} \left(\left| \widehat {\theta} _ {n} - \theta \right| \geq k\right) \leq \frac {\operatorname {V a r} \left(\widehat {\theta} _ {n}\right)}{k ^ {2}}. \tag {1}
$$
...
$$
\mathbf {P} \left(- z _ {1 - \alpha / 2} \leq Z \leq z _ {1 - \alpha / 2}\right) = 1 - \alpha
$$
...
$$
\begin{array}{l} \mathbf {P} \left(- z _ {1 - \alpha / 2} \leq \frac {\sqrt {n} (\widehat {\theta} _ {n} - \theta)}{\sigma} \leq z _ {1 - \alpha / 2}\right) \approx 1 - \alpha \\ \Rightarrow \mathbf {P} \left(- z _ {1 - \alpha / 2} \frac {\sigma}{\sqrt {n}} \leq \widehat {\theta} _ {n} - \theta \leq z _ {1 - \alpha / 2} \frac {\sigma}{\sqrt {n}}\right) \approx 1 - \alpha \\ \Rightarrow \mathbf {P} \left(\widehat {\theta} _ {n} - z _ {1 - \alpha / 2} \frac {\sigma}{\sqrt {n}} \leq \theta \leq \widehat {\theta} _ {n} + z _ {1 - \alpha / 2} \frac {\sigma}{\sqrt {n}}\right) \approx 1 - \alpha . \\ \end{array}
$$
...
$$
\widehat {\sigma} _ {n} ^ {2} = \frac {\sum_ {i = 1} ^ {n} (Y _ {i} - \widehat {\theta} _ {n}) ^ {2}}{n - 1}.
$$
...
$$
[ L (\mathbf {Y}), U (\mathbf {Y}) ] = \left[ \widehat {\theta} _ {n} - z _ {1 - \alpha / 2} \frac {\widehat {\sigma} _ {n}}{\sqrt {n}}, \quad \widehat {\theta} _ {n} + z _ {1 - \alpha / 2} \frac {\widehat {\sigma} _ {n}}{\sqrt {n}} \right] \tag {3}
$$
...
$$
C _ {0} = \mathbb {E} _ {0} ^ {Q} \left[ e ^ {- r T} \max  \left(S _ {T} - K, 0\right) \right]
$$
...
$$
U - L = \frac {2 \widehat {\sigma} _ {n} z _ {1 - \alpha / 2}}{\sqrt {n}}
$$
...
$$
\mathbf {P} \left(\widehat {\theta} _ {n} - z _ {1 - \alpha / 2} \frac {\sigma}{\sqrt {n}} \leq \theta \leq \widehat {\theta} _ {n} + z _ {1 - \alpha / 2} \frac {\sigma}{\sqrt {n}}\right) \approx 1 - \alpha .
$$
...
$$
\mathbf {P} \left(E _ {a} \leq z _ {1 - \alpha / 2} \frac {\sigma}{\sqrt {n}}\right) \approx 1 - \alpha .
$$

If we then want  $\mathbf{P}\left(E_{a} \leq \epsilon\right) \approx 1 - \alpha$ , it clearly suffices to choose  $n$  such that

$$
n = \frac {\sigma^ {2} z _ {1 - \alpha / 2} ^ {2}}{\epsilon^ {2}}.
$$
...
$$
n = \frac {\sigma^ {2} z _ {1 - \alpha / 2} ^ {2}}{\theta^ {2} \epsilon^ {2}}.
$$
...
$$
\frac {\widehat {\sigma} _ {n} z _ {1 - \alpha / 2}}{\sqrt {n}} \leq \epsilon
$$
...
$$
\frac {\widehat {\sigma} _ {n} \left(z _ {1 - \alpha / 2}\right)}{\widehat {\theta} _ {n} \sqrt {n}} \leq \epsilon .
$$
...
$$
\begin{array}{l} \mathsf {M S E} (F _ {e}) = \mathbb {E} _ {F _ {e}} \left[ \left(\frac {\sum_ {i = 1} ^ {n} Y _ {i}}{n} - \bar {y}\right) ^ {2} \right] \\ = \operatorname {V a r} _ {F _ {e}} \left(\frac {\sum_ {i = 1} ^ {n} Y _ {i}}{n}\right) (6) \\ = \frac {\operatorname {V a r} _ {F _ {e}} (Y)}{n} (7) \\ = \frac {\sum_ {i = 1} ^ {n} \left(y _ {i} - \bar {y}\right) ^ {2}}{n ^ {2}} \\ \end{array}
$$
...
$$
\text {g e n e r a t e} Y _ {1}, \dots , Y _ {n} \Vdash \text {I D f r o m} F _ {e}
$$

$$
\mathbf {s e t} \widehat {\theta} _ {i} ^ {b} = g \left(Y _ {1}, \dots , Y _ {n}\right)
$$

$$
\operatorname {s e t} Z _ {i} ^ {b} = \left[ \widehat {\theta} _ {i} ^ {b} - \theta \left(F _ {e}\right) \right] ^ {2}
$$

end for

$$
\operatorname {s e t} \widehat {\operatorname {M S E} (F)} = \sum_ {b = 1} ^ {B} Z ^ {(b)} / B
$$
...
$$
q _ {l} \leq \widehat {\theta} ^ {b} \leq q _ {u} \tag {10}
$$

is  $1 - \alpha$ . But (10) is equivalent to

$$
\widehat {\theta} - q _ {u} \leq \widehat {\theta} - \widehat {\theta} ^ {b} \leq \widehat {\theta} - q _ {l} \tag {11}
$$
...
$$
\widehat {\theta} - q _ {u} \leq \theta - \widehat {\theta} \leq \widehat {\theta} - q _ {l} \tag {12}
$$
...
$$
\left(2 \widehat {\theta} - q _ {u}, 2 \widehat {\theta} - q _ {l}\right).
$$