...
$$
p_{t} y_{t} + b_{H, t - 1} \exp \left(r_{t - 1}\right) + b_{F, t - 1} \exp \left(r_{t - 1}^{*} - e_{t}\right) = c_{t} + b_{H, t} + b_{F, t} \exp (- e_{t}), \tag {1.1}
$$
...
$$
\left(c_{t}, c_{H, t}, c_{F, t}, b_{H, t}, b_{F, t}, p_{t}, c_{t}^{*}, c_{H, t}^{*}, c_{F, t}^{*}, b_{H, t}^{*}, b_{F, t}^{*}, p_{t}^{*}, r_{t}, r_{t}^{*}, e_{t}\right)_{t = 0}^{\infty},
$$
...
$$
\begin{array}{l} \mathbb {E}_{t} \left[ r x_{t + 1} \right] = - \mathbb {E}_{t} \left[ - r x_{t + 1} \right] \\ - \operatorname{co v}_{t} \left(m_{t + 1}^{*}, \Delta e_{t + 1}\right) - \frac{1}{2} \operatorname{va r}_{t} \left(\Delta e_{t + 1}\right) = \operatorname{co v}_{t} \left(m_{t + 1}, - \Delta e_{t + 1}\right) + \frac{1}{2} \operatorname{va r}_{t} \left(\Delta e_{t + 1}\right), \tag {1.11} \\ \end{array}
$$
...
$$
r p_{t} \stackrel {\text{de f}} {=} \mathbb {E}_{t} [ r x_{t + 1} ] = - c o v_{t} \left(m_{t + 1}^{*}, \Delta e_{t + 1}\right) - \frac{1}{2} v a r_{t} \left(\Delta e_{t + 1}\right),
$$

which implies

$$
e_{t} - \mathbb {E}_{t} \left[ e_{t + 1} \right] = r_{t} - r_{t}^{*} - r p_{t}. \tag {1.12}
$$
...
$$
e_{t} = \sum_{j = 0}^{\infty} \mathbb {E}_{t} \left[ r_{t + j} - r_{t + j}^{*} \right] - \sum_{j = 0}^{\infty} \mathbb {E}_{t} \left[ r p_{t + j} \right] + \bar {e}. \tag {1.13}
$$
...
$$
\begin{array}{r l r} \text{w .r .t .} c_{H, t}: & \delta^{t} \pi u^{\prime} (c_{t}) \alpha \left(\frac{c_{F , t}}{c_{H , t}}\right)^{1 - \alpha} & = \zeta_{H, t}, \end{array}
$$

$$
\begin{array}{l l} \text{w .r .t .} c_{H, t}^{*}: & \delta^{t} (1 - \pi) u^{\prime} (c_{t}^{*}) (1 - \alpha) \left(\frac{c_{F , t}^{*}}{c_{H , t}^{*}}\right)^{\alpha} \\ & = \zeta_{H, t}, \end{array}
$$
...
$$
\begin{array}{r l r} \mathbf {w . r . t .} c_{F, t}^{*}: & \delta^{t} (1 - \pi) u^{\prime} (c_{t}^{*}) \alpha \left(\frac{c_{H , t}^{*}}{c_{F , t}^{*}}\right)^{1 - \alpha} & = \zeta_{F, t}. \end{array}
$$

Plug in the within-period solution in Section 1.A, and we obtain the following equilibrium condition:

$$
\pi u^{\prime} \left(c_{t}\right) = (1 - \pi) u^{\prime} \left(c_{t}^{*}\right) \exp \left(e_{t}\right), \tag {1.14}
$$
...
$$
c_{F, t} = \frac{(1 - \alpha) k_{t}}{\alpha + (1 - \alpha) k_{t}} y_{t}^{*}, \quad c_{F, t}^{*} = \frac{\alpha}{\alpha + (1 - \alpha) k_{t}} y_{t}^{*},
$$

and the aggregate consumption is

$$
c_{t} = \frac{\alpha^{\alpha} (1 - \alpha)^{1 - \alpha}}{\left((1 - \alpha) + \alpha k_{t}\right)^{\alpha} (\alpha + (1 - \alpha) k_{t})^{1 - \alpha}} k_{t} y_{t}^{\alpha} \left(y_{t}^{*}\right)^{1 - \alpha},
$$
...
$$
\Delta e_{t + 1} = m_{t + 1} - m_{t + 1}^{*}. \tag {1.15}
$$
...
$$
\mathbb {E}_{t} \left[ r x_{t + 1} \right] = - c o v_{t} \left(m_{t + 1}^{*}, \Delta e_{t + 1}\right) - \frac{1}{2} v a r_{t} \left(\Delta e_{t + 1}\right) = \frac{1}{2} v a r_{t} \left(m_{t + 1}^{*}\right) - \frac{1}{2} v a r_{t} \left(m_{t + 1}\right), \tag {1.16}
$$
...
$$
\begin{array}{l} c_{H, t} = \frac{\alpha \pi}{\alpha \pi + (1 - \alpha) (1 - \pi)} y_{t}, \quad c_{H, t}^{*} = \frac{(1 - \alpha) (1 - \pi)}{\alpha \pi + (1 - \alpha) (1 - \pi)} y_{t}, \\ c_{F, t} = \frac{(1 - \alpha) \pi}{(1 - \alpha) \pi + \alpha (1 - \pi)} y_{t}^{*}, \qquad c_{F, t}^{*} = \frac{\alpha (1 - \pi)}{(1 - \alpha) \pi + \alpha (1 - \pi)} y_{t}^{*}. \\ \end{array}
$$
...
$$
\begin{array}{l} m_{t + 1} = \log \delta - \Delta \log c_{t + 1} = \log \delta - \alpha \Delta \log y_{t + 1} - (1 - \alpha) \Delta \log y_{t + 1}^{*}, \\ m_{t + 1}^{*} = \log \delta - \Delta \log c_{t + 1}^{*} = \log \delta - (1 - \alpha) \Delta \log y_{t + 1} - \alpha \Delta \log y_{t + 1}^{*}, \\ \end{array}
$$
...
$$
\Delta e_{t + 1} = m_{t + 1} - m_{t + 1}^{*} = \Delta \log u^{\prime} \left(c_{t + 1}\right) - \Delta \log u^{\prime} \left(c_{t + 1}^{*}\right),
$$
...
$$
\exp (e_{t}) = \frac{\alpha}{1 - \alpha} \frac{p_{t}^{*} c_{F , t}}{p_{t} c_{H , t}},
$$

$$
\exp (- e_{t}) = \frac{\alpha}{1 - \alpha} \frac{p_{t} c_{H , t}^{*}}{p_{t}^{*} c_{F , t}^{*}}.
$$
...
$$
\exp (e_{t}) = \left(\frac{\partial u (c_{H , t} , c_{F , t}) / \partial c_{H , t}}{\partial u (c_{H , t} , c_{F , t}) / \partial c_{F , t}}\right)^{2 \alpha - 1},
$$

$$
\exp (- e_{t}) = \left(\frac{\partial u^{*} (c_{F , t}^{*} , c_{H , t}) / \partial c_{F , t}^{*}}{\partial u^{*} (c_{F , t}^{*} , c_{H , t}) / \partial c_{H , t}^{*}}\right)^{2 \alpha - 1}.
$$
...
$$
(2 \alpha - 1) \left(\log c_{t} - \log c_{t}^{*}\right) = \left(\log y_{t} - \log y_{t}^{*}\right) + 2 (1 - \alpha) \frac{2 \alpha}{2 \alpha - 1} e_{t}. \tag {1.17}
$$
...
$$
e_{t} = - \gamma \left(\log c_{t} - \log c_{t}^{*}\right) + \tau_{t}^{A M}.
$$
...
$$
\left(\frac{2 \alpha - 1}{\gamma} + 2 (1 - \alpha) \frac{2 \alpha}{2 \alpha - 1}\right) e_{t} = - \left(\log y_{t} - \log y_{t}^{*} - \frac{2 \alpha - 1}{\gamma} \tau_{t}^{A M} + \tau_{t}^{G M}\right), \tag {1.18}
$$
...
$$
\mathbb {E} \left[ r x_{t + 1}^{i} \right] \propto \beta^{i}.
$$
...
$$
x_{t}^{L i b o r} \stackrel {\mathrm{de f}} {=} l i b o r_{t}^{\mathbb {S}} - l i b o r_{t}^{i} + (f_{t}^{i} - e_{t}^{i}).
$$
...
$$
r p_{t} \stackrel {\mathrm{de f}} {=} - c o v_{t} (m_{t + 1}^{*}, \Delta e_{t + 1}) - \frac{1}{2} v a r_{t} (\Delta e_{t + 1}) = \mathbb {E}_{t} [ r x_{t + 1} ],
$$
...
$$
\mathbb {E}_{t} \left[ r x_{t + 1} \right] = 0.
$$
...
$$
r_{t} - r_{t}^{*} = \mathbb {E}_{t} \left[ - \Delta e_{t + 1} \right] + r p_{t},
$$
...
$$
m_{t + 1}^{i} = - \mu_{t}^{i} - \sqrt{\delta^{i} z_{t}^{w}} \varepsilon_{t + 1}^{w} - \sqrt{\gamma z_{t}^{i}} \varepsilon_{t + 1}^{i},
$$
...
$$
\begin{array}{l} \Delta e_{t + 1}^{i / \S} = m_{t + 1}^{i} - m_{t + 1}^{\S} \\ = - \left(\mu_{t}^{i} - \mu_{t}^{\S}\right) - \left(\sqrt{\delta^{i}} - \sqrt{\delta^{\S}}\right) \sqrt{z_{t}^{w}} \varepsilon_{t + 1}^{w} - \left(\sqrt{\gamma z_{t}^{i}} \varepsilon_{t + 1}^{i} - \sqrt{\gamma z_{t}^{\S}} \varepsilon_{t + 1}^{\S}\right). \\ \end{array}
$$
...
$$
\begin{array}{l} z_{t}^{w} = (1 - \phi) \theta^{w} + \phi z_{t - 1}^{w} + \sigma \sqrt{z_{t - 1}^{w}} \varepsilon_{t}^{w}, (3.1) \\ z_{t}^{i} = (1 - \phi) \theta + \phi z_{t - 1}^{i} + \sigma \sqrt{z_{t - 1}^{i}} \varepsilon_{t}^{i}. (3.2) \\ \end{array}
$$
...
$$
r p_{t}^{i / \$} \stackrel {\text{de f}} {=} \mathbb {E}_{t} \left[ r x_{t + 1}^{i / \$} \right] = \frac{1}{2} \left(\delta^{\$} - \delta^{i}\right) z_{t}^{w} + \frac{1}{2} \gamma \left(z_{t}^{\$} - z_{t}^{i}\right). \tag {3.3}
$$
...
$$
r_{t}^{i} - r_{t}^{\$} = \left(\chi - \frac{1}{2} \gamma\right) \left(z_{t}^{i} - z_{t}^{\$}\right) - \frac{1}{2} \left(\delta^{i} - \delta^{\$}\right) z_{t}^{w}, \tag {3.4}
$$
...
$$
r x_{t + 1}^{i / \$} = \alpha_{t}^{i} + \beta_{t}^{i} \cdot h m l_{t + 1} + \varepsilon_{t + 1}^{i},
$$
...
$$
\mathbb {E}_{t} [ r x_{t + 1}^{i} ] = \boldsymbol {\beta}^{i} \cdot \mathbb {E}_{t} [ f_{t + 1} ],
$$
...
$$
\varphi^{i} \stackrel {d e f} {=} \frac{c o v (r x_{t + 1}^{i / \S} , r_{t}^{i} - r_{t}^{\S})}{v a r (r_{t}^{i} - r_{t}^{\S})} = \frac{\frac{1}{2} \gamma (\frac{1}{2} \gamma - \chi) (v a r (z_{t}^{i}) + v a r (z_{t}^{\S})) + \frac{1}{4} (\delta^{\S} - \delta^{i})^{2} v a r (z_{t}^{w})}{(\chi - \frac{1}{2} \gamma)^{2} (v a r (z_{t}^{i}) + v a r (z_{t}^{\S})) + \frac{1}{4} (\delta^{\S} - \delta^{i})^{2} v a r (z_{t}^{w})},
$$
...
$$
\Delta e_{t + 1}^{i / \S} = \alpha^{i} + \varphi^{i} (r_{t}^{i} - r_{t}^{\S}) + \varepsilon_{t + 1}^{i}.
$$

Its slope coefficient is given by

$$
\frac{c o v (\Delta e_{t + 1}^{i / \S} , r_{t}^{i} - r_{t}^{\S})}{v a r (r_{t}^{i} - r_{t}^{\S})} = \frac{\chi (\frac{1}{2} \gamma - \chi) (v a r (z_{t}^{i}) + v a r (z_{t}^{\S}))}{(\chi - \frac{1}{2} \gamma)^{2} (v a r (z_{t}^{i}) + v a r (z_{t}^{\S})) + \frac{1}{4} (\delta^{\S} - \delta^{i})^{2} v a r (z_{t}^{w})},
$$
...
$$
\frac{c o v (\Delta e_{t + 1}^{i / \S} , r_{t}^{i} - r_{t}^{\S})}{v a r (r_{t}^{i} - r_{t}^{\S})} = \frac{\chi \left(\frac{1}{2} \gamma - \chi\right) (v a r (z_{t}^{i}) + v a r (z_{t}^{\S})) + \zeta \left(\frac{1}{2} - \zeta\right) (\delta^{i} - \delta^{\S})^{2} v a r (z_{t}^{w})}{(\chi - \frac{1}{2} \gamma)^{2} (v a r (z_{t}^{i}) + v a r (z_{t}^{\S})) + (\zeta - \frac{1}{2})^{2} (\delta^{i} - \delta^{\S})^{2} v a r (z_{t}^{w})} > 0.
$$
...
$$
\Delta \overline {{e}}_{t + 1}^{i} = m_{t + 1}^{i} - \overline {{m}}_{t + 1} = - \chi (z_{t}^{i} - \overline {{z}}_{t}) - (\sqrt{\delta^{i}} - \sqrt{\delta}) \sqrt{z_{t}^{w}} \varepsilon_{t + 1}^{w} - \sqrt{\gamma z_{t}^{i}} \varepsilon_{t + 1}^{i},
$$
...
$$
\varphi^{i / j} \stackrel {\text{de f}} {=} \frac{\operatorname{co v} \left(\Delta e_{t + 1}^{i / j} , \Delta \bar {e}_{t + 1}^{i}\right)}{\operatorname{va r} \left(\Delta \bar {e}_{t + 1}^{i}\right)} = \frac{\chi^{2} \operatorname{va r} (z_{t}^{i}) + \left(\sqrt{\delta^{i}} - \sqrt{\delta^{j}}\right) \left(\sqrt{\delta^{i}} - \sqrt{\delta}\right) \theta^{w} + \gamma \theta}{\chi^{2} \operatorname{va r} (z_{t}^{i}) + \left(\sqrt{\delta^{i}} - \sqrt{\delta}\right)^{2} \theta^{w} + \gamma \theta}.
$$
...
$$
z_{t + 1}^{i} = \Psi z_{t}^{i} + \Sigma^{1 / 2} \varepsilon_{t + 1}^{i},
$$
...
$$
\Lambda_{t}^{i} = \Lambda_{0}^{i} + \Lambda_{1}^{i} z_{t}^{i}.
$$
...
$$
u_{t} = \left\{(1 - \delta) \left(c_{t}\right)^{1 - \frac{1}{\psi}} + \delta \mathbb {E}_{t} \left[ \left(u_{t + 1}\right)^{1 - \gamma} \right]^{\frac{1 - \frac{1}{\psi}}{1 - \gamma}} \right\}^{\frac{1}{1 - \frac{1}{\psi}}}, \tag {3.5}
$$
...
$$
r_{t + 1}^{c} = \kappa_{0}^{c} + \Delta c_{t + 1} + \log \left(w c_{t + 1}\right) - \kappa_{1}^{c} \log \left(w c_{t}\right), \tag {3.6}
$$
...
$$
\log \left(w c_{t}\right) = \mu_{w c} + W_{x} x_{t} + W_{\sigma} \left(\sigma_{t}^{2} - \sigma^{2}\right), \tag {3.7}
$$

where

$$
\begin{array}{l} W_{x} = \frac{1 - \frac{1}{\psi}}{\kappa_{1}^{c} - \rho}, \\ W_{\sigma} = \frac{(1 - \gamma) \left(1 - \frac{1}{\psi}\right)}{2 (\kappa_{1}^{c} - \phi)} \left(\frac{\varphi_{e}^{2}}{(\kappa_{1}^{c} - \rho)^{2}} + \frac{2 \nu \varphi_{e}}{\kappa_{1}^{c} - \rho} + 1\right), \\ \end{array}
$$
...
$$
\begin{array}{l} r_{t + 1}^{c} = \kappa_{0}^{c} + \Delta c_{t + 1} + \log (w c_{t + 1}) - \kappa_{1}^{c} \log (w c_{t}), \\ m_{t + 1} = \theta \log \delta - \frac{\theta}{\psi} \Delta c_{t + 1} + (\theta - 1) r_{t + 1}^{c}, \\ 1 = \mathbb {E}_{t} [ \exp (m_{t + 1} + r_{t + 1}^{c}) ], \\ \end{array}
$$
...
$$
\begin{array}{l} r p_{t} \stackrel {\text{de f}} {=} \mathbb {E}_{t} [ r x_{t + 1} ] = \frac{1}{2} (v a r_{t} \left(m_{t + 1}^{*}\right) - v a r_{t} \left(m_{t + 1}\right)) \\ = \frac{1}{2} \left[ \gamma^{2} + (\theta - 1)^{2} W_{x}^{2} \varphi_{e}^{2} - 2 \nu \gamma (\theta - 1) W_{x} \varphi_{e} \right] (\sigma_{t}^{* 2} - \sigma_{t}^{2}), \\ \end{array}
$$

the interest rate differential is

$$
\begin{array}{l} r_{t} - r_{t}^{*} = \left(- \mathbb {E}_{t} [ m_{t + 1} ] - \frac{1}{2} v a r_{t} (m_{t + 1})\right) - \left(- \mathbb {E}_{t} [ m_{t + 1}^{*} ] - \frac{1}{2} v a r_{t} (m_{t + 1}^{*})\right) \\ = \left\{- \frac{\theta}{\psi} + (\theta - 1) [ 1 + W_{x} (\rho - \kappa_{1}^{c}) ] \right\} (x_{t}^{*} - x_{t}) \\ + \left\{W_{\sigma} (\phi - \kappa_{1}^{c}) (\theta - 1) + \frac{1}{2} \gamma^{2} + \frac{1}{2} (\theta - 1)^{2} W_{x}^{2} \varphi^{2} - \nu \gamma (\theta - 1) W_{x} \varphi \right\} (\sigma_{t}^{* 2} - \sigma_{t}^{2}), \\ \end{array}
$$

and the Backus-Smith coefficient is

$$
\begin{array}{l} \beta_{t}^{B S} = \frac{\operatorname{co v}_{t} \left(\Delta e_{t + 1} , \Delta c_{t + 1}^{*} - \Delta c_{t + 1}\right)}{\operatorname{va r}_{t} \left(\Delta c_{t + 1}^{*} - \Delta c_{t + 1}\right)} \\ = \gamma + \nu \frac{\varphi_{e} (1 - \theta) W_{x}}{v a r_{t} (\sigma_{t}^{*} \varepsilon_{g , t + 1}^{*} - \sigma_{t} \varepsilon_{g , t + 1})} \left(\sigma_{t}^{2} + \sigma_{t}^{* 2}\right). \\ \end{array}
$$
...
$$
\bar {x}_{t}^{i} = a_{t}^{i} \left(\ell_{t}^{i}\right)^{\theta^{i}} \left(\prod_{j = 1}^{N} \left(x_{j t}^{i}\right)^{w_{i j}}\right), \tag {3.8}
$$
...
$$
\vec{c}_{t}^{i} = \prod_{j = 1}^{N} \left(c_{j t}^{i}\right)^{v_{i j}}, \tag {3.9}
$$
...
$$
\sum_{i = 1}^{N} \pi^{i} \log \bar {c_{t}^{i}} + \varphi_{t}^{i} \left(a_{t}^{i} \left(\ell_{t}^{i}\right)^{\theta^{i}} \left(\prod_{j = 1}^{N} \left(x_{j t}^{i}\right)^{w_{i j}}\right) - \sum_{j = 1}^{N} \left(c_{i t}^{j} + x_{i t}^{j}\right) - d_{t}^{i}\right) + \chi^{i} (\overline {{\ell}}^{i} - \ell_{t}^{i}),
$$
...
$$
\begin{array}{l l} \text{w .r .t .} c_{i t}^{j}: & \pi^{j} v_{j i} (c_{i t}^{j})^{- 1} = \varphi_{t}^{i}, \end{array}
$$

$$
\begin{array}{c c} \text{w .r .t .} x_{i t}^{j}: & \varphi_{t}^{j} \bar {x}_{t}^{j} w_{j i} (x_{i t}^{j})^{- 1} = \varphi_{t}^{i}, \end{array}
$$
...
$$
\Delta \overline {{e}}_{t}^{i} = \frac{1}{N} \sum_{j = 1}^{N} \Delta e_{t}^{i / j}.
$$
...
$$
\begin{array}{l} c o v \left(\Delta \vec{e}_{t}^{i}, \Delta \vec{e}_{t}^{j}\right) = \mathcal {C} (i, j) - \overline {{\mathcal {C}}} (i) - \overline {{\mathcal {C}}} (j) + \kappa^{e}, \\ v a r (\Delta e_{t}^{i / j}) = - 2 \mathcal {C} (i, j) + \mathcal {C} (i, i) + \mathcal {C} (j, j), \\ \end{array}
$$
...
$$
\begin{array}{l} r p_{t}^{i / \S} \stackrel {\text{de f}} {=} \mathbb {E}_{t} \left[ r x_{t + 1}^{i / \S} \right] = \frac{1}{2} (v a r_{t} (m_{t + 1}^{\S}) - v a r_{t} (m_{t + 1}^{i})) \\ = \frac{1}{2} \left(\mathcal {C} (\mathrm{\$}, \mathrm{\$}) - \mathcal {C} (i, i)\right), \\ \end{array}
$$
...
$$
\Delta e_{t + 1}^{1 / 2} = - 1. 6 0 \varepsilon_{t + 1}^{(1)} + 1. 6 0 \varepsilon_{t + 1}^{(2)},
$$

$$
\Delta e_{t + 1}^{1 / 3} = - 1. 3 3 \varepsilon_{t + 1}^{(1)} + 1. 3 3 \varepsilon_{t + 1}^{(3)},
$$

$$
\Delta e_{t + 1}^{1 / 4} = - 1. 1 4 \varepsilon_{t + 1}^{(1)} + 1. 1 4 \varepsilon_{t + 1}^{(4)},
$$
...
$$
\varphi_{t}^{i} \epsilon_{i t}^{j} = \pi^{j} v_{j i}
$$
...
$$
\varphi_{t} \overline {{x}}_{t} = H^{\prime} \pi + \left(I - W^{\prime}\right)^{- 1} d_{t},
$$
...
$$
\begin{array}{l} \exp (m_{t, t + h}) \stackrel {\text{de f}} {=} \delta^{h} \frac{u^{\prime} (c_{t + h})}{u^{\prime} (c_{t})}, \\ \exp (m_{t, t + h}^{*}) \stackrel {\text{de f}} {=} \delta^{h} \frac{u^{\prime} (c_{t + h}^{*})}{u^{\prime} (c_{t}^{*})}, \\ \end{array}
$$

then, the Euler equations can be written as

$$
\begin{array}{l} 1 = \mathbb {E}_{t} \left[ \exp (m_{t, t + h}) \exp (r_{t} (h) h) \right], \\ 1 = \mathbb {E}_{t} \left[ \exp \left(m_{t, t + h}^{*}\right) \exp \left(- \Delta e_{t, t + h} + r_{t} (h) h\right) \right]. \\ \end{array}
$$
...
$$
r x_{h}^{(h)} (h) \stackrel {\mathrm{de f}} {=} \Delta e_{0, h} + h (r_{0} (h) - r_{0}^{*} (h)).
$$
...
$$
\frac{\log \beta}{1 - \phi} = \frac{1}{2} \left(\gamma v_{P}\right)^{2} + \log \delta - \mu \gamma ,
$$
...
$$
m c_{t}^{P} = m c_{t - 1}^{P} - \frac{1}{2} \sigma_{P}^{2} + \sigma_{P} \varepsilon_{t}^{P}, \tag {3.13}
$$

$$
m c_{t}^{T} = \bar {m c}^{T} + \phi m c_{t - 1}^{T} + t \log \beta + \sigma_{T} \varepsilon_{t}^{T}, \tag {3.14}
$$
...
$$
\exp \left(m c_{t}^{T}\right) = \lim_{h \rightarrow \infty} \frac{\tilde {\delta}^{t + h}}{p_{t} (h)}, \tag {3.15}
$$
...
$$
\lim_{h \rightarrow \infty} \frac{p_{t + 1} (h - 1)}{p_{t} (h)} = \exp \left(m c_{t}^{T} - m c_{t + 1}^{T}\right). \tag {3.16}
$$
...
$$
\lim_{h \rightarrow \infty} r_{t} (h) + \log \tilde {\delta} = 0, \tag {3.17}
$$

and

$$
\lim_{h \rightarrow \infty} \left(r_{t} (h) + \log \tilde {\delta}\right) h = \sum_{i = 0}^{\infty} \phi^{i} \sigma_{T} \varepsilon_{t - i}^{T} - \frac{1}{2 - 2 \phi^{2}} \sigma_{T}^{2} - \frac{1}{1 - \phi} \sigma_{T P}. \tag {3.18}
$$
...
$$
\lim_{h \rightarrow \infty} \frac{p_{t + 1} (h - 1)}{p_{t} (h)} = \exp \left(m c_{t}^{T} - m c_{t + 1}^{T}\right),
$$
...
$$
\Delta e_{t}^{P} \stackrel {\text{de f}} {=} \Delta m c_{t}^{P} - \Delta m c_{t}^{P, *},
$$

$$
\Delta e_{t}^{T} \stackrel {\mathrm{de f}} {=} \Delta m c_{t}^{T} - \Delta m c_{t}^{T, *}.
$$
...
$$
\lim_{h \rightarrow \infty} \left(\Delta r_{t} (h) - \Delta r_{t}^{*} (h)\right) = 0. \tag {3.19}
$$
...
$$
e_{t} - \bar {e} = \lim_{h \rightarrow \infty} h \left(r_{t} (h) - r_{t}^{*} (h)\right). \tag {3.20}
$$
...
$$
\lim_{h \rightarrow \infty} \left(h r_{t} (h) - \sum_{j = 0}^{h - 1} \mathbb {E}_{t} [ r_{t + j} ]\right) - \lim_{h \rightarrow \infty} \left(h r_{t}^{*} (h) - \sum_{j = 0}^{h - 1} \mathbb {E}_{t} [ r_{t + j}^{*} ]\right) = - \sum_{j = 0}^{\infty} \mathbb {E}_{t} [ r p_{t + j} ].
$$
...
$$
\mathbb {E}_{t} \left[ M_{t, t + h}^{*} \right] = \exp \left(h \left(a_{h} + b_{h} e_{t}\right)\right)
$$

with the boundary condition  $a_0 = b_0 = 0$ . By iteration,

$$
\mathbb {E}_{t} \left[ M_{t, t + h}^{*} \right] = \mathbb {E}_{t} \left[ \exp (- \mu + \phi e_{t}) \mathbb {E}_{t + 1} \left[ M_{t + 1, t + h}^{*} \right] \right]
$$

$$
= \mathbb {E}_{t} [ \exp (- \mu + \phi e_{t}) \exp ((h - 1) (a_{h - 1} + b_{h - 1} e_{t + 1})) ]
$$
...
$$
\begin{array}{l} \lim_{h \to \infty} r x_{t} (h) = \frac{1}{2} \sigma_{T}^{2} + \sigma_{T P}, \\ \lim_{h \to \infty} r x_{t}^{y} (h) = \frac{2 \gamma - 1}{2 \gamma^{2}} \sigma_{P}^{2} + \frac{1}{2} \sigma_{T}^{2} + \sigma_{T P}. \\ \end{array}
$$
...
$$
\exp \left(- \lambda_{t}^{*}\right) = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1}^{*} + \Delta e_{t + 1} + r_{t}\right) \right].
$$
...
$$
1 = \mathbb {E}_{t} [ \exp (m_{t + 1} + \rho_{t}) ] > \mathbb {E}_{t} [ \exp (m_{t + 1} + r_{t}) ].
$$
...
$$
\exp (- \lambda_{t}) = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1} + r_{t}\right) \right]. \tag {4.1}
$$
...
$$
\begin{array}{l} \mathbb {E}_{0} \left[ \sum_{t = 1}^{\infty} \delta^{t} \left(u \left(c_{t}\right) + v \left(b_{H, t}; \theta_{t}\right)\right) \right. \\ \left. + \sum_{t = 1}^{\infty} \zeta_{t} (p_{t} y_{t} + \bar {b}_{t} + b_{H, t - 1} \exp (r_{t - 1}) + b_{F, t - 1} \exp (r_{t - 1}^{*} - e_{t}) - c_{t} - \bar {b}_{t - 1} \exp (r_{t - 1}) - b_{H, t} - b_{F, t} \exp (- e_{t})) \right]. \\ \end{array}
$$

The first-order conditions w.r.t.  $c_{t}, b_{H,t}$  and  $b_{F,t}$  are

$$
\delta^{t} u^{\prime} (c_{t}) - \zeta_{t} = 0,
$$

$$
\begin{array}{l} \mathbb {E}_{t} \left[ \delta^{t} v^{\prime} \left(h_{H, t}; \theta_{t}\right) - \zeta_{t} + \zeta_{t + 1} \exp (r_{t}) \right] = 0, \\ \mathbb {E}_{t} \left[ - \zeta_{t} \exp \left(- r_{t}^{*} - e_{t}\right) + \zeta_{t + 1} \exp \left(- e_{t + 1}\right) \right] = 0. \\ \end{array}
$$
...
$$
\exp (- \lambda_{t}) = \mathbb {E}_{t} [ \exp (m_{t + 1}) \exp (r_{t}) ],
$$
...
$$
\left(c_{F, t}^{*}\right)^{\alpha} \left(c_{H, t}^{*}\right)^{1 - \alpha} = p_{t} c_{H, t}^{*} \exp (e_{t}) + p_{t}^{*} c_{F, t}^{*},
$$
...
$$
1 = \mathbb {E}_{t} \left[ \exp \big (m_{t + 1} - \Delta e_{t + 1} + r_{t}^{*} \big) \right],
$$
...
$$
1 = \mathbb {E}_{t} \left[ \exp \big (m_{t + 1}^{*} + \Delta e_{t + 1} + (r_{t} + \lambda_{t}^{*}) \big) \right],
$$
...
$$
\pi u^{\prime} (c_{t}) = (1 - \pi) u^{\prime} (c_{t}^{*}) \exp (e_{t}).
$$
...
$$
1 = \mathbb {E}_{t} \left[ \exp \big (m_{t + 1} - f_{t} + e_{t} + r_{t}^{*} \big) \right]
$$
...
$$
x_{t}^{T r e a s} \stackrel {\mathrm{de f}} {=} r_{t} - \left(r_{t}^{*} - f_{t} + e_{t}\right) = - \lambda_{t}^{*} <   0.
$$
...
$$
x_{t}^{T r e a s} \stackrel {\mathrm{de f}} {=} r_{t} - (r_{t}^{*} - f_{t} + e_{t}) = - (1 - \beta^{*}) \lambda_{t}^{*} <   0,
$$
...
$$
\begin{array}{l} \exp \left(- \gamma^{*} \lambda_{t}^{*}\right) = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1}^{*} + \Delta e_{t + 1} - l i b o r_{t}\right) \right], \\ \exp \left(- \beta^{*} \lambda_{t}^{*}\right) = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1}^{*} + \Delta e_{t + 1} - f_{t} + e_{t} + l i b o r_{t}^{*}\right) \right]; \\ \end{array}
$$
...
$$
\begin{array}{l} x_{t}^{T r e a s} = - (1 - \beta^{*}) \lambda_{t}^{*}, \\ x_{t}^{\text{Li bo r}} = - \left(\gamma^{*} - \beta^{*}\right) \lambda_{t}^{*}. \\ \end{array}
$$
...
$$
1 - \frac{v^{\prime} (q_{t} (1) ; \theta_{t})}{u^{\prime} (c_{t})} = \mathbb {E}_{t} \left[ \exp (m_{t, t + 1}) \frac{1}{p_{t} (1)} \right],
$$
...
$$
1 - \mathbb {E}_{t} \left[ \delta \frac{p_{t + 1} (1)}{p_{t} (2)} \frac{v^{\prime} (q_{t + 1} (1) ; \theta_{t + 1})}{u^{\prime} (c_{t})} \right] = \mathbb {E}_{t} \left[ \exp (m_{t, t + 2}) \frac{1}{p_{t} (2)} \right],
$$
...
$$
e_{t} - e_{0} = \sum_{k = 1}^{t} (m_{k} - m_{k}^{*}) + \sum_{k = 1}^{t} \eta_{k}.
$$
...
$$
\begin{array}{l} d y_{t} = \mu_{y} y_{t} d t + \sigma_{y} y_{t} d Z_{t}^{y}, \\ d y_{t}^{*} = \mu_{y^{*}} y_{t}^{*} d t + \sigma_{y^{*}} y_{t}^{*} d Z_{t}^{y^{*}}. \\ \end{array}
$$
...
$$
\left(y_{t}, y_{t}^{*}, \gamma_{t}\right)_{t = 0}^{t}
$$
...
$$
\exp (m_{t}) \stackrel {\mathrm{de f}} {=} \exp (- \delta t) \frac{\gamma_{t} c_{0}}{\gamma_{0} c_{t}},
$$
...
$$
\text{s .t .} \quad \mathbb {E} \left[ \int_{0}^{T} \exp \left(m_{\tilde {v}, t}\right) \left(\tilde {c}_{t}^{*} - p_{t}^{*} \exp (- e_{t}) y_{t}^{*}\right) d t \right] \leq \tilde {W}_{0}^{*},
$$
...
$$
\mathbb {E}_{t} \left[ \eta_{t + 1} \right] + \frac{1}{2} \operatorname{va r}_{t} \left(\eta_{t + 1}\right) + \operatorname{co v}_{t} \left(m_{t + 1}, \eta_{t + 1}\right) = 0. \tag {5.10}
$$
...
$$
v a r_{t} (\Delta e_{t + 1}) = v a r_{t} (m_{t + 1} - m_{t + 1}^{*}) - v a r_{t} (\eta_{t + 1}).
$$
...
$$
\mathbb {E}_{t} \left[ r x_{t + 1} \right] = \frac{1}{2} \left(v a r_{t} \left(m_{t + 1}^{*}\right) - v a r_{t} \left(m_{t + 1}\right)\right) + \mathbb {E}_{t} \left[ \eta_{t + 1} \right].
$$
...
$$
\operatorname{va r}_{t} \left(\Delta e_{t + 1}\right) = \operatorname{va r}_{t} \left(m_{t + 1} - m_{t + 1}^{*}\right),
$$

$$
\begin{array}{l} c o v_{t} (m_{t + 1} - m_{t + 1}^{*}, \Delta e_{t + 1}) = v a r_{t} (\Delta e_{t + 1}), \\ \mathbb {E}_{t} [ r x_{t + 1} ] = \frac{1}{2} (v a r_{t} (m_{t + 1}^{*}) - v a r_{t} (m_{t + 1})). \\ \end{array}
$$
...
$$
c o v_{t} \left(m_{t + 1} - m_{t + 1}^{*}, \Delta e_{t + 1}\right) = c o v_{t} \left(y_{t} m_{t + 1} + z_{t} m_{t + 1}^{*}, m_{t + 1} - m_{t + 1}^{*}\right).
$$

(c) Using the Euler equations (1.6)-(1.9), the conditional currency risk premium can be expressed as

$$
r p_{t} \stackrel {{d e f}} {{=}} \mathbb {E}_{t} [ r x_{t + 1} ] = - \frac{1}{2} c o v_{t} (y_{t} m_{t + 1} + z_{t} m_{t + 1}^{*}, m_{t + 1} + m_{t + 1}^{*}).
$$
...
$$
\operatorname{va r}_{t} \left(\Delta e_{t + 1}^{c m}\right) = \operatorname{va r}_{t} \left(m_{t + 1} - m_{t + 1}^{*}\right),
$$

$$
\begin{array}{l} c o v_{t} \left(m_{t + 1} - m_{t + 1}^{*}, \Delta e_{t + 1}^{c m}\right) = v a r_{t} \left(m_{t + 1} - m_{t + 1}^{*}\right), \\ r p_{t}^{c m} = - \frac{1}{2} c o v_{t} (m_{t + 1} - m_{t + 1}^{*}, m_{t + 1} + m_{t + 1}^{*}) = \frac{1}{2} v a r_{t} (m_{t + 1}^{*}) - \frac{1}{2} v a r_{t} (m_{t + 1}), \\ \end{array}
$$
...
$$
\operatorname{var}_{t} \left(\Delta e_{t + 1}\right) \leq 1 \% \cdot \operatorname{var}_{t} \left(m_{t + 1}\right). \tag{5.14}
$$
...
$$
y_{t} \left(y_{t} - 1\right) v a r_{t} \left(m_{t + 1}\right) + z_{t} \left(z_{t} + 1\right) v a r_{t} \left(m_{t + 1}^{*}\right) +
$$
...
$$
\begin{array}{l} 1 = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1}^{(1)} + r_{t}^{(1)}\right) \right], \\ 1 = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1}^{(1)} - \Delta e_{t + 1}^{2 / 1} + r_{t}^{(2)}\right) \right], \\ 1 = \mathbb {E}_{t} \left[ \exp (m_{t + 1}^{(2)} + r_{t}^{(2)}) \right], \\ 1 = \mathbb {E}_{t} \left[ \exp (m_{t + 1}^{(2)} + \Delta e_{t + 1}^{2 / 1} + r_{t}^{(1)}) \right]. \\ \end{array}
$$
...
$$
1 = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1}^{(2)} - \Delta e_{t + 1}^{2 / 1} + r_{t}^{(1)}\right) \right] = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1}^{(1)} + \Delta e_{t + 1}^{2 / 1} + r_{t}^{(2)}\right) \right]. \tag {5.20}
$$
...
$$
\exp \left(M_{t + 1}\right) \stackrel {\text{de f}} {=} \frac{P_{t}}{P_{t + 1}} \exp \left(m_{t + 1}\right), \tag {6.1}
$$
...
$$
\begin{array}{l} i_{t} = - \mathbb {E}_{t} [ m_{t + 1} ] - \frac{1}{2} v a r_{t} (m_{t + 1}) + \mathbb {E}_{t} [ \pi_{t + 1} ] - \frac{1}{2} v a r_{t} (\pi_{t + 1}) + c o v_{t} (m_{t + 1}, \pi_{t + 1}) \\ = r_{t} + \mathbb {E}_{t} \left[ \pi_{t + 1} \right] + i r p_{t}, \tag {6.2} \\ \end{array}
$$
...
$$
\mathbb {E}_{t} [ R X_{t + 1} ] = - c o v_{t} (M_{t + 1}^{*}, \Delta \mathcal {E}_{t + 1}) - \frac{1}{2} v a r_{t} (\Delta \mathcal {E}_{t + 1}).
$$
...
$$
\mathbb {E}_{0} \sum_{t = 0}^{\infty} \delta^{t} u_{t} (j) \stackrel {\text{de f}} {=} \mathbb {E}_{0} \sum_{t = 0}^{\infty} \delta^{t} \left(\log c_{t} (j) - \kappa \frac{\ell_{t} (j)^{1 + \nu}}{1 + \nu}\right),
$$
...
$$
\exp (M_{t + 1}) \stackrel {\text{de f}} {=} \delta \frac{P_{t} c_{t} (j)}{P_{t + 1} c_{t + 1} (j)},
$$

which is related to its real SDF, defined as

$$
\exp (m_{t + 1}) \stackrel {\text{de f}} {=} \delta \frac{c_{t}}{c_{t + 1}},
$$
...
$$
D_{t} (h) = \left(p_{t} (h) - M C_{t}\right) \left(\frac{p_{t} (h)}{P_{H , t}}\right)^{- \rho} c_{H, t} + \left(\exp \left(\mathcal {E}_{t}\right) p_{t}^{*} (h) - M C_{t}\right) \left(\frac{p_{t}^{*} (h)}{P_{H , t}^{*}}\right)^{- \rho} c_{H, t}^{*}. \tag {6.3}
$$
...
$$
Q_{t} + P_{t} g_{t} = P_{t} \tau_{t} + Q_{t + 1} \exp (- i_{t}). \tag {6.4}
$$
...
$$
\frac{Q_{t}}{P_{t}} = \mathbb {E}_{t} \left[ \sum_{k = 0}^{\infty} \exp (m_{t, t + k}) s_{t + k} \right] + \lim_{T \to \infty} \mathbb {E}_{t} \left[ \exp (m_{t, t + T}) \frac{Q_{t + T}}{P_{t + T}} \right].
$$

The transversality condition requires that the terminal value in the intertemporal budget condition vanishes:

$$
\lim_{T \to \infty} \mathbb {E}_{t} \left[ \exp (m_{t, t + T}) \frac{Q_{t + T}}{P_{t + T}} \right] = 0,
$$

which is equivalent to requiring that the present value of government surpluses grows slower than the real discount rate:

$$
\lim_{T \rightarrow \infty} \mathbb {E}_{t} \left[ \exp (m_{t, t + T}) \left(\sum_{k = 0}^{\infty} \exp (m_{t + T, t + T + k}) s_{t + T + k}\right)\right] = 0.
$$
...
$$
\frac{Q_{t}}{P_{t}} = \mathbb {E}_{t} \left[ \sum_{k = 0}^{\infty} \exp \left(m_{t, t + k}\right) s_{t + k} \right]. \tag {6.5}
$$
...
$$
\begin{array}{l} 1 = \mathbb {E}_{t} \left[ \exp \left(M_{t + 1}\right) \exp (i_{t}) \right] = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1}\right) \frac{P_{t}}{P_{t + 1}} \exp (i_{t}) \right] \\ \exp (- i_{t}) = \mathbb {E}_{t} \left[ \exp (m_{t + 1}) \frac{P_{t}}{P_{t + 1}} \right], \\ \end{array}
$$
...
$$
q_{t} + g_{t} = \tau_{t} + q_{t + 1} \exp (\pi_{t + 1} - i_{t}).
$$
...
$$
y_{t} = \alpha \frac{P_{t}}{P_{H , t}} \left(c_{t} + g_{t}\right) + (1 - \alpha) \frac{P_{t}^{*}}{P_{H , t}^{*}} \left(c_{t}^{*} + g_{t}^{*}\right). \tag {6.6}
$$

The market clearing condition for the home government bond is

$$
\int_{0}^{1} \Omega_{t} \left(\sigma_{t + 1}, j\right) d j + \int_{0}^{1} \Omega_{t} \left(\sigma_{t + 1}, j^{*}\right) d j^{*} = Q_{t + 1}, \quad \forall \sigma_{t + 1}. \tag {6.7}
$$
...
$$
\frac{1}{P_{t}} = \frac{1}{Q_{t}} \mathbb {E}_{t} \left[ \sum_{k = 0}^{\infty} \delta^{k} \frac{c_{t}}{c_{t + k}} s_{t + k} \right], \tag {6.8}
$$
...
$$
P_{H, t} = \exp (\mathcal {E}_{t}) P_{H, t}^{*} = \frac{\rho}{\rho - 1} \frac{W_{t}}{z_{t}}, \tag {6.10}
$$

$$
P_{F, t}^{*} = \exp (- \mathcal {E}_{t}) P_{F, t} = \frac{\rho}{\rho - 1} \frac{W_{t}^{*}}{z_{t}^{*}}. \tag {6.11}
$$
...
$$
P_{H, t} = \exp \left(\mathcal {E}_{t}\right) P_{H, t}^{*} = \frac{\rho}{\rho - 1} \mathbb {E}_{t - 1} \left[ M C_{t} \right], \tag {6.12}
$$

$$
P_{F, t}^{*} = \exp (- \mathcal {E}_{t}) P_{F, t} = \frac{\rho}{\rho - 1} \mathbb {E}_{t - 1} \left[ M C_{t}^{*} \right]. \tag {6.13}
$$
...
$$
\begin{array}{l} c_{t} = \bar {\ell} \alpha^{\alpha} (1 - \alpha)^{1 - \alpha} \frac{(P_{t} c_{t})^{\alpha} (P_{t}^{*} c_{t}^{*})^{1 - \alpha}}{(\mathbb {E}_{t - 1} [ P_{t} c_{t} \ell_{t}^{\nu} / z_{t} ])^{\alpha} (\mathbb {E}_{t - 1} [ P_{t}^{*} c_{t}^{*} (\ell_{t}^{*})^{\nu} / z_{t}^{*} ])^{1 - \alpha}}, \\ c_{t}^{*} = \bar {\ell} \alpha^{\alpha} (1 - \alpha)^{1 - \alpha} \frac{(P_{t} c_{t})^{1 - \alpha} (P_{t}^{*} c_{t}^{*})^{\alpha}}{(\mathbb {E}_{t - 1} [ P_{t} c_{t} \ell_{t}^{\nu} / z_{t} ])^{1 - \alpha} (\mathbb {E}_{t - 1} [ P_{t}^{*} c_{t}^{*} (\ell_{t}^{*})^{\nu} / z_{t}^{*} ])^{\alpha}}, \\ \end{array}
$$

which implies

$$
\begin{array}{l} \log c_{t} = \kappa_{t - 1}^{c} + \alpha \log \left(P_{t} c_{t}\right) + (1 - \alpha) \log \left(P_{t}^{*} c_{t}^{*}\right), \\ \log c_{t}^{*} = \kappa_{t - 1}^{c_{*}^{*}} + \alpha \log \left(P_{t}^{*} c_{*}^{*}\right) + (1 - \alpha) \log \left(P_{t} c_{t}\right), \\ e_{t} = \kappa_{t - 1}^{e} + (2 \alpha - 1) \log \left(P_{t} c_{t}\right) - (2 \alpha - 1) \log \left(P_{t}^{*} c_{t}^{*}\right), \\ \end{array}
$$
...
$$
\frac{1}{P_{t} c_{t}} = \exp (i_{t}) \mathbb {E}_{t} \left[ \delta \frac{1}{P_{t + 1} c_{t + 1}} \right]. \tag {6.14}
$$
...
$$
\log c_{t} = \tilde {\kappa}_{t - 1}^{c} - \alpha i_{t} - (1 - \alpha) i_{t}^{*},
$$
...
$$
r_{t} (k) = - \log \mathbb {E}_{t} [ \delta c_{t} / c_{t + k} ] = - \log \left(c_{t} \mathbb {E}_{t} [ \delta / c_{t + k} ]\right).
$$
...
$$
P_{t} c_{t} = \frac{Q_{t} c_{t}}{s_{t} + c_{t} A}. \tag {6.15}
$$
...
$$
r_{t} = - \log \delta - \log \mathbb {E}_{t} [ 1 / c_{t + 1} ] - \kappa_{c} + \frac{((1 - \alpha) \bar {s} / A + \alpha \bar {c})}{\bar {c} (A \bar {c} + (1 - \alpha) 2 \bar {s})} s_{t} + \frac{(1 - \alpha) (\bar {c} + \bar {s} / A)}{\bar {c} (A \bar {c} + (1 - \alpha) 2 \bar {s})} s_{t}^{*},
$$
...
$$
\frac{Q_{t}}{P_{t}} = \mathbb {E}_{t} \left[ \sum_{k = 0}^{\infty} \exp (m_{t, t + k}) s_{t + k} \right] = s_{t} + \mathbb {E}_{t} \left[ \sum_{k = 1}^{\infty} \exp (m_{t, t + k}) s_{t + k} \right], \tag {6.17}
$$
...
$$
i_{t} = \log \left(\frac{s_{t} + c_{t} A}{c_{t}}\right) - \log \mathbb {E}_{t} \left[ \delta \frac{s_{t + 1} + c_{t + 1} A}{c_{t + 1}} \right] + \Delta \log Q_{t + 1}. \tag {6.18}
$$
...
$$
\begin{array}{r l r} \mathrm{w .r .t .} c_{F, t}^{*}: & \delta^{t} (1 - \pi) (c_{t}^{*})^{- \gamma^{*}} \alpha \left(\frac{c_{H , t}^{*}}{c_{F , t}^{*}}\right)^{1 - \alpha} & = \zeta_{F, t}. \end{array}
$$
...
$$
\mathbb {E}_{t} \left[ \int_{0}^{T} \delta^{t} \frac{1}{1 - \gamma^{*}} \left(c_{t}^{*}\right)^{1 - \gamma^{*}} d t \right].
$$
...
$$
a_{t} = \mathbb {E}_{t} \left[ \int_{t}^{T} \frac{\exp \left(m_{s}\right)}{\exp \left(m_{t}\right)} c_{s} d s \right], \quad a_{t}^{*} = \mathbb {E}_{t} \left[ \int_{t}^{T} \frac{\exp \left(m_{s}^{*}\right)}{\exp \left(m_{t}^{*}\right)} c_{s}^{*} d s \right], \tag {7.1}
$$
...
$$
\frac{d \exp (m_{t})}{\exp (m_{t})} = - r_{t} d t - \lambda_{t} d W_{t},
$$
...
$$
\begin{array}{l} c_{t} = \left(c_{H, t}\right)^{\alpha} \left(c_{F, t}\right)^{1 - \alpha}, \\ c_{t}^{*} = (c_{F, t}^{*})^{\alpha} (c_{H, t}^{*})^{1 - \alpha}, \\ \end{array}
$$
...
$$
\begin{array}{l} e_{t} - \bar {e} = \sum_{j = 1}^{\infty} \mathbb {E}_{t} \left[ \gamma \left(\Delta \log c_{t + j} - \Delta \log c_{t + j}^{*}\right) \right] + \sum_{j = 0}^{\infty} \mathbb {E}_{t} \left[ \lambda_{H, t + j}^{*} - \lambda_{H, t + j} \right] \\ = - \gamma \left(\log \frac{c_{t}}{\bar {c}} - \log \frac{c_{t}^{*}}{\bar {c}^{*}}\right) + \sum_{j = 0}^{\infty} \mathbb {E}_{t} \left[ \lambda_{H, t + j}^{*} - \lambda_{H, t + j} \right], \tag {7.3} \\ \end{array}
$$

where the convenience yield differential on the U.S. bond is approximately

$$
\lambda_{H, t}^{*} - \lambda_{H, t} \approx \frac{\omega_{H}^{*} \left(b_{H , t}^{*}\right)^{- \sigma}}{\left(c_{t}^{*}\right)^{- \gamma}} \exp (- e_{t}) - \frac{\omega_{H} b_{H , t}^{- \sigma}}{c_{t}^{- \gamma}} - \theta_{H, t}^{*} \exp (- e_{t}). \tag {7.4}
$$
...
$$
D_{t} = \mathbb {E}_{t} \left[ \sum_{k = 1}^{\infty} \exp (M_{t, t + k}) S_{t + k} \right] + \lim_{k \rightarrow \infty} \mathbb {E}_{t} \left[ \exp (M_{t, t + k}) D_{t + k} \right].
$$
...
$$
D_{t - 1} \exp \left(R_{t}^{D}\right) = \mathbb {E}_{t} \left[ \sum_{k = 0}^{\infty} \exp \left(M_{t, t + k}\right) S_{t + k} \right] + \lim_{k \rightarrow \infty} \mathbb {E}_{t} [ \exp \left(M_{t, t + k}\right) D_{t + k} ]. \tag {8.7}
$$
...
$$
P_{t}^{T} \stackrel {\text{de f}} {=} \mathbb {E}_{t} \left[ \sum_{k = 1}^{\infty} \exp \left(M_{t, t + k}\right) T_{t + k} \right],
$$

$$
P_{t}^{G} \stackrel {\text{de f}} {=} \mathbb {E}_{t} \left[ \sum_{k = 1}^{\infty} \exp (M_{t, t + k}) G_{t + k} \right].
$$
...
$$
K_{t} = D_{t} \left(1 - \exp \left(- \lambda_{t}\right)\right) \approx D_{t} \lambda_{t},
$$
...
$$
D_{t} = \mathbb {E}_{t} \left[ \sum_{k = 1}^{\infty} \exp (M_{t, t + k}) S_{t + k} \right] + \mathbb {E}_{t} \left[ \sum_{k = 0}^{\infty} \exp (M_{t, t + k}) K_{t + k} \right] + \lim_{k \rightarrow \infty} \mathbb {E}_{t} [ \exp (M_{t, t + k}) D_{t + k} ]. \tag {8.11}
$$
...
$$
\exp \left(R_{t + 1}^{T}\right) = \frac{P_{t + 1}^{T} + T_{t + 1}}{P_{t}^{T}},
$$
...
$$
\begin{array}{l} \exp (R_{t + 1}^{D}) = \frac{D_{t + 1} + S_{t + 1}}{D_{t}} = \frac{P_{t + 1}^{T} + P_{t + 1}^{K} + K_{t + 1} - P_{t + 1}^{G} + T_{t + 1} - G_{t + 1}}{D_{t}} \\ = \frac{P_{t}^{T}}{D_{t}} \exp \left(R_{t + 1}^{T}\right) + \frac{P_{t}^{K}}{D_{t}} \exp \left(R_{t + 1}^{K}\right) - \frac{P_{t}^{G}}{D_{t}} \exp \left(R_{t + 1}^{G}\right), \tag {8.12} \\ \end{array}
$$
...
$$
\rho_{t} (h) \stackrel {\text{de f}} {=} - \frac{1}{h} \log \mathbb {E}_{t} [ \exp (M_{t, t + h}) ],
$$
...
$$
c_{t} (h) \stackrel {\mathrm{de f}} {=} \frac{1}{h} \left(\log \mathbb {E}_{t} \left[ \exp (M_{t, t + h}) \prod_{j = 1}^{h} (1 - \chi_{t + j}^{i}) \exp (\lambda_{t + j - 1} (h - j + 1)) \right] - \log \mathbb {E}_{t} \left[ \exp (M_{t, t + h}) \prod_{j = 1}^{h} (1 - \chi_{t + j}^{i}) \right]\right).
$$
...
$$
\lim_{t \rightarrow \infty} \mathbb {E}_{0} \left[ \delta^{t} u^{\prime} \left(c_{t}\right) a_{t} \right] = 0.
$$

Now, suppose the households' transversality condition for the government debt is violated, i.e.,

$$
\lim_{t \rightarrow \infty} \mathbb {E}_{0} \left[ \delta^{t} u^{\prime} \left(c_{t}\right) d_{t} \right] > 0.
$$

This implies that the households' holdings in other assets are negative in the infinite horizon, i.e.,

$$
\lim_{t \rightarrow \infty} \mathbb {E}_{0} \left[ \delta^{t} u^{\prime} \left(c_{t}\right)\left(a_{t} - d_{t}\right)\right] <   0,
$$
...
$$
\lim_{t \rightarrow \infty} \mathbb {E}_{0} \left[ \delta^{t} u^{\prime} \left(c_{t}\right) d_{t} \exp (- \lambda_{t}) \right] = 0.
$$
...
$$
\mathbb {E}_{t} \left[ \sum_{k = 1}^{\infty} \exp \left(M_{t, t + k}\right) \left(T_{t + k} - G_{t + k}\right) \right],
$$
...
$$
B (h + 1)^{\prime} = - e_{i}^{\prime} + B (h)^{\prime} \left(\Psi - \Sigma^{\frac{1}{2}} \Lambda_{1}\right),
$$
...
$$
p d_{t}^{\tau} (h) = A^{\tau} (h) + B^{\tau} (h)^{\prime} z_{t},
$$

$$
p d_{t}^{\mathcal {G}} (h) = A^{\mathcal {G}} (h) + B^{\mathcal {G}} (h)^{\prime} z_{t},
$$

where

$$
\begin{array}{l} A^{\tau} (h + 1) = - i_{0} (1) + A^{\tau} (h) + x_{0} + \pi_{0} + \frac{1}{2} (B^{\tau} (h) + e_{\Delta \tau} + e_{x} + e_{\pi})^{\prime} \Sigma (B^{\tau} (h) + e_{\Delta \tau} + e_{x} + e_{\pi}) \\ - \left(B^{\tau} (h) + e_{\Delta \tau} + e_{x} + e_{\pi}\right)^{\prime} \Sigma^{\frac{1}{2}} \Lambda_{0}, \\ \end{array}
$$
...
$$
\begin{array}{l} A^{g} (h + 1) = - i_{0} (1) + A^{g} (h) + x_{0} + \pi_{0} + \frac{1}{2} (B^{g} (h) + e_{\Delta g} + e_{x} + e_{\pi})^{\prime} \Sigma (B^{g} (h) + e_{\Delta g} + e_{x} + e_{\pi}) \\ - \left(B^{g} (h) + e_{\Delta g} + e_{x} + e_{\pi}\right)^{\prime} \Sigma^{\frac{1}{2}} \Lambda_{0}, \\ \end{array}
$$
...
$$
\lim_{h \to \infty} i_{t} (h) = i_{0} (1) - \frac{1}{2} B_{t r a n s}^{\prime} \Sigma B_{t r a n s} + B_{t r a n s}^{\prime} \Sigma^{\frac{1}{2}} \Lambda_{0},
$$
...
$$
\lim_{h \rightarrow \infty} \mathbb {E} [ \log P_{t + 1} (h - 1) - \log P_{t} (h) ] - i_{0} (1) = B_{\text{tr an s}}^{\prime} \Sigma^{\frac{1}{2}} \Lambda_{0} - \frac{1}{2} B_{\text{tr an s}}^{\prime} \Sigma B_{\text{tr an s}}, \tag {8.16}
$$
...
$$
\widetilde {\gamma}_{t + 1} = \kappa v_{t + 1} - v_{t} + s_{t + 1},
$$
...
$$
v_{t} = \mathbb {F}_{t} \sum_{j = 1}^{T} \left(s_{t + j} - \widetilde {r}_{t + j}\right) + \mathbb {F}_{t} [ v_{t + T} ] = \mathbb {F}_{t} \sum_{j = 1}^{T} b v_{t + j - 1} + \mathbb {F}_{t} [ v_{t + T} ] \tag {8.17}
$$

We conjecture and verify that the law of motion for the debt/output ratio under the subjective measure  $\mathbb{F}$  is

$$
v_{t + 1} = \psi v_{t} + \eta_{t + 1}^{\mathrm{F}}.
$$
...
$$
v_{t} = \lim_{T \to \infty} \mathbb {F}_{t} \sum_{j = 1}^{T} b v_{t + j - 1} + \lim_{T \to \infty} \mathbb {F}_{t} [ v_{t + T} ],
$$
...
$$
x_{t} = \arg \max_{x_{t}} \mathbb {E}_{t} \left[ f_{t + 1} \left(z_{t + 1}\right) \frac{\exp \left(\left(1 - \gamma\right) r_{t + 1}^{p}\right)}{1 - \gamma} \right], \tag {9.1}
$$
...
$$
x_{t} = \gamma^{- 1} \Sigma_{t}^{- 1} \left(\mathbb {E} \left[ r_{t + 1} \right] + \frac{1}{2} \sigma_{t}^{2} - r_{t}^{f}\right). \tag {9.2}
$$
...
$$
x_{t} = \frac{1}{\gamma} \Sigma_{t}^{- 1} \left(\mathbb {E}_{t} r_{t + 1} - r_{t}^{f} + \frac{1}{2} \sigma_{t}^{2}\right) + \left(1 - \frac{1}{\gamma}\right) \Sigma_{t}^{- 1} c o v_{t} \left(r_{t + 1}, - \left(\mathbb {E}_{t + 1} - \mathbb {E}_{t}\right) \sum_{j = 1}^{\infty} \rho^{j} r_{t + j}^{f}\right). \tag {9.3}
$$
...
$$
x_{t} = \arg \max_{x_{t}} \mathbb {E}_{t} \left[ r_{t + 1}^{p} \right],
$$
...
$$
x_{t} (\iota) = \frac{\exp \left(\delta_{t} (\iota)\right)}{1 + \sum_{k} \exp \left(\delta_{t} (k)\right)}. \tag {9.4}
$$
...
$$
p_{t} (\iota) q_{t} (\iota) = a_{t} x_{t} (\iota). \tag {9.5}
$$
...
$$
\begin{array}{l}^{2} \text{Th ed er iv at io ni ss im pl e :} \frac{\partial \log x_{t} (t)}{\partial \log p_{t} (t)} = \\ \frac{\partial \delta_{t} (t)}{\partial \log p_{t} (t)} - \frac{\partial \log (1 + \sum_{k} \exp (\delta_{t} (k)))}{\partial \log p_{t} (t)} = \alpha - \\ \alpha \frac{\exp (\delta_{t} (t))}{1 + \sum_{k} \exp (\delta_{t} (k))}. \end{array}
$$
...
$$
a_{t} = a_{t - 1} \left((1 - x_{t - 1}) + x_{t - 1} \frac{p_{t}}{p_{t - 1}}\right) + s_{t} = ((1 - x_{t - 1}) + x_{t - 1} p_{t}) + s_{t}.
$$

We assume  $\alpha = -1$  and  $x_{t-1} = 1 / \sqrt{2}$ . Then, this system of equations has only one root with a positive asset price, with,

$$
p_{t} = \sqrt{2} - 1, a_{t} = 2 - \sqrt{2}, x_{t} = 1 / \sqrt{2},
$$
...
$$
\left. \right.\left(s_{n, t}, q_{t} (\iota , \ell), \kappa_{n, t} (\iota , \ell), \xi_{n, t} (\ell)\right)_{t = 0}^{\infty}, \quad \text{fo r} \quad n, \iota , \ell = 1, 2.
$$
...
$$
n f a_{t} \stackrel {\text{de f}} {=} a_{t} \sum_{\iota} x_{F, t} (\iota) - a_{t}^{*} \sum_{\iota} x_{H, t}^{*} (\iota). \tag {9.6}
$$
...
$$
\rho_{t} (\iota) = \frac{p_{t} (\iota) - p_{t - 1} (\iota)}{p_{t - 1} (\iota)},
$$

$$
d_{t} (\iota) = \frac{\operatorname{di v}_{t} (\iota)}{p_{t - 1} (\iota)}.
$$
...
$$
f_{t} \stackrel {{\mathrm{de f}}} {{=}} s_{t} + a_{t - 1} \left(\sum_{\iota} x_{H, t - 1} (\iota) d_{t} (\iota) + \sum_{\iota} x_{F, t - 1} (\iota) d_{t}^{*} (\iota)\right).
$$
...
$$
a_{t} = a_{t - 1} + a_{t - 1} \left(\sum_{\iota} x_{H, t - 1} (\iota) \rho_{t} (\iota) + \sum_{\iota} x_{F, t - 1} (\iota) \rho_{t}^{*} (\iota)\right) + f_{t}. \tag {9.7}
$$
...
$$
m_{t} (\iota) = p_{t} (\iota) q_{t} (\iota) = a_{t} x_{H, t} (\iota) + a_{t}^{*} x_{H, t}^{*} (\iota). \tag {9.8}
$$
...
$$
n f a_{t} - n f a_{t - 1} = t b_{t} + i b_{t} + c g_{t}, \tag {9.9}
$$
...
$$
\left(w_{t} \ell_{t} + q_{t} k_{t}\right) + b_{H, t - 1} = c_{t} + z_{t} + \exp (- r_{t}) b_{H, t},
$$
...
$$
k_{t + 1} = (1 - d) k_{t} + z_{t} - \frac{\kappa}{2} \frac{(\Delta k_{t + 1})^{2}}{k_{t}},
$$
...
$$
\left(w_{t}^{*} \ell_{t}^{*} + q_{t}^{*} K_{t}^{*}\right) + b_{F, t - 1}^{*} = c_{t}^{*} + z_{t}^{*} + \exp \left(- r_{t}^{*}\right) b_{F, t}^{*}.
$$
...
$$
\exp (- r_{t}) n_{t} = - \exp (- e_{t}) \exp (- r_{t}^{*}) n_{t}^{*}. \tag {10.1}
$$

The size of their position is determined by an exogenous process:

$$
\exp (- r_{t}) n_{t} = n \left(\exp \left(\psi_{t}\right) - 1\right),
$$
...
$$
\exp (- r_{t}) d_{t} = - \exp (- e_{t}) \exp \left(- r_{t}^{*}\right) d_{t}^{*}. \tag {10.2}
$$
...
$$
\mathbb {E}_{t} [ r x_{t + 1} ] \stackrel {\text{de f}} {=} \mathbb {E}_{t} [ \Delta e_{t + 1} + r_{t} - r_{t}^{*} ] = \chi_{1} \psi_{t} - \chi_{2} \frac{b_{H , t}}{\bar {Y}}.
$$
...
$$
(y_{t}, y_{H, t}, y_{F, t}, c_{t}, k_{t}, z_{t}, x_{t}, \ell_{t}, b_{H, t}, q_{t}, w_{t}, r_{t}, p_{t}, y_{t}^{*}, y_{H, t}^{*}, y_{F, t}^{*}, c_{t}^{*}, k_{t}^{*}, z_{t}^{*}, x_{t}^{*}, \ell_{t}^{*}, b_{F, t}^{*}, q_{t}^{*}, w_{t}^{*}, r_{t}^{*}, p_{t}^{*}, e_{t})_{t = 0}^{\infty},
$$

plus two auxiliary variables  $\exp(m_{t+1})$  and  $\exp(m_{t+1}^*)$  that denote the home and foreign SDFs/marginal utility growth:

$$
\exp (m_{t + 1}) = \delta \frac{u^{\prime} (c_{t + 1})}{u^{\prime} (c_{t})},
$$
...
$$
\left[ \alpha^{1 - \eta} y_{H, t}^{\eta} + (1 - \alpha)^{1 - \eta} y_{F, t}^{\eta} \right]^{1 / \eta - 1} \alpha^{1 - \eta} y_{H, t}^{\eta - 1} = p_{t},
$$

$$
\left[ \alpha^{1 - \eta} y_{H, t}^{\eta} + (1 - \alpha)^{1 - \eta} y_{F, t}^{\eta} \right]^{1 / \eta - 1} (1 - \alpha)^{1 - \eta} y_{F, t}^{\eta - 1} = p_{t}^{*} \exp (- e_{t}),
$$
...
$$
\left[ \alpha^{1 - \eta} (y_{F, t}^{*})^{\eta} + (1 - \alpha)^{1 - \eta} (y_{H, t}^{*})^{\eta} \right]^{1 / \eta - 1} \alpha^{1 - \eta} (y_{F, t}^{*})^{\eta - 1} = p_{t}^{*},
$$

$$
\left[ \alpha^{1 - \eta} (y_{F, t}^{*})^{\eta} + (1 - \alpha)^{1 - \eta} (y_{H, t}^{*})^{\eta} \right]^{1 / \eta - 1} (1 - \alpha)^{1 - \eta} (y_{H, t}^{*})^{\eta - 1} = p_{t} \exp (e_{t}),
$$

$$
\left(\ell_{t}^{*}\right)^{1 / \nu} = \left(c_{t}^{*}\right)^{- \gamma} w_{t}^{*},
$$
...
$$
\ell_{t} w_{t} = p_{t} (1 - \vartheta) (1 - \phi) y_{t},
$$

$$
k_{t} q_{t} = p_{t} \vartheta (1 - \phi) y_{t},
$$
...
$$
y_{t}^{*} = \left(\exp \left(a_{t}^{*}\right) \left(k_{t}^{*}\right)^{\vartheta} \left(\ell_{t}^{*}\right)^{(1 - \vartheta)}\right)^{1 - \phi} \left(x_{t}^{*}\right)^{\phi},
$$
...
$$
z_{t} = k_{t + 1} - (1 - d) k_{t} + \frac{\kappa}{2} \frac{(\Delta k_{t + 1})^{2}}{k_{t}},
$$
...
$$
c_{t}^{- \gamma} \exp (- r_{t}) = \mathbb {E}_{t} \left[ \delta c_{t + 1}^{- \gamma} \right], \tag {10.5}
$$

$$
\left(c_{t}^{*}\right)^{- \gamma} \exp \left(- r_{t}^{*}\right) = \mathbb {E}_{t} \left[ \delta \left(c_{t + 1}^{*}\right)^{- \gamma} \right], \tag {10.6}
$$

$$
\mathbb {E}_{t} \left[ \Delta e_{t + 1} + r_{t} - r_{t}^{*} \right] = \chi_{1} \psi_{t} - \chi_{2} \frac{b_{H , t}}{\bar {Y}}, \tag {10.7}
$$
...
$$
\chi_{1} \psi_{t} - \chi_{2} \frac{b_{H , t}}{\bar {Y}} = \mathbb {E}_{t} \left[ \Delta e_{t + 1} - \left(m_{t + 1} - m_{t + 1}^{*}\right) \right]. \tag {10.8}
$$
...
$$
\exp (- \lambda_{F, t}) = \mathbb {E}_{t} \left[ \exp (m_{t + 1} - \Delta e_{t + 1} + r_{t}^{*}) \right],
$$

$$
\exp (- \lambda_{F, t}^{*}) = \mathbb {E}_{t} \left[ \exp (m_{t + 1}^{*} + r_{t}^{*}) \right],
$$

$$
\exp \left(- \lambda_{H, t}^{*}\right) = \mathbb {E}_{t} \left[ \exp \left(m_{t + 1}^{*} + \Delta e_{t + 1} + r_{t}\right) \right],
$$
...
$$
- \left(\lambda_{H, t}^{*} - \lambda_{H, t}\right) = - \left(\lambda_{F, t}^{*} - \lambda_{F, t}\right) = \mathbb {E}_{t} \left[ \Delta e_{t + 1} - \left(m_{t + 1} - m_{t + 1}^{*}\right) \right]. \tag {10.9}
$$
...
$$
c_{t} (i) = \left(c_{H, t} (i)\right)^{\alpha} \left(c_{F, t} (i)\right)^{1 - \alpha}.
$$
...
$$
p_{t} y_{t} + \phi a_{t - 1} (a) \exp \left(r_{t}^{a}\right) = \phi \left(c_{t} (a) + a_{t} (a)\right) + (1 - \phi) \tau_{t},
$$

and the home inactive households' budget constraint can be expressed as

$$
(1 - \phi) \tau_{t} = (1 - \phi) c_{t} (i).
$$
...
$$
y_{t} - (1 - \phi) \left(c_{H, t} (i) + c_{H, t}^{*} (i)\right) = \phi \left(c_{H, t} (a) + c_{H, t}^{*} (a)\right),
$$

$$
y_{t}^{*} - (1 - \phi) \left(c_{F, t} (i) + c_{F, t}^{*} (i)\right) = \phi \left(c_{F, t} (a) + c_{F, t}^{*} (a)\right),
$$
...
$$
\begin{array}{l} \mathbb {E}_{0} \left[ \sum_{t = 1}^{\infty} \delta^{t} \left(\pi u \left(c_{t} (a)\right) + (1 - \pi) u \left(c_{t}^{*} (a)\right)\right) \right. \\ + \sum_{t = 1}^{\infty} \zeta_{H, t} (y_{t} - \phi (c_{H, t} (a) + c_{H, t}^{*} (a)) - (1 - \phi) (c_{H, t} (i) + c_{H, t}^{*} (i))) \\ \left. + \sum_{t = 1}^{\infty} \zeta_{F, t} (y_{t}^{*} - \phi (c_{F, t} (a) + c_{F, t}^{*} (a)) - (1 - \phi) (c_{F, t} (i) + c_{F, t}^{*} (i))) \right], \\ \end{array}
$$

which implies the following standard first-order conditions

$$
\begin{array}{l} \text{w .r .t .} c_{H, t} (a): \quad \delta^{t} \pi u^{\prime} (c_{t} (a)) \alpha \left(\frac{c_{F , t} (a)}{c_{H , t} (a)}\right)^{1 - \alpha} = \phi \zeta_{H, t}, \\ \text{w .r .t .} c_{H, t}^{*} (a): \quad \delta^{t} (1 - \pi) u^{\prime} (c_{t}^{*} (a)) (1 - \alpha) \left(\frac{c_{F , t}^{*} (a)}{c_{H , t}^{*} (a)}\right)^{\alpha} = \phi \zeta_{H, t}, \\ \begin{array}{l l} \text{w .r .t .} c_{F, t} (a): & \delta^{t} \pi u^{\prime} (c_{t} (a)) (1 - \alpha) \left(\frac{c_{H , t} (a)}{c_{F , t} (a)}\right)^{\alpha} = \phi \zeta_{F, t}, \end{array} \\ \text{w .r .t .} c_{F, t}^{*} (a): \quad \delta^{t} (1 - \pi) u^{\prime} (c_{t}^{*} (a)) \alpha \left(\frac{c_{H , t}^{*} (a)}{c_{F , t}^{*} (a)}\right)^{1 - \alpha} = \phi \zeta_{F, t}. \\ \end{array}
$$
...
$$
\left(y_{t}, y_{t}^{*}, \tau_{t}, \tau_{t}^{*}\right)_{t = 0}^{\infty}.
$$

There are 14 endogenous variables in each period  $t$ :

$$
(c_{t} (a), c_{H, t} (a), c_{F, t} (a), c_{t} (i), c_{H, t} (i), c_{F, t} (i), \zeta_{H, t}, c_{t}^{*} (a), c_{H, t}^{*} (a), c_{F, t}^{*} (a), c_{t}^{*} (i), c_{H, t}^{*} (i), c_{F, t}^{*} (i), \zeta_{F, t})_{t = 0}^{\infty}.
$$

The model implies the following 14 equations in each period, which include 4 consumption aggregation equations,

$$
\begin{array}{l} c_{t} (a) = \left(c_{H, t} (a)\right)^{\alpha} \left(c_{F, t} (a)\right)^{1 - \alpha}, \\ c_{t}^{*} (a) = \left(c_{F, t}^{*} (a)\right)^{\alpha} \left(c_{H, t}^{*} (a)\right)^{1 - \alpha}, \\ c_{t} (i) = \left(c_{H, t} (i)\right)^{\alpha} \left(c_{F, t} (i)\right)^{1 - \alpha}, \\ c_{t}^{*} (i) = (c_{F, t}^{*} (i))^{\alpha} (c_{H, t}^{*} (i))^{1 - \alpha}, \\ \end{array}
$$

2 social planner's resource constraints,

$$
y_{t} = \phi \left(c_{H, t} (a) + c_{H, t}^{*} (a)\right) + (1 - \phi) \left(c_{H, t} (i) + c_{H, t}^{*} (i)\right),
$$

$$
y_{t}^{*} = \phi (c_{F, t} (a) + c_{F, t}^{*} (a)) + (1 - \phi) (c_{F, t} (i) + c_{F, t}^{*} (i)),
$$
...
$$
\frac{c_{H , t} (a)}{c_{F , t} (a)} = \frac{c_{H , t} (i)}{c_{F , t} (i)},
$$
...
$$
p_{t} = \alpha \left(\frac{c_{F , t} (a)}{c_{H , t} (a)}\right)^{1 - \alpha},
$$

$$
p_{t}^{*} = \alpha \left(\frac{c_{H , t}^{*} (a)}{c_{F , t}^{*} (a)}\right)^{1 - \alpha},
$$

and the exchange rate is given by

$$
\pi u^{\prime} \left(c_{t} (a)\right) = (1 - \pi) u^{\prime} \left(c_{t}^{*} (a)\right) \exp \left(e_{t}\right).
$$
...
$$
w. r. t. c_{H, t} (a): \quad - \gamma \hat {c}_{t} (a) + (1 - \alpha) \hat {c}_{F, t} (a) - (1 - \alpha) \hat {c}_{H, t} (a) = \hat {\zeta}_{H, t},
$$

$$
w. r. t. c_{H, t}^{*} (a): - \gamma \hat {c}_{t}^{*} (a) + \alpha \hat {c}_{F, t}^{*} (a) - \alpha \hat {c}_{H, t}^{*} (a) = \hat {\zeta}_{H, t},
$$

$$
\mathrm{w .r .t .} c_{F, t} (a): \quad - \gamma \hat {c}_{t} (a) + \alpha \hat {c}_{H, t} (a) - \alpha \hat {c}_{F, t} (a) = \hat {\zeta}_{F, t},
$$

$$
w. r. t. c_{F, t}^{*} (a): - \gamma \hat {c}_{t}^{*} (a) + (1 - \alpha) \hat {c}_{H, t}^{*} (a) - (1 - \alpha) \hat {c}_{F, t}^{*} (a) = \hat {\zeta}_{F, t},
$$
...
$$
\rho \stackrel {\mathrm{de f}} {=} c o r r_{t} (\hat {\tau}_{t + 1}, \hat {y}_{t + 1}) = c o r r_{t} (\hat {\tau}_{t + 1}^{*}, \hat {y}_{t + 1}^{*}),
$$
...
$$
\sigma_{\tau}^{2} \stackrel {\text{de f}} {=} v a r_{t} (\hat {\tau}_{t + 1}) = v a r_{t} (\hat {\tau}_{t + 1}^{*}).
$$
...
$$
\operatorname{co rr}_{t} \left(\hat {e}_{t + 1}, \hat {c}_{t + 1}^{*} - \hat {c}_{t + 1}\right) = \frac{1 - (1 - \phi) \rho \frac{\sigma_{\tau}}{\sigma_{y}}}{\sqrt{1 + (1 - \phi)^{2} \frac{\sigma_{\tau}^{2}}{\sigma_{y}^{2}} - 2 (1 - \phi) \rho \frac{\sigma_{\tau}}{\sigma_{y}}}}.
$$
...
$$
\bar {p} \bar {y} \left(\log y_{t} - \log y_{t}^{*}\right) + \bar {p} \bar {y} \frac{2 - 2 \alpha}{2 \alpha - 1} e_{t} = (2 \alpha - 1) \bar {c} \left(\log c_{t} - \log c_{t}^{*}\right) - 2 (1 - \alpha) \bar {c} e_{t}
$$

$$
\begin{array}{l} (2 \alpha - 1) (\log c_{t} - \log c_{t}^{*}) - 2 (1 - \alpha) e_{t} - \frac{2 - 2 \alpha}{2 \alpha - 1} e_{t} = \log y_{t} - \log y_{t}^{*} \\ (2 \alpha - 1) \left(\log c_{t} - \log c_{t}^{*}\right) - 2 (1 - \alpha) \frac{2 \alpha}{2 \alpha - 1} e_{t} = \log y_{t} - \log y_{t}^{*} \\ \end{array}
$$
...
$$
\begin{array}{l} h m l_{t + 1} - \mathbb {E}_{t} \left[ h m l_{t + 1} \right] = - \frac{1}{N_{H}} \sum_{i \in H} \left(\sqrt{\delta^{i}} - \sqrt{\delta^{\$}}\right) \sqrt{z_{t}^{w}} \varepsilon_{t + 1}^{w} - \frac{1}{N_{H}} \sum_{i \in H} \left(\sqrt{\gamma z_{t}^{i}} \varepsilon_{t + 1}^{i} - \sqrt{\gamma z_{t}^{\$}} \varepsilon_{t + 1}^{\$}\right) \\ + \frac{1}{N_{L}} \sum_{i \in L} \left(\sqrt{\delta^{i}} - \sqrt{\delta^{\S}}\right) \sqrt{z_{t}^{w}} \varepsilon_{t + 1}^{w} + \frac{1}{N_{L}} \sum_{i \in L} \left(\sqrt{\gamma z_{t}^{i}} \varepsilon_{t + 1}^{i} - \sqrt{\gamma z_{t}^{\S}} \varepsilon_{t + 1}^{\S}\right) \\ = \left(\sqrt{\delta_{t}^{L}} - \sqrt{\delta_{t}^{H}}\right) \sqrt{z_{t}^{w}} \varepsilon_{t + 1}^{w} - \frac{1}{N_{H}} \sum_{i \in H} \sqrt{\gamma z_{t}^{i}} \varepsilon_{t + 1}^{i} + \frac{1}{N_{L}} \sum_{i \in L} \sqrt{\gamma z_{t}^{i}} \varepsilon_{t + 1}^{i} \\ = \left(\overline {{\sqrt{\delta_{t}^{L}}}} - \overline {{\sqrt{\delta_{t}^{H}}}}\right) \sqrt{z_{t}^{w}} \varepsilon_{t + 1}^{w} \\ \end{array}
$$
...
$$
\begin{array}{l} \Delta e_{t + 1}^{i / \$} = - \left(\mu_{t}^{i} - \mu_{t}^{\$}\right) - \left(\sqrt{\delta^{i}} - \sqrt{\delta^{\$}}\right) \sqrt{z_{t}^{w}} \varepsilon_{t + 1}^{w} - \left(\sqrt{\gamma z_{t}^{i}} \varepsilon_{t + 1}^{i} - \sqrt{\gamma z_{t}^{\$}} \varepsilon_{t + 1}^{\$}\right) \\ = - \chi \left(z_{t}^{i} - z_{t}^{\$}\right) - \left(\sqrt{\delta^{i}} - \sqrt{\delta^{\$}}\right) \sqrt{z_{t}^{w}} \varepsilon_{t + 1}^{w} - \left(\sqrt{\gamma z_{t}^{i}} \varepsilon_{t + 1}^{i} - \sqrt{\gamma z_{t}^{\$}} \varepsilon_{t + 1}^{\$}\right) \\ \end{array}
$$
...
$$
c o v (\Delta e_{t + 1}^{i / \mathbb {S}}, r_{t}^{i} - r_{t}^{\mathbb {S}}) = - \chi \left(\chi - \frac{1}{2} \gamma\right) v a r (z_{t}^{i} - z_{t}^{\mathbb {S}})
$$
...
$$
\begin{array}{l} v a r (\sqrt{z_{t}^{w}} \varepsilon_{t + 1}^{w}) = \mathbb {E} \left[ z_{t}^{w} (\varepsilon_{t + 1}^{w})^{2} \right] - \left(\mathbb {E} \left[ \sqrt{z_{t}^{w}} (\varepsilon_{t + 1}^{w}) \right]\right)^{2} \\ = \mathbb {E} \left[ z_{t}^{w} \right] \mathbb {E} \left[ \left(\varepsilon_{t + 1}^{w}\right)^{2} \right] \\ = \theta^{w} \\ \end{array}
$$
...
$$
v a r \left(\Delta e_{t + 1}^{i / j}\right) = \chi^{2} \left(v a r \left(z_{t}^{i}\right) + v a r \left(z_{t}^{j}\right)\right) + \left(\sqrt{\delta^{i}} - \sqrt{\delta^{j}}\right)^{2} \theta^{w} + 2 \gamma \theta
$$

$$
\begin{array}{l} \varphi = \frac{c o v (\Delta e_{t + 1}^{i / j} , \Delta \vec{e}_{t + 1}^{i})}{v a r (\Delta \vec{e}_{t + 1}^{i})} \\ = 1 - \frac{\left(\sqrt{\delta^{i}} - \overline {{\sqrt{\delta}}}\right) \left(\sqrt{\delta^{j}} - \overline {{\sqrt{\delta}}}\right) \theta^{w}}{\chi^{2} v a r \left(z_{t}^{i}\right) + \left(\sqrt{\delta^{i}} - \overline {{\sqrt{\delta}}}\right)^{2} \theta^{w} + \gamma \theta}, \\ \end{array}
$$
...
$$
r_{t + 1}^{c} - \mathbb {E}_{t} \left[ r_{t + 1}^{c} \right] = \sigma_{t} \varepsilon_{\bar {g}, t + 1} + W_{x} \sigma_{t} \varphi_{e} \varepsilon_{x, t + 1} + W_{\sigma} \omega \varepsilon_{w, t + 1}
$$
...
$$
\begin{array}{l} \log \bar {c}^{i} = \sum_{j = 1}^{N} v_{i j} \log \left(\frac{\pi^{i} v_{i j}}{\gamma^{j}} \bar {x}^{j}\right) \\ \log \bar {c} = \sum_{j = 1}^{N} v_{i j} \log \left(\pi^{i} v_{i j}\right) + V \log \bar {x} - V \log \gamma \\ = \sum_{j = 1}^{N} v_{i j} \log \left(\pi^{i} v_{i j}\right) + H \left(\kappa^{x} + \log a - \theta \log \gamma\right) \\ = \kappa^{c} + H (\log a - \theta \log (H^{\prime} \pi + (I - W^{\prime})^{- 1} d)) \\ \end{array}
$$
...
$$
E \left[ \int_{0}^{T} \exp (m_{\tilde {v}_{F}, t}) (\tilde {c}_{t}^{*} - p_{t}^{*} \exp (- e_{t}) y_{t}^{*}) d t \right] = \tilde {w}_{0}^{*}.
$$
...
$$
\nabla u^{*} \left(c_{F, t}, c_{F, t}^{*}\right) = \left(\exp (\delta t) \tilde {\zeta}_{F} \exp \left(m_{\tilde {v}_{F}, t}\right) p_{t}, \exp (\delta t) \tilde {\zeta}_{F} \exp \left(m_{\tilde {v}_{F}, t}\right) p_{t}^{*} \exp (- e_{t})\right).
$$
...
$$
\begin{array}{l} \exp (m_{\tilde {\nu}_{F}, t}) = \frac{\exp (m_{\tilde {\nu}_{F} , t})}{\exp (m_{\tilde {\nu}_{F} , 0})} = \exp (- \delta t) \frac{\tilde {c}_{0}^{*}}{\tilde {c}_{t}^{*}} = \exp (- \delta t) \frac{p_{0}^{*} \exp (- e_{0}) c_{F , 0}^{*}}{p_{t}^{*} \exp (- e_{t}) c_{F , t}^{*}} \\ = \exp (- \delta t) \frac{p_{0}^{*} \exp (- e_{0}) y_{0}^{*}}{p_{t}^{*} \exp (- e_{t}) y_{t}^{*}} \frac{\pi_{0}}{\pi_{t}} \frac{\gamma_{t} (1 - \alpha) + \pi_{t} \gamma^{*} \alpha}{\gamma_{0} (1 - \alpha) + \pi_{0} \gamma^{*} \alpha}. \tag {A.18} \\ \end{array}
$$
...
$$
d \exp \left(m_{t}^{c m}\right) = \exp \left(m_{t}^{c m}\right) \left(\mu_{m, t}^{c m} + \frac{1}{2} \| \sigma_{m, t}^{c m} \|^{2}\right) d t + \exp \left(m_{t}^{c m}\right) \sigma_{m, t}^{c m} d Z_{t}
$$
...
$$
0 = \mathbb {E}_{t} [ m_{t + 1} ] + \frac{1}{2} v a r_{t} (m_{t + 1}) + r_{t},
$$

$$
0 = \mathbb {E}_{t} [ m_{t + 1} ] + \frac{1}{2} v a r_{t} (m_{t + 1}) + r_{t} + \mathbb {E}_{t} [ \eta_{t + 1} ] + \frac{1}{2} v a r_{t} (\eta_{t + 1}) + c o v_{t} (m_{t + 1}, \eta_{t + 1}),
$$
...
$$
c o v_{t} (m_{t + 1}, \eta_{t + 1}) = - \mathbb {E}_{t} [ \eta_{t + 1} ] - \frac{1}{2} v a r_{t} (\eta_{t + 1}),
$$
...
$$
\begin{array}{l} \operatorname{va r}_{t} \left(\Delta e_{t + 1}\right) = \operatorname{va r}_{t} \left(m_{t + 1} - m_{t + 1}^{*}\right) + \operatorname{va r}_{t} \left(\eta_{t + 1}\right) + 2 \operatorname{co v}_{t} \left(m_{t + 1} - m_{t + 1}^{*}, \eta_{t + 1}\right) \\ = v a r_{t} \left(m_{t + 1} - m_{t + 1}^{*}\right) - v a r_{t} \left(\eta_{t + 1}\right), \\ \end{array}
$$

$$
\begin{array}{l} c o v_{t} \left(m_{t + 1} - m_{t + 1}^{*}, \Delta e_{t + 1}\right) = \operatorname{va r}_{t} \left(m_{t + 1} - m_{t + 1}^{*}\right) + c o v_{t} \left(m_{t + 1} - m_{t + 1}^{*}, \eta_{t + 1}\right) \\ = \operatorname{va r}_{t} \left(m_{t + 1} - m_{t + 1}^{*}\right) - \operatorname{va r}_{t} \left(\eta_{t + 1}\right) \\ = v a r_{t} \left(\Delta e_{t + 1}\right). \\ \end{array}
$$

The excess return is given by

$$
\begin{array}{l} \mathbb {E}_{t} \left[ r x_{t + 1} \right] = - r_{t}^{*} + r_{t} + \mathbb {E}_{t} \left[ \Delta e_{t + 1} \right] \\ = \mathbb {E}_{t} \left[ m_{t + 1}^{*} \right] + \frac{1}{2} v a r_{t} \left(m_{t + 1}^{*}\right) - \mathbb {E}_{t} \left[ m_{t + 1} \right] - \frac{1}{2} v a r_{t} \left(m_{t + 1}\right) + \mathbb {E}_{t} \left[ m_{t + 1} - m_{t + 1}^{*} + \eta_{t + 1} \right] \\ = \frac{1}{2} \left(v a r_{t} \left(m_{t + 1}^{*}\right) - v a r_{t} \left(m_{t + 1}\right)\right) + \mathbb {E}_{t} [ \eta_{t + 1} ]. \\ \end{array}
$$
...
$$
\begin{array}{l} \operatorname{va r}_{t} \left(\Delta e_{t + 1}\right) = \operatorname{co v}_{t} \left(\Delta e_{t + 1}, m_{t + 1} - m_{t + 1}^{*}\right) \\ = \operatorname{co v}_{t} \left(y_{t} m_{t + 1} + z_{t} m_{t + 1}^{*} + w_{t} \varepsilon_{t + 1}, m_{t + 1} - m_{t + 1}^{*}\right) \\ = y_{t} \operatorname{va r}_{t} \left(m_{t + 1}\right) - z_{t} \operatorname{va r}_{t} \left(m_{t + 1}^{*}\right) + \left(z_{t} - y_{t}\right) \operatorname{co v}_{t} \left(m_{t + 1}. m_{t + 1}^{*}\right), \\ \end{array}
$$
...
$$
\begin{array}{l} z_{t} \ell_{t} = \frac{P_{t} c_{t}}{P_{H , t}} \left(1 + \alpha \frac{g_{t}}{c_{t}} + (1 - \alpha) \frac{g_{t}^{*}}{c_{t}^{*}}\right) \\ z_{t}^{*} \ell_{t}^{*} = \frac{P_{t}^{*} c_{t}^{*}}{P_{F , t}^{*}} \left(1 + \alpha \frac{g_{t}^{*}}{c_{t}^{*}} + (1 - \alpha) \frac{g_{t}}{c_{t}}\right). \\ \end{array}
$$
...
$$
\begin{array}{l} z_{t} \bar {\ell} \ell_{t}^{- \nu} = \frac{P_{t} c_{t}}{P_{H , t}} \\ c_{t} = z_{t} \bar {\ell} \ell_{t}^{- \nu} \frac{P_{H , t}}{P_{t}} = \alpha^{\alpha} (1 - \alpha)^{1 - \alpha} \bar {\ell} \ell_{t}^{- \nu} z_{t} \frac{P_{H , t}}{P_{H , t}^{\alpha} P_{F , t}^{1 - \alpha}} \\ \end{array}
$$
...
$$
\begin{array}{l} \log e_{t} \stackrel {\text{de f}} {=} \log \frac{P_{t}^{*}}{P_{t}} \mathcal {E}_{t} = \log c_{t} - \log c_{t}^{*} \\ \approx (2 \alpha - 1) (\log z_{t} - \log z_{t}^{*}) - \frac{\nu}{1 + \nu} (2 \alpha - 1)^{2} \left(\frac{g_{t}}{c_{t}} - \frac{g_{t}^{*}}{c_{t}^{*}}\right), \\ \end{array}
$$
...
$$
P_{H, t} = \frac{\rho}{\rho - 1} \mathbb {E}_{t - 1} \left[ \frac{W_{t}}{z_{t}} \right] \quad \mathcal {E}_{t} P_{H, t}^{*} = \frac{\rho}{\rho - 1} \mathbb {E}_{t - 1} \left[ \frac{W_{t}}{z_{t}} \right] \tag {A.28}
$$

$$
\frac{1}{\mathcal {E}_{t}} P_{F, t} = \frac{\rho}{\rho - 1} \mathbb {E}_{t - 1} \left[ \frac{W_{t}^{*}}{z_{t}^{*}} \right] \quad P_{F, t}^{*} = \frac{\rho}{\rho - 1} \mathbb {E}_{t - 1} \left[ \frac{W_{t}^{*}}{z_{t}^{*}} \right] \tag {A.29}
$$

Just as in the flexible price case,

$$
z_{t} \ell_{t} = \frac{P_{t} c_{t}}{P_{H , t}} \left(1 + \alpha \frac{g_{t}}{c_{t}} + (1 - \alpha) \frac{g_{t}^{*}}{c_{t}^{*}}\right) \tag {A.30}
$$
...
$$
\begin{array}{l} c_{t} = z_{t} \ell_{t} \cdot \frac{P_{H , t}}{P_{t}} \left(1 + \alpha \frac{g_{t}}{c_{t}} + (1 - \alpha) \frac{g_{t}^{*}}{c_{t}^{*}}\right)^{- 1} = \frac{P_{H , t}}{\frac{1}{\alpha^{\alpha} (1 - \alpha)^{1 - \alpha}} P_{H , t}^{\alpha} P_{F , t}^{1 - \alpha}} \frac{P_{t} c_{t}}{\mathbb {E}_{t - 1} [ P_{t} c_{t} \ell_{t}^{\nu} / z_{t} ]} \overline {{\ell_{t}}} \\ = \frac{P_{t} c_{t}}{\mathbb {E}_{t - 1} \left[ P_{t} c_{t} \ell_{t}^{\nu} / z_{t} \right]} \bar {\ell} \left(\alpha^{\alpha} (1 - \alpha)^{1 - \alpha}\right) \frac{P_{H , t}^{1 - \alpha}}{P_{F , t}^{1 - \alpha}} \\ \end{array}
$$

Use the price setting Eq. (A.28) and (A.29),

$$
\frac{P_{H , t}}{P_{F , t}} = \frac{1}{\mathcal {E}_{t}} \frac{\mathbb {E}_{t - 1} [ W_{t} / z_{t} ]}{\mathbb {E}_{t - 1} [ W_{t}^{*} / z_{t}^{*} ]} = \frac{P_{t}^{*} c_{t}^{*}}{P_{t} c_{t}} \frac{\mathbb {E}_{t - 1} [ P_{t} c_{t} \ell_{t}^{\nu} / z_{t} ]}{\mathbb {E}_{t - 1} [ P_{t}^{*} c_{t}^{*} (\ell_{t}^{*})^{\nu} / z_{t}^{*} ]}
$$
...
$$
\begin{array}{l} c_{t} = \bar {\ell} \alpha^{\alpha} (1 - \alpha)^{1 - \alpha} \frac{\left(P_{t} c_{t}\right)^{\alpha} \left(P_{t}^{*} c_{t}^{*}\right)^{1 - \alpha}}{\left(\mathbb {E}_{t - 1} \left[ P_{t} c_{t} \ell_{t}^{\nu} / z_{t} \right]\right)^{\alpha} \left(\mathbb {E}_{t - 1} \left[ P_{t}^{*} c_{t}^{*} \left(\ell_{t}^{*}\right)^{\nu} / z_{t}^{*} \right]\right)^{1 - \alpha}} \\ c_{t}^{*} = \bar {\ell} \alpha^{\alpha} (1 - \alpha)^{1 - \alpha} \frac{\left(P_{t} c_{t}\right)^{1 - \alpha} \left(P_{t}^{*} c_{t}^{*}\right)^{\alpha}}{\left(\mathbb {E}_{t - 1} \left[ P_{t} c_{t} \ell_{t}^{\nu} / z_{t} \right]\right)^{1 - \alpha} \left(\mathbb {E}_{t - 1} \left[ P_{t}^{*} c_{t}^{*} \left(\ell_{t}^{*}\right)^{\nu} / z_{t}^{*} \right]\right)^{\alpha}} \\ P_{t} = \frac{Q_{t}}{s_{t} + c_{t} \mathbb {E}_{t} \left[ \sum_{k = t + 1}^{\infty} \beta^{k - t} \frac{s_{k}}{c_{k}} \right]}, \\ P_{t}^{*} = \frac{Q_{t}^{*}}{s_{t}^{*} + c_{t}^{*} \mathbb {E}_{t} \left[ \sum_{k = t + 1}^{\infty} \beta^{k - t} \frac{s_{k}^{*}}{c_{k}^{*}} \right]}. \\ \end{array}
$$

which implies

$$
\begin{array}{l} \log c_{t} = \kappa_{t - 1}^{c} + \alpha \log \left(P_{t} c_{t}\right) + (1 - \alpha) \log \left(P_{t}^{*} c_{t}^{*}\right) \\ \log c_{t}^{*} = \kappa_{t - 1}^{c^{*}} + \alpha \log \left(P_{t}^{*} c_{t}^{*}\right) + (1 - \alpha) \log \left(P_{t} c_{t}\right) \\ e_{t} = \log c_{t} - \log c_{t}^{*} = \kappa_{t - 1}^{e} + (2 \alpha - 1) (\log (P_{t} c_{t}) - \log (P_{t}^{*} c_{t}^{*})) \\ \end{array}
$$

where

$$
\begin{array}{l} \kappa_{t - 1}^{c} = \log \left(\frac{\bar {\ell} \alpha^{\alpha} (1 - \alpha)^{1 - \alpha}}{(\mathbb {E}_{t - 1} [ P_{t} c_{t} \ell_{t}^{\nu} / z_{t} ])^{\alpha} (\mathbb {E}_{t - 1} [ P_{t}^{*} c_{t}^{*} (\ell_{t}^{*})^{\nu} / z_{t}^{*} ])^{1 - \alpha}}\right) \\ \kappa_{t - 1}^{c} = \log \left(\frac{\bar {\ell} \alpha^{\alpha} (1 - \alpha)^{1 - \alpha}}{(\mathbb {E}_{t - 1} [ P_{t} c_{t} \ell_{t}^{\nu} / z_{t} ])^{1 - \alpha} (\mathbb {E}_{t - 1} [ P_{t}^{*} c_{t}^{*} (\ell_{t}^{\nu})^{\nu} / z_{t}^{*} ])^{\alpha}}\right) \\ \kappa_{t - 1}^{e} = \kappa_{t - 1}^{c} - \kappa_{t - 1}^{c^{*}} \\ \end{array}
$$
...
$$
\begin{array}{l} \log c_{t}^{*} = \kappa_{t - 1}^{c_{t}^{*}} - \alpha \left(i_{t}^{*} + \log \mathbb {E}_{t} \left[ \delta \frac{1}{P_{t + 1}^{*} c_{t + 1}^{*}} \right]\right) - (1 - \alpha) \left(i_{t} + \log \mathbb {E}_{t} \left[ \delta \frac{1}{P_{t + 1} c_{t + 1}} \right]\right) \\ = \tilde {\kappa}_{t - 1}^{c^{*}} - \alpha i_{t}^{*} - (1 - \alpha) i_{t} \\ \end{array}
$$

where

$$
\tilde {\kappa}_{t - 1}^{c} = \kappa_{t - 1}^{c} - \alpha \log \mathbb {E}_{t} \left[ \delta \frac{1}{P_{t + 1} c_{t + 1}} \right] - (1 - \alpha) \log \mathbb {E}_{t} \left[ \delta \frac{1}{P_{t + 1}^{*} c_{t + 1}^{*}} \right]
$$
...
$$
\tilde {r} = - \log \delta - \tilde {\kappa}_{t - 1}^{c} - \log \mathbb {E}_{t} \left[ 1 / c_{t + 1} \right]
$$
...
$$
c_{t} = \bar {\ell} \alpha^{\alpha} (1 - \alpha)^{1 - \alpha} \frac{(\frac{1}{s_{t} + c_{t} A} c_{t})^{\alpha} (\frac{1}{s_{t}^{*} + c_{t}^{*} A^{*}} c_{t}^{*})^{1 - \alpha}}{(\mathbb {E}_{t - 1} [ \frac{1}{s_{t} + c_{t} A} c_{t} \ell_{t}^{\nu} / z_{t} ])^{\alpha} (\mathbb {E}_{t - 1} [ \frac{1}{s_{t}^{*} + c_{t}^{*} A^{*}} c_{t}^{*} (\ell_{t}^{*})^{\nu} / z_{t}^{*} ])^{1 - \alpha}}
$$

$$
c_{t}^{*} = \bar {\ell} \alpha^{\alpha} (1 - \alpha)^{1 - \alpha} \frac{\left(\frac{1}{s_{t} + c_{t} A} c_{t}\right)^{1 - \alpha} \left(\frac{1}{s_{t}^{*} + c_{t}^{*} A^{*}} c_{t}^{*}\right)^{\alpha}}{(\mathbb {E}_{t - 1} [ \frac{1}{s_{t} + c_{t} A} c_{t} \ell_{t}^{\nu} / z_{t} ])^{1 - \alpha} (\mathbb {E}_{t - 1} [ \frac{1}{s_{t}^{*} + c_{t}^{*} A^{*}} c_{t}^{*} (\ell_{t}^{*})^{\nu} / z_{t}^{*} ])^{\alpha}}.
$$
...
$$
\log c_{t} = \kappa_{c} - \frac{\left((1 - \alpha) \bar {s} + \alpha A^{*} \bar {c}\right) s_{t} + (1 - \alpha) \left(A \bar {c} + \bar {s}\right) s_{t}^{*}}{\bar {c} \left(A A^{*} \bar {c} + (1 - \alpha) \bar {s} \left(A + A^{*}\right)\right)}
$$

$$
\log c_{t}^{*} = \kappa_{C}^{*} - \frac{(1 - \alpha) (A^{*} \bar {c} + \bar {s}) s_{t} + ((1 - \alpha) \bar {s} + \alpha A \bar {c}) s_{t}^{*}}{\bar {c} (A A^{*} \bar {c} + (1 - \alpha) \bar {s} (A + A^{*}))}
$$
...
$$
\begin{array}{l} \log P_{t} = \log Q_{t} - \log \left(s_{t} + c_{t} A\right) \\ \approx \log Q_{t} - \log (\bar {s} + \bar {c} A) - \frac{1}{\bar {s} + \bar {c} A} (s_{t} - \bar {s}) - \frac{\bar {c} A}{\bar {s} + \bar {c} A} \left(\kappa - \frac{\left((1 - \alpha) \bar {s} + \alpha A^{*} \bar {c}\right) s_{t} + (1 - \alpha) (A \bar {c} + \bar {s}) s_{t}^{*}}{\bar {c} (A A^{*} \bar {c} + (1 - \alpha) \bar {s} (A + A^{*}))} - \log \bar {c}\right) \\ = \kappa^{P} + \log Q_{t} - \frac{1 - \alpha}{\bar {s} + \bar {c} A} \frac{A^{*} \bar {c} + \bar {s} (A^{*} / A)}{A^{*} \bar {c} + (1 - \alpha) \bar {s} (1 + A^{*} / A)} s_{t} + \frac{(1 - \alpha)}{A^{*} \bar {c} + (1 - \alpha) \bar {s} (1 + A^{*} / A)} s_{t}^{*} \\ \end{array}
$$
...
$$
\exp \left(- \lambda_{H, t}^{*}\right) = 1 - \frac{\omega_{H}^{*} \left(b_{H , t}^{*}\right)^{- \sigma} - \left(\bar {c}^{*}\right)^{- \gamma} \theta_{H , t}^{*}}{\left(c_{t}^{*}\right)^{- \gamma}} \exp \left(- e_{t}\right)
$$
...
$$
\sum_{h = 1}^{H} Q_{t} (h) P_{t} (h) = \mathbb {E}_{t} \left[ \exp \left(M_{t + 1}\right) S_{t + 1} \right] + \mathbb {E}_{t} \left[ \exp \left(M_{t + 1}\right) \sum_{h = 1}^{H} Q_{t + 1} (h) P_{t + 1} (h) \right] \tag {A.31}
$$
...
$$
\begin{array}{l} \sum_{h = 1}^{H} Q_{t + 1} (h) P_{t + 1} (h) = \mathbb {E}_{t + 1} \left[ \exp \left(M_{t + 1, t + 2}\right) S_{t + 2} \right] + \sum_{h = 1}^{H} Q_{t + 1} (h) P_{t + 1} (h) \left(1 - e^{- \lambda_{t + 1} (h)}\right) \\ + \mathbb {E}_{t + 1} \left[ \exp \left(M_{t + 1, t + 2}\right) \sum_{h = 1}^{H} Q_{t + 2} (h) P_{t + 2} (h) \right] \\ \end{array}
$$

plug it into the RHS of Eq. (A.33) to get:

$$
\begin{array}{l} \sum_{h = 1}^{H} Q_{t} (h) P_{t} (h) = \mathbb {E}_{t} \left[ \sum_{k = 1}^{2} \exp (M_{t, t + k}) S_{t + k} \right] + \mathbb {E}_{t} \left[ \sum_{k = 0}^{1} \exp (M_{t, t + k}) \sum_{h = 1}^{H} Q_{t + k} (h) P_{t + k} (h) \left(1 - e^{- \lambda_{t + k} (h)}\right) \right] \\ + \mathbb {E}_{t} \left[ \exp (M_{t, t + 2}) \sum_{h = 1}^{H} Q_{t + 2} (h) P_{t + 2} (h) \right]. \\ \end{array}
$$

To iterate forward, assume that

$$
\begin{array}{l} \sum_{h = 1}^{H} Q_{t} (h) P_{t} (h) = \mathbb {E}_{t} \left[ \sum_{k = 1}^{n} \exp \left(M_{t, t + k}\right) S_{t + k} \right] + \mathbb {E}_{t} \left[ \sum_{k = 0}^{n - 1} \exp \left(M_{t, t + k}\right) \sum_{h = 1}^{H} Q_{t + k} (h) P_{t + k} (h) \left(1 - e^{- \lambda_{t + k} (h)}\right) \right] \\ + \mathbb {E}_{t} \left[ \exp \left(M_{t, t + n}\right) \sum_{h = 1}^{H} Q_{t + n} (h) P_{t + n} (h) \right] \tag {A.34} \\ \end{array}
$$
...
$$
\begin{array}{l} \frac{c o v_{t} \left(\exp \left(R_{t + 1}^{D} , \exp \left(R_{t + 1}^{M}\right)\right)\right)}{v a r_{t} \left(\exp \left(R_{t + 1}^{M}\right)\right)} \left(1 + \frac{K_{t}}{P_{t}^{T} + P_{t}^{K} - P_{t}^{G}}\right) \\ = \frac{c o v_{t} (\exp (R_{t + 1}^{T} , \exp (R_{t + 1}^{M})))}{v a r_{t} (\exp (R_{t + 1}^{M}))} \frac{P_{t}^{T}}{P_{t}^{T} + P_{t}^{K} - P_{t}^{G}} \\ + \frac{c o v_{t} (\exp (R_{t + 1}^{K} , \exp (R_{t + 1}^{M})))}{v a r_{t} (\exp (R_{t + 1}^{M}))} \frac{P_{t}^{K}}{P_{t}^{T} + P_{t}^{K} - P_{t}^{G}} \\ - \frac{c o v_{t} (\exp (R_{t + 1}^{G} , \exp (R_{t + 1}^{M})))}{v a r_{t} (\exp (R_{t + 1}^{M}))} \frac{P_{t}^{G}}{P_{t}^{T} + P_{t}^{K} - P_{t}^{G}}, \\ \end{array}
$$
...
$$
\mathbb {E}_{0} \left[ u^{\prime} \left(c_{t - 1}\right) d_{t - 1} \right] = \mathbb {E}_{0} \left[ \delta u^{\prime} \left(c_{t}\right) d_{t - 1} \exp \left(r_{t}^{d}\right) \right].
$$
...
$$
\exp \big (p d_{t - 1}^{m} (h + 1) \big) = \mathbb {E}_{t} [ \exp \big (M_{t} + p d_{t}^{m} (h) + \Delta \log D i v_{t} \big) ],
$$
...
$$
\begin{array}{l} \lim_{h \rightarrow \infty} A (h) / h = - i_{0} (1) + \frac{1}{2} B (\infty)^{\prime} \Sigma B (\infty) - B (\infty)^{\prime} \Sigma^{\frac{1}{2}} \Lambda_{0}, \\ B (\infty)^{\prime} = \lim_{h \rightarrow \infty} B (h)^{\prime} = - e_{i}^{\prime} \left(I - \left(\Psi - \Sigma^{\frac{1}{2}} \Lambda_{1}\right)\right)^{- 1} \\ \end{array}
$$
...
$$
\begin{array}{l} \lim_{h \rightarrow \infty} \mathbb {E}_{t} [ \log P_{t + 1}^{m} (h - 1) - \log P_{t}^{m} (h) ] \\ = i_{0} (1) - \frac{1}{2} \left(B^{m} (\infty) + e_{\Delta d} + e_{x} + e_{\pi}\right)^{\prime} \Sigma \left(B^{m} (\infty) + e_{\Delta d} + e_{x} + e_{\pi}\right) \\ + \left(B^{m} (\infty) + e_{\Delta d} + e_{x} + e_{\pi}\right)^{\prime} \Sigma^{\frac{1}{2}} \Lambda_{0} + B^{m} (\infty)^{\prime} (\Psi - I) z_{t} + \left(e_{\Delta d} + e_{x} + e_{\pi}\right)^{\prime} \Psi z_{t}, \\ \end{array}
$$
...
$$
\begin{array}{l} \big (B^{m} (\infty) + e_{\Delta d} + e_{x} + e_{\pi} \big)^{\prime} = B^{m} (\infty)^{\prime} + \big (e_{\Delta d} + e_{x} + e_{\pi} \big)^{\prime} \big (I - (\Psi - \Sigma^{\frac{1}{2}} \Lambda_{1}) \big) \big (I - (\Psi - \Sigma^{\frac{1}{2}} \Lambda_{1}) \big)^{- 1} \\ = \left(- e_{i}^{\prime} + (e_{\Delta d} + e_{x} + e_{\pi})^{\prime} (\Psi - \Sigma^{\frac{1}{2}} \Lambda_{1}) + (e_{\Delta d} + e_{x} + e_{\pi}) (I - (\Psi - \Sigma^{\frac{1}{2}} \Lambda_{1}))\right) (I - (\Psi - \Sigma^{\frac{1}{2}} \Lambda_{1}))^{- 1} \\ = \left(- e_{i}^{\prime} + e_{\Delta d} + e_{x} + e_{\pi}\right)^{\prime} \left(I - \left(\Psi - \Sigma^{\frac{1}{2}} \Lambda_{1}\right)\right)^{- 1}. \\ \end{array}
$$
...
$$
\psi_{t} \left(w_{t}, z_{t}\right) = \delta^{t} \frac{w_{t}^{1 - \gamma}}{1 - \gamma}
$$
...
$$
g_{t} (z_{t}) = \max_{x_{t}} \mathbb {E}_{t} \left[ f_{t + 1} (z_{t + 1}) \frac{\left(x_{t}^{\prime} \exp (r_{t + 1})\right)^{1 - \gamma}}{1 - \gamma} \right]
$$

such that  $1 = x_{t}^{\prime}1$ . Plug  $g_{t}(z_{t})$  back into  $\psi_t(w_t,z_t)$  to get

$$
\psi_{t} (w_{t}, z_{t}) = \delta^{t} w_{t}^{1 - \gamma} \max_{w c_{t}} \left\{\frac{w c_{t}^{\gamma - 1}}{1 - \gamma} + \delta (1 - \frac{1}{w c_{t}})^{1 - \gamma} g_{t} (z_{t}) \right\}
$$
...
$$
\begin{array}{l} \psi_{t} (w_{t}, z_{t}) = \delta^{t} w_{t}^{1 - \gamma} \left[ \frac{w c_{t}^{\gamma - 1}}{1 - \gamma} + \delta (1 - \frac{1}{w c_{t}})^{1 - \gamma} \frac{(w c_{t} - 1)^{\gamma}}{\delta (1 - \gamma)} \right] \\ = \delta^{t} \frac{w_{t}^{1 - \gamma}}{1 - \gamma} \left[ w c_{t}^{\gamma - 1} + w c_{t}^{\gamma - 1} (w c_{t} - 1) \right] \\ = \delta^{t} \frac{w_{t}^{1 - \gamma}}{1 - \gamma} w c_{t}^{\gamma} \\ \end{array}
$$
...
$$
\begin{array}{l} x_{t} = \arg \max_{x_{t}} \mathbb {E} \left[ \exp ((1 - \gamma) r_{t + 1}^{p}) \right] \\ = \arg \max_{x_{t}} \exp (\mathbb {E} \left[ (1 - \gamma) r_{t + 1}^{p} \right] + \frac{1}{2} v a r ((1 - \gamma) r_{t + 1}^{p})) \\ = \arg \max_{x_{t}} \mathbb {E} \left[ (1 - \gamma) r_{t + 1}^{p} \right] + \frac{1}{2} v a r ((1 - \gamma) r_{t + 1}^{p}) \\ \end{array}
$$
...
$$
t b_{t} = a_{t} - \sum_{\iota} v_{t} (\iota) - a_{t - 1} \sum_{\iota} x_{F, t - 1} (\iota) (1 + d_{t}^{*} (\iota) + \rho_{t}^{*} (\iota)) + a_{t - 1}^{*} \sum_{\iota} x_{H, t - 1}^{*} (1 + d_{t} (\iota) + \rho_{t} (\iota))
$$

Recall the dynamics of home household wealth given by Eq. (9.7):

$$
a_{t} = a_{t - 1} \left(\sum_{\iota} x_{H, t - 1} (\iota) (1 + d_{t} (\iota) + \rho_{t} (\iota) + \sum_{\iota} x_{F, t - 1} (\iota) (1 + d_{t}^{*} (\iota) + \rho_{t}^{*} (\iota)\right) + s_{t}.
$$

Plug in the  $tb_{t}$  expression to get:

$$
t b_{t} = s_{t} - \left(\sum_{\iota} v_{t} (\iota) - \sum_{\iota} v_{t - 1} (\iota) \left(1 + \rho_{t} (\iota) + d_{t} (\iota)\right)\right).
$$
...
$$
\begin{array}{l} \frac{\mathbb {E}_{t} \left[ \Delta e_{t + 1} + r_{t} - r_{t}^{*} \right]}{\omega v a r_{t} \left(\Delta e_{t + 1}\right) / m} = \exp (\bar {r}) n \psi_{t} - \exp (\bar {e} + \bar {r}^{*} - \bar {r}) b_{H, t} \\ \Rightarrow \mathbb {E}_{t} [ \Delta e_{t + 1} + r_{t} - r_{t}^{*} ] = \chi_{1} \psi_{t} - \chi_{2} \frac{b_{H , t}}{\bar {Y}}, \\ \end{array}
$$
...
$$
\begin{array}{l} - \gamma (\hat {c}_{t} (a) - \hat {c}_{t}^{*} (a)) - \alpha \hat {c}_{F, t} (a) + (1 - \alpha) \hat {c}_{F, t}^{*} (a) - (1 - \alpha) c_{H, t}^{*} (a) + \alpha \hat {c}_{H, t} (a) = 0 \\ \Rightarrow (1 - \gamma) \alpha \hat {c}_{H, t} (a) + (\alpha \gamma - \gamma - \alpha) \hat {c}_{F, t} (a) + (\gamma - 1) (1 - \alpha) \hat {c}_{H, t}^{*} (a) + (\gamma \alpha + 1 - \alpha) \hat {c}_{F, t}^{*} (a) = 0 \tag {A.36} \\ \end{array}
$$
...
$$
\begin{array}{l} c o v_{t} (\hat {e}_{t + 1}, \hat {c}_{t + 1}^{*} - \hat {c}_{t + 1}) = \frac{\gamma}{\phi} \left(v a r (\hat {y}_{t + 1} - \hat {y}_{t + 1}^{*}) - (1 - \phi) c o v_{t} (\hat {\tau}_{t + 1} - \hat {\tau}_{t + 1}^{*}, \hat {y}_{t + 1} - \hat {y}_{t + 1}^{*})\right) \\ = \frac{\gamma}{\phi} \left(2 \sigma_{y}^{2} - 2 (1 - \phi) \rho \sigma_{y} \sigma_{\tau}\right), \\ \end{array}
$$
...
$$
\sigma_{\tau}^{2} = v a r_{t} (\hat {\tau}_{t + 1}) = v a r_{t} (\hat {\tau}_{t + 1}^{*}).
$$
