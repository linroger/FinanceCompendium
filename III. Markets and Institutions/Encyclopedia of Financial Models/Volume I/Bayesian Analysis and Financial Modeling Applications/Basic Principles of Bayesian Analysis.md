...
$$ f \left(y _ {1}, y _ {2}, \dots , y _ {n} \mid \theta\right)
$$
...
$$
L \left(\theta \mid y _ {1}, y _ {2}, \dots , y _ {n}\right) = f \left(y _ {1}, y _ {2}, \dots , y _ {n} \mid \theta\right) \tag {2}
$$
...
$$
\begin{array}{l} L \left(\theta \mid x _ {1}, x _ {2}, \dots , x _ {2 0}\right) = \prod_ {i = 1} ^ {2 0} p \left(X = x _ {i} \mid \theta\right) = \prod_ {i = 1} ^ {2 0} \frac {\theta^ {x _ {i}}}{x _ {i} !} e ^ {- \theta} \\ = \frac {\theta^ {\sum_ {i = 1} ^ {2 0} x _ {i}}}{\prod_ {i = 1} ^ {2 0} x _ {i} !} e ^ {- 2 0 \theta} \tag {4} \\ \end{array}
$$
...
$$
L \left(\theta \mid x _ {1}, x _ {2}, \dots , x _ {2 0}\right) \propto \theta^ {\sum_ {i = 1} ^ {2 0} x _ {i}} e ^ {- 2 0 \theta} \tag {5}
...
$$
\widehat {\theta} = \overline {{x}} = \frac {\sum_ {i = 1} ^ {2 0} x _ {i}}{2 0}
$$
...
$$
\begin{array}{l} L \left(\mu , \sigma \mid y _ {1}, y _ {2}, \dots , y _ {1 5 4 8}\right) \\ = \prod_ {i = 1} ^ {1 5 4 8} f (y _ {i}) \\ = \left(\frac {1}{\sqrt {2 \pi} \sigma}\right) ^ {1 5 4 8} e ^ {- \sum_ {i = 1} ^ {1 5 4 8} \frac {(y _ {i} - \mu) ^ {2}}{2 \sigma^ {2}}} \\ \propto \sigma^ {- 1 5 4 8} e ^ {- \sum_ {i = 1} ^ {1 5 4 8} \frac {\left(y _ {i} - \mu\right) ^ {2}}{2 \sigma^ {2}}} \tag {7} \\ \end{array}
$$
...
$$
D _ {i} = 0 \quad i f P _ {i + 1} = P _ {i}
$$

$$
D _ {i} = 1 \text {i f} P _ {i + 1} > P _ {i}
$$
