...
$$
\begin{array}{l} O A S_{i t} = \alpha_{t} + \beta_{t} \text{Expected Default Cost}_{i t} \\ + \gamma_{t} \text{Expected Liquidity Cost}_{i t} + \eta_{i t} \\ \end{array}
$$
...
$$
\Delta O A S_{i t, t + j} = \alpha_{t} + \theta_{t} \hat{\eta}_{i t} + \delta_{t} \text{Month Dummy}_{t} + e_{i t} \tag {2}
$$
...
$$
\begin{array}{l} O A S_{i t} = \alpha_{t} + \beta_{t} C D S_{i t} + \gamma_{t} L C S_{i t} + \phi_{t} L C S V o l_{i t} \\ + \delta_{t} \text{Month Dummy}_{t} + \eta_{i t} \tag {3} \\ \end{array}
$$
...
$$
\begin{array}{l} \Delta O A S_{i t} = \alpha_{t} + \beta_{t} \Delta C D S_{i t} + \gamma_{t} \Delta L C S_{i t} \\ + \delta_{t} \text{Month Dummy}_{t} + \eta_{i t} \tag {4} \\ \end{array}
$$
