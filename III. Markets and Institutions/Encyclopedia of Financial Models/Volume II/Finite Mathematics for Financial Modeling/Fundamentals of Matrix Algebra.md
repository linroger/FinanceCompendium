...
$$
\mathbf {w} = \left[ \begin{array}{c c c} w _ {1} & w _ {2} \dots w _ {N} \end{array} \right]
$$
...
$$
\mathsf {a} = \left[ \begin{array}{l} a _ {1} \\ a _ {2} \\ \vdots \\ a _ {N} \end{array} \right]
$$
...
$$
\mathbf {A} = \left[ \begin{array}{c c c c c} a _ {1, 1} & \cdot & a _ {1, j} & \cdot & a _ {1, m} \\ . & \cdot & . & \cdot & . \\ a _ {i, 1} & \cdot & a _ {i, j} & \cdot & a _ {i, m} \\ . & \cdot & . & \cdot & . \\ a _ {n, 1} & \cdot & a _ {n, j} & \cdot & a _ {n, m} \end{array} \right]
$$
...
$$
\mathbf {A} = \left\{a _ {i j} \right\} _ {n m} \quad \mathrm {o r} \quad \mathbf {A} = \left[ a _ {i j} \right] _ {n m}
...
$$
\mathbf {A} = \left[ \begin{array}{c c c c c c} a _ {1 1} & 0 & \cdot & \cdot & \cdot & 0 \\ 0 & a _ {2 2} & \cdot & \cdot & \cdot & 0 \\ \cdot & \cdot & \cdot & & & \cdot \\ \cdot & \cdot & & \cdot & & \cdot \\ \cdot & \cdot & & & \cdot & 0 \\ 0 & 0 & \cdot & \cdot & 0 & a _ {n n} \end{array} \right]
$$
...
$$
\begin{array}{l} \mathbf {A} = \left[ \begin{array}{c c c c c c} a _ {1 1} & a _ {1 2} & \cdot & \cdot & \cdot & a _ {1 n} \\ a _ {2 1} & a _ {2 2} & \cdot & \cdot & \cdot & a _ {2 n} \\ \cdot & \cdot & \cdot & & & \cdot \\ \cdot & \cdot & & \cdot & & \cdot \\ \cdot & \cdot & & & \cdot & \cdot \\ a _ {n 1} & a _ {n 2} & \cdot & \cdot & \cdot & a _ {n n} \end{array} \right] \Rightarrow \\ \mathrm {d g} \mathbf {A} = \left[ \begin{array}{c c c c c c} a _ {1 1} & 0 & \cdot & \cdot & \cdot & 0 \\ 0 & a _ {2 2} & \cdot & \cdot & \cdot & 0 \\ \cdot & \cdot & \cdot & & & \cdot \\ \cdot & \cdot & & \cdot & & \cdot \\ \cdot & \cdot & & & \cdot & \cdot \\ 0 & 0 & \cdot & \cdot & \cdot & a _ {n n} \end{array} \right] \\ \end{array}
$$
...
$$
| \mathbf {A} | = \sum (- 1) ^ {t (j _ {1}, \dots , j _ {n})} \prod_ {i = 1} ^ {n} a _ {i j}
...
$$
\begin{array}{l} | \mathbf {A} | = (- 1) ^ {0} a _ {1 1} a _ {2 2} + (- 1) ^ {1} a _ {1 2} a _ {2 1} \\ = a _ {1 1} a _ {2 2} - a _ {1 2} a _ {2 1}. \\ \end{array}
$$
...
$$
\begin{array}{l} a _ {1, 1} x _ {1} + \dots + a _ {1, m} x _ {m} = b _ {1} \\ \ldots \\ a _ {n, 1} x _ {1} + \dots + a _ {1, m} x _ {m} = b _ {m} \\ \end{array}
$$

The  $n\times m$  matrix:

$$
\mathbf {A} = \left[ \begin{array}{c c c c c} a _ {1, 1} & \cdot & a _ {1, j} & \cdot & a _ {1, m} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {i, 1} & \cdot & a _ {i, j} & \cdot & a _ {i, m} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {n, 1} & \cdot & a _ {n, j} & \cdot & a _ {n, m} \end{array} \right]
...
$$
[ \mathbf {A b} ] = \left[ \begin{array}{c c c c c} a _ {1, 1} & \cdot & a _ {1, j} & \cdot & a _ {1, m}   b _ {1} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {i, 1} & \cdot & a _ {i, j} & \cdot & a _ {i, m}   b _ {i} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {n, 1} & \cdot & a _ {n, j} & \cdot & a _ {n, m}   b _ {n} \end{array} \right]
$$
...
$$
\left[ \begin{array}{c c c c c} \cdot & a _ {1, i _ {1}} & \cdot & a _ {1, i _ {p}} & \cdot \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ \cdot & a _ {n, i _ {1}} & \cdot & a _ {n, i _ {p}} & \cdot \end{array} \right]
...
$$
\beta_ {1} a _ {1, i _ {1}} + \dots + \beta_ {p} a _ {1, i _ {p}} = 0
$$
...
$$
\beta_ {1} a _ {n, i _ {1}} + \dots + \beta_ {p} a _ {n, i _ {p}} = 0
$$
...
$$
\lambda_ {1} a _ {i _ {1}, 1} + \dots + \lambda_ {q} a _ {i _ {q}, 1} = 0
$$
...
$$
\lambda_ {1} a _ {i _ {1}, m} + \dots + \lambda_ {q} a _ {i _ {q}, m} = 0
$$
...
$$
\mathbf {x} ^ {T} = \left[ \begin{array}{c} x _ {1} \\ \cdot \\ \cdot \\ \cdot \\ x _ {n} \end{array} \right].
$$
...
$$
\mathbf {x} + \mathbf {y} = \left[ x _ {1} + y _ {1}, \dots , x _ {n} + y _ {n} \right]
$$

This definition can be generalized to any number  $N$  of summands:

$$
\sum_ {i = 1} ^ {N} \mathbf {x} _ {i} = \left[ \sum_ {i = 1} ^ {N} x _ {1 i}, \dots , \sum_ {i = 1} ^ {N} y _ {n i} \right]
$$
...
$$ a \mathbf {x} = [ a x _ {1}, \dots , a x _ {n} ].
$$
...
$$
\mathbf {x} \cdot \mathbf {y} = \sum_ {i = 1} ^ {n} x _ {i} y _ {i}.
$$
...
$$
\mathbf {A} ^ {T} = \left\{a _ {j i} \right\} _ {m n}
$$
...
$$
\mathbf {A} + \mathbf {B} = \left\{a _ {i j} + b _ {i j} \right\} _ {n m}.
$$
...
$$
\sum_ {s = 1} ^ {N} \mathbf {A} _ {i} = \left\{\sum_ {s = 1} ^ {N} a _ {s _ {i j}} \right\} _ {n m}
...
$$ c \mathbf {A} = \mathbf {A} c = \left\{c a _ {i j} \right\} _ {n m}.
$$
...
$$
\mathbf {C} = \mathbf {A B} = \left\{c _ {i j} \right\} = \left\{\sum_ {t = 1} ^ {p} a _ {i t} b _ {t j} \right\}.
$$
...
$$
\begin{array}{l} \operatorname {A d j} (\mathbf {A}) = \left[ \begin{array}{c c c c c} \alpha_ {1, 1} & \cdot & \alpha_ {1, j} & \cdot & \alpha_ {1, n} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ \alpha_ {i, 1} & \cdot & \alpha_ {i, j} & \cdot & \alpha_ {i, n} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ \alpha_ {n, 1} & \cdot & \alpha_ {n, j} & \cdot & \alpha_ {n, n} \end{array} \right] ^ {T} \\ = \left[ \begin{array}{c c c c} \alpha_ {1, 1} \cdot \alpha_ {2, 1} \cdot \alpha_ {n, 1} \\ \cdot \cdot \cdot \cdot \cdot \cdot \cdot \\ \alpha_ {1, i} \cdot \alpha_ {2, i} \cdot \alpha_ {n, i} \\ \cdot \cdot \cdot \cdot \cdot \cdot \cdot \\ \alpha_ {1, n} \cdot \alpha_ {2, n} \cdot \alpha_ {n, n} \end{array} \right] \\ \end{array}
$$
...
$$
\mathbf {A} ^ {- 1} = \frac {\operatorname {A d j} (\mathbf {A})}{| \mathbf {A} |}
$$
...
$$
\begin{array}{l} (\mathbf {A} - \lambda \mathbf {I}) \mathbf {x} = \left[ \begin{array}{c c c c c} a _ {1, 1} - \lambda & \cdot & a _ {1, j} & \cdot & a _ {1, n} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {i, 1} & \cdot & a _ {i, i} - \lambda & \cdot & a _ {i, n} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {n, 1} & \cdot & a _ {n, j} & \cdot & a _ {n, n} - \lambda \end{array} \right] \\ \left[ \begin{array}{c} x _ {1} \\ \cdot \\ x _ {i} \\ \cdot \\ x _ {n} \end{array} \right] = 0 \\ \end{array}
$$
...
$$
| \mathbf {A} - \lambda \mathbf {I} | = \left| \begin{array}{c c c c c} a _ {1, 1} - \lambda & \cdot & a _ {1, j} & \cdot & a _ {1, n} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {i, 1} & \cdot & a _ {i, i} - \lambda & \cdot & a _ {i, n} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {n, 1} & \cdot & a _ {n, j} & \cdot & a _ {n, n} - \lambda \end{array} \right| = 0
$$
...
$$
\left[ \begin{array}{c c c c c} a _ {1, 1} - \lambda_ {s} & \cdot & a _ {1, j} & \cdot & a _ {1, n} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {i, 1} & \cdot & a _ {i, i} - \lambda_ {s} & \cdot & a _ {i, n} \\ \cdot & \cdot & \cdot & \cdot & \cdot \\ a _ {n, 1} & \cdot & a _ {n, j} & \cdot & a _ {n, n} - \lambda_ {s} \end{array} \right] \left[ \begin{array}{c} x _ {1 _ {s}} \\ \cdot \\ x _ {i _ {s}} \\ \cdot \\ x _ {n _ {s}} \end{array} \right] = 0
$$
