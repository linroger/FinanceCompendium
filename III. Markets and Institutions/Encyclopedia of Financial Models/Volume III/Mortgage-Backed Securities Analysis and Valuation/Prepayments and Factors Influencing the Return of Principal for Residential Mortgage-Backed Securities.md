...
The emergence of this activity has a number of implications. The most important realization is that home prices and mortgage credit performance are closely linked. In this light, the strong credit performance exhibited by the mortgage market since the 1950s was arguably skewed higher by decades of steady home price appreciation. This assertion implicitly argues that res identical mortgage loans are riskier assets than previously assumed. In addition, mortgage underwriters have placed undue faith in metrics such as credit scores which, while valuable, cannot serve as reliable proxies for borrowers' willingness to service their loans during times of financial distress.
...
- The most common way to assess prepayment speeds within a product group at various levels of refinancing incentive is with the prepayment S-curves. These curves show pre payment speeds for different levels of mortgage rates and/or refinancing incentives.
