...
$$
\bigcup_ {i = 1} ^ {\infty} a _ {i}
$$

That is,

$$
P (\{a _ {i} \}) = 0, \text {f o r a l l} a _ {i}
$$

$$
P \left(\bigcup_ {i = 1} ^ {\infty} a _ {i}\right) = 0 \tag {2}
$$
...
$$
\lim  _ {\Delta x \rightarrow 0} \frac {F (x + \Delta x) - F (x)}{\Delta x} = \frac {\partial F (x)}{\partial x} \equiv f (x) \tag {6}
$$
...
$$
F (x) = \int_ {\mathrm {R}} f (t) \cdot 1 _ {(- \infty , x ]} d t \tag {8a}
$$

$$
F (x) = \int_ {- \infty} ^ {\infty} f (t) \cdot 1 _ {(- \infty , x ]} d t \tag {8b}
$$
...
$$
\begin{array}{l} P (X \leq x) = \int_ {- \infty} ^ {\infty} 1 _ {(- \infty , x ]} (t) f (t) d t \\ P (X \in (a, b ]) = \int_ {- \infty} ^ {\infty} 1 _ {(a, b ]} (t) f (t) d t \\ \end{array}
$$
...
$$
\begin{array}{l} \operatorname {V a r} (X) = \int_ {- \infty} ^ {\infty} (x - E (X)) ^ {2} \cdot f (x) d x \\ = \int_ {- \infty} ^ {\infty} (x - \mu) ^ {2} \cdot f (x) d x \tag {12} \\ \end{array}
