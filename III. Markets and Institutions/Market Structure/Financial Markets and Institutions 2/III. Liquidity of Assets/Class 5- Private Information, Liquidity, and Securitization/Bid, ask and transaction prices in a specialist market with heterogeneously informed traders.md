...
random variable independent of  $V$  and any information about  $V$  and independent across traders. We allow the possibility that  $\rho$  might follow a different distribution for the informed and the uninformed.
...
tion. We shall consider two distributions of the liquidity traders' preference parameters  $\rho$ : the case where  $\rho$  equals 0 or  $\infty$ , each with probability one-half, which is the case of perfectly inelastic liquidity supply and demand, and the case where  $\rho$  is uniformly distributed on  $(0,2)$ . No information arrives exogenously during the trading period.
...
The model discussed in the previous section is based on a particular normalization of reservation prices that was mathematically convenient. This normalization took the form of the specialist having a  $\rho$  of one, while the median of the  $\rho$ 's of the traders was one. Another normalization that is of
