...
Except as provided below, the SPV will only purchase U.S. dollar-denominated commercial paper (including asset-backed commercial paper ("ABCP")) that is rated at least A1/P1/F1 by a major nationally recognized statistical rating organization (NRSRO) or, if rated by multiple major NRSROs, is rated at least A1/P1/F1 by two or more major NRSROs, in each case subject to review by the Federal Reserve.
...
Pricing: For commercial paper rated A1/P1/F1, pricing will be based on the then-current 3-month overnight index swap ("Is") rate plus 110 basis points. For commercial paper rated A2/P2/F2, pricing will be based on the then-current 3-month Is rate plus 200 basis points.
...
Termination date: The SPV will cease purchasing commercial paper on March 31, 2021, unless the Board and the Department of the Treasury extend the facility. The New York Fed will continue to fund the SPV after such date until the SPV's underlying assets mature.<sup>1</sup>