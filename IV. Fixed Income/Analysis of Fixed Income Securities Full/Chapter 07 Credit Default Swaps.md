...
Ever since its introduction in mid 1990's, the growth of the CDS market has been exponential. Although suffered a short cutback after the 2008 Lehman crisis, the market has rebounded and stayed healthy ever since.
...
$$
\begin{align}
V_{\text{prot}} &= V_{\text{prem}} \\
(1 - R) \sum_{i=1}^{4n} P(t, T_i) [Q(t, T_{i-1}) - Q(t, T_i)] &= \frac{s}{4} \sum_{i=1}^{4n} P(t, T_i) Q(t, T_i) \\
&= \begin{cases}
U_{\text{HG}} + \frac{0.01}{4} \sum_{i=1}^{4n} P(t, T_i) Q(t, T_i) \\
U_{\text{HY}} + \frac{0.05}{4} \sum_{i=1}^{4n} P(t, T_i) Q(t, T_i)
\end{cases}
\end{align}
$$
...
| Fund Name | Vintage Year | Fundraising Status | Fund/Target Size ($mn) | Fund Manager | Manager Location |
|---|---|---|---|---|---|
| Alcentra Strategic Credit Fund II | 2020 | Raising | 1,100.40 | Alcentra | UK |
| Arrow Credit Opportunities | 2020 | Second Close | 2,200.81 | AGG Capital Management | UK |
| Clessidra Restructuring Fund | 2019 | First Close | - | Clessidra Capital Partners | Italy |
| Italian Recovery Fund II | 2020 | Raising | 330.12 | DEA Capital Alternative Funds | Italy |
| LCM Credit Opportunities Strategy 4 | 2020 | Raising | 4,401.62 | LCM Partners | UK |
| M&G Debt Opportunities Fund V | 2020 | Raising | 1,110.78 | M&G Investments | UK |
| Triton Debt Opportunities Fund II | 2019 | Second Close | - | Triton | Jersey |
