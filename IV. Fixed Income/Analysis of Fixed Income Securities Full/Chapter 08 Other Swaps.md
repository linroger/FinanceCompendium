...
M the number of years corresponding to the deal maturity i the number of years $(0 < i \leq M)$


$\phi_i$ is the fixed-leg year fractions for the interval $[T_{i-1}, T_i]$

$\psi_i$ is the floating-leg year fractions for the interval $[T_{i-1}, T_i]$
...
Eiis the closing level of the index on date i or, at Expiration Date, the options final settlement level.| Variance Calculation | σ² = 10,000 × 252 × ∑ᵢ₌₁ᴺᴬᶜᵗᵘᵃˡReturnᵢ²/Nᴱˣᵖᵉᶜᵗᵉᵈ where Returnⱼ = ln(Eⱼ/Eⱼ₋₁), Nᴱˣᵖᵉᶜᵗᵉᵈ = expected trading days, Nᴬᶜᵗᵘᵃˡ = actual trading days, E₀ = index level on Trade Date, Eᵢ = index level on date i |
