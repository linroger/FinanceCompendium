...
<table><tr><td>Calculate</td><td>Key</td><td>Answer</td></tr><tr><td>(750 x 12) ÷ 360</td><td>750 ENTER 12 x 360</td><td>25.00</td></tr><tr><td>360 ÷ (750 x 12)</td><td>360 ENTER 750 ENTER 12 x ÷</td><td>0.04</td></tr><tr><td>[(456 - 75) ÷ 19.2] x (68 ÷ 1.9)456 ENTER 75 - 19.2 ÷ 68 ENTER 1.9 ÷ x</td><td>710.20</td><td></td></tr><tr><td>(3 + 4) ÷ (5 + 6)</td><td>3 ENTER 4 + 5 ENTER 6 ÷</td><td></td></tr><tr><td>√[(9 x 12) x (4 - 2)3]</td><td>9 ENTER 12 x 4 ENTER 2 - 3 GOLD yx x GOLD √</td><td>29.39</td></tr></table>
...
Stores the sum deposited

Stores the period as 12 half-years (6 years)

Stores the semi-annually compounded rate

Sets the periodic payments to 0

The future value at maturity
...
10,000 FV  $\mathrm{FV} = 10,000$

10 I% YR I%YR= 10

0 PMT  $\mathrm{PMT} = 0$

PV  $\mathrm{PV} = -2,313.77$

# Description

Cleared stack and TVM variables

Stores the period as 30 half-years (15 years)

Stores the par value of the bond in FV

Stores the semi-annually compounded rate

Sets payments to zero

The present value (a negative cash flow)

# $\underline{4} (\underline{\mathrm{d}})$  - Buying a car
...
Returns to first-level TVM menu

Stores number of six-month periods (3 yrs)

Stores monthly compounded rate

Stores amount of loan

Sets future value (balance at end) to 0
...
DATE1 DATE2 DAYS 360D 365D TODAY
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-05/032793cc-24cc-41db-abba-ce2260455eff/8cd2c5ea856696d009a45a939d3652e8c08765297a19b597fb2bd38f8c096712.jpg)  
...
Macauley's Duration  $= (1 + \mathrm{y} / \mathrm{p})$  * Modified Duration
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-05/032793cc-24cc-41db-abba-ce2260455eff/09dca4ea3753019db4510c8cf7bae278d3cbc1565736d1c495ecf99d18480cda.jpg)  
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-05/032793cc-24cc-41db-abba-ce2260455eff/a424c6d954af96f420b85d1f59c8c85c726b1bbce3def0124a6c73376ec30fe8.jpg)  
...
$\mathbf{x} = (\# \text{of days until payment}) / 365$
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-05/032793cc-24cc-41db-abba-ce2260455eff/b1d207a73b88202ab4ef6a2f3e0df80d3cc1228a76a86cd13361a1686c5fc963.jpg)  
...
DAYS BETWEEN  $= 360^{*}(\mathrm{yyyy}_{1}$  -  $\mathrm{yyyy}_2) + 30^* (\mathrm{mm}_1\mathrm{-mm}_2) + (\mathrm{dd}_1\mathrm{-dd}_2)$
...
\(\mathbf{r}_{\mathrm{ab}}\) \[1 + 0.0825^{*}92 / 360]^{365 / 92}\text{-} 1\)  
[ [1.02108]^{3.96739} - 1 ]  
0.086299
...
(3.A10b)  $\mathrm{r_{\mathrm{Sab}} = 2}*[ (1 + \mathrm{r_{\mathrm{mm}}} * \mathrm{AD} / 365)^{182.5 / \mathrm{AD}} - 1]$
...
$$
\begin{array}{l} . 0 7 9 5 3 = 2 * [ (1 + . 0 8 * 3 6 5 / 3 6 0) ^ {5} - 1 ] \\ = 2 * \left[ (1. 0 8 1 1 1) ^ {. 5} - 1 \right] \\ \end{array}
$$
...
$$
\mathrm {r} _ {\mathrm {c c}} = [ 3 6 5 / \mathrm {A D} ] ^ {*} \ln [ 1 + \mathrm {r} _ {\mathrm {m m}} * \mathrm {A D} / 3 6 0 ] \quad \text {f o r U . S . , F r a n c e , e t c .} \tag {3.A14a}
$$

$$
\mathrm {r} _ {\mathrm {c c}} = [ 3 6 5 / \mathrm {A D} ] ^ {*} \ln [ 1 + \mathrm {r} _ {\mathrm {m m}} * \mathrm {A D} / 3 6 5 ] \quad \text {f o r U . K}. \tag {3.A14b}
$$
...
$$
\begin{array}{l} \mathrm {r} _ {\mathrm {c c}} \quad = (\text {d e c i m a l}) \text {r a t e , c o n t i n u o u s l y c o m p o u n d e d a t 3 6 5 - d a y a n a n a l r a t e} \\ \mathrm {r} _ {\text {s a b}} \quad = (\text {d e c i m a l}) \text {s e m i - a n n u a l} \\ \end{array}
$$
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-05/032793cc-24cc-41db-abba-ce2260455eff/b23eda3b0388c35c3fde270885c0ad671a75d9c6bc9f8e548eecabbef160de24.jpg)  
Figure 4.1  
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-05/032793cc-24cc-41db-abba-ce2260455eff/a6df63aa2a5aebbcab992d8fcbee798bb6ffca8930b3202c3d5d669097c6fd25.jpg)  
Figure 4.2
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-05/032793cc-24cc-41db-abba-ce2260455eff/289918bff860034f8c923742bc29847b0986d0b8217821a18b66ef1c66594d9c.jpg)  
...
USD IRS 2-30 YRS xxx01 EUROPE-M/EAST INFO & CONTACTS xxx07 NORTH AMERICA [UPDATED LONDON HOURS] [UPDATED LONDON HOURS] [INTERTEST RATE SWAPS ] [UPDATED ASIA-PACIFIC USD IR OPTION VOLS xxx02 DEM GBP FRF ECU JPY xxx10 JPY COMPOSITE xxx20 USD BASIS SWAPS xxx03 ITL CHF ESP DEL NLG xxx11 AUD COMPOSITE xxx22 USD LIBOR SWAPS xxx04 DKK FIM NOK SEK xxx18 [IN-DEPTH COMPOSITES ] [FUTURES STRIPS ] IMM RUN SWAPS xxx06 DEM xxx12 FRF xxx14 IRS:NZD IDR MYR THB xxx24 USD TSY YLD CURVE xxx08 GBP xxx13 JPY xxx15 CAD INT RATE SWAPS xxx09 *US FRA UPDATED GLOBALLY BASIS SWAPS VS USD xxx19 [FORWARD RATE AGREEMENTS] IMM 90-DAY EURODOLLAR: SPOT & IMM DATES xxx25 LONDON - ITL ECU CHF ESP xxx16 9M-3Y MATURITIES xxx26 LONDON - AUD SAR xxx17 3Y-10Y MATURITIES xxx27 TOKYO - LIFFE: GBP DEM USD xxx28 TIFFE: JPY xxx29
...
Rate Quotation Absolute level or spread to UST Spread to liber
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-05/032793cc-24cc-41db-abba-ce2260455eff/8c2c7f96d28f21aeb898acc2e847e3252ebba32774a284025b5fd54d431c6147.jpg)  
...
<table><tr><td></td><td>FIXED SIDE</td><td>FLOATING SIDE</td></tr><tr><td>USD - 2 day settle</td><td></td><td></td></tr><tr><td>Payment Frequency</td><td>Semi-annual</td><td>Quarterly</td></tr><tr><td>Day Basis for Coupon</td><td>30/360</td><td>A/360</td></tr><tr><td>GBP - 0 day settle</td><td></td><td></td></tr><tr><td>Payment Frequency</td><td>Semi-annual</td><td>Quarterly</td></tr><tr><td>Day Basis for Coupon</td><td>A/365 fixed</td><td>A/365</td></tr><tr><td>EUR - 2 day settle</td><td></td><td></td></tr><tr><td>Payment Frequency</td><td>Annual</td><td>Semi-annual</td></tr><tr><td>Day Basis for Coupon</td><td>30/360</td><td>A/360</td></tr><tr><td>JPY - 2 day settle</td><td></td><td></td></tr><tr><td>Payment Frequency</td><td>Semi-annual</td><td>Semi-annual</td></tr><tr><td>Day Basis for Coupon</td><td>A/365 fixed</td><td>A/360</td></tr><tr><td>CAD - 0 day settle</td><td></td><td></td></tr><tr><td>Payment Frequency</td><td>Semi-annual</td><td>Quarterly, comp&#x27;d paid semi</td></tr><tr><td>Day Basis for Coupon</td><td>A/365 fixed</td><td>A/365</td></tr></table>
...
$$
\mathrm {N P V} (\text {s w a p} \quad \text {r} \quad \text {f i x e d}) = \mathrm {P V} (\text {f i x e d} \quad \text {c o u p o n} \quad \text {b o n d}) - \mathrm {P V} (\text {f l o a t} \quad \text {b o n d}) \tag {4.1a}
$$
