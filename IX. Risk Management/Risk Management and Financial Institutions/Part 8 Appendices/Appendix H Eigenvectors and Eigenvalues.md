...
cssclasses: academia
title: Appendix H
linter-yaml-title-alias: Appendix H
---
...
\left( \begin{array}{c c} 1 & - 1 \\ 2 & 4 \end{array} \right) \left( \begin{array}{c} x _ {1} \\ x _ {2} \end{array} \right) = 3 \left( \begin{array}{c} x _ {1} \\ x _ {2} \end{array} \right)
...
$$
\mathbf {x} = \left( \begin{array}{c} 0. 4 4 7 \\ - 0. 8 9 4 \end{array} \right)
...
\mathbf {x} = \left( \begin{array}{c} 0. 7 0 7 \\ - 0. 7 0 7 \end{array} \right)
