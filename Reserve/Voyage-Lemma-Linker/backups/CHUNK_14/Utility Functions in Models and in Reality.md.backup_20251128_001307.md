...
key_concepts:
  - Chapter overview and key definitions
cssclasses: academia
---
...
Table 5.5: Relative risk premia for a fair gamble of the fraction $\alpha$ of your consumption $u(c)=c^{1-\gamma}/(1-\gamma)$ , the certainty equivalent $c^{*}$ of the risky plan is determined by
$$
...
$$
which is independent of $(c,z)$ . Therefore the utility function (5.13) is referred to as CES (Constant Elasticity of Substitution) utility. For the Cobb-Douglas utility function
$$
