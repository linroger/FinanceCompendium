...
tags:
  - jpmorgan_chase_cio_losses
  - chief_investment_office_risk
  - synthetic_credit_portfolio
  - london_whale_trading
  - value_at_risk_model_failure
  - basel_three_compliance
aliases:
  - JP Morgan Case Study
  - JPMorgan Chase
  - London Whale Case
key_concepts:
  - chief_investment_office_synthetic_credit_trading
  - var_model_manipulation_and_breaches
  - risk_weighted_asset_reduction_strategy
  - margin_call_induced_liquidation
  - credit_default_swap_index_concentration
  - performance_based_trading_incentives
  - governance_failures_at_cio
---
...
JP Morgan counts undisputedly as one of the major winners in the crisis, its reputation as a "rock" for the financial system staying virtually unscathed, at least until May 2012. JP Morgan is the largest bank in the US with 259,000 employees, a diversified range of operations, a strong capital base (stockholder equity of \$204 bn at the end of 2012) and an exceptional ability to grow through external acquisitions. Total net revenue for 2012 reached \$97 bn and net income \$21 bn. Chase Manhattan bank is itself the result of the merger of more than 1,200 predecessor institutions, including:
...
\begin{tabular}{|l|r|r|}
\hline
USD mn & 2012 & 2011 \\ \hline
Total assets & 2,359,141 & 2,265,792 \\ \hline
Loans & 733,796 & 723,720 \\ \hline
Deposits & 1,193,593 & 1,127,806 \\ \hline
Excess deposits & 459,797 & 404,086 \\ \hline
\end{tabular}
\end{document}
```
...
The CIO is separate from the Treasury and invests excess cash in Treasuries, agencies, mortgage-backed securities, high quality securities, corporate debt and other domestic and overseas assets. In 2006, the CIO started trading synthetic credit derivatives, which led to establishing the Synthetic Credit Portfolio (SCP). The SCP, whose notional grew rapidly from \$4 bn in 2008 to \$51 bn in 2011 and where all the losses took place, was a relatively small subset of the CIO's total portfolio. Most of CIO's other assets comprised of \$323 bn of available-for-sale securities with an average rating of AA+, as well as \$175 bn deposited at central banks, all run quite conservatively.
...
\begin{tabular}{|l|r|}
\hline
Year & SCP revenues (USD mn) \\ \hline
2008 & 170 \\ \hline
2009 & 1,050 \\ \hline
2010 & 149 \\ \hline
2011 & 453 \\ \hline
...
\begin{tabular}{|l|r|}
\hline
Position in March 2012 USD bn & JP Morgan CIO \\ \hline
US IG credit index & 62 \\ \hline
European IG credit index & 71 \\ \hline
US HY credit index & 22 \\ \hline
Total & 155 \\ \hline
\end{tabular}
\end{document}
``` 
...
\hline
Ytd Loss & 100 & 169 & 718 & 2,132 & 3,695 & 4,400 & 6,200 \\ \hline
\end{tabular}
\end{document}
``` 
...
\hline
Total VaR (USD mn) & Average & Min & Max \\ \hline
CIB trading Fixed income & 83 & 47 & 131 \\ \hline
Foreign exchange & 10 & 6 & 22 \\ \hline
Equities & 21 & 12 & 35 \\ \hline
Commodities & 15 & 11 & 27 \\ \hline
Diversification & -45 & & \\ \hline
CIB trading VaR & 84 & 50 & 128 \\ \hline
CIO VaR & 92 & 5 & 196 \\ \hline
\end{tabular}
\end{document}
```
