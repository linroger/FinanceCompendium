...
tags:
  - corporate_bond_indentures
  - bond_covenants
  - make_whole_call_provisions
  - negative_pledge_covenants
  - bond_trustee_role
  - defeasance_provisions
  - covenant_defaults
  - indenture_modification
aliases:
  - Bond Contracts
  - Bond Indentures
  - Corporate Bonds
...
key_concepts:
  - indenture_contract_structure
  - optional_redemption_features
  - negative_pledge_clause
  - sale_leaseback_restrictions
  - events_of_default
  - trustee_representation
  - majority_bondholder_consent
  - defeasance_and_discharge
cssclasses: academia
---
...
\begin{tabular}{|l|c|c|}
\hline
 & Per Note & Total \\ \hline
Initial public offering price(1) & 100\% & \$750,000,000 \\ \hline
Underwriting discount & 0.325\% & \$2,437,500 \\ \hline
Proceeds, before expenses, to MGM MIRAGE(1) & 99.675\% & \$747,562,500 \\ \hline
\end{tabular}
\end{document}
```
