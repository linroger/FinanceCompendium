---
cssclasses: academia
title: Basic Concepts in Financial Intermediation
linter-yaml-title-alias: Basic Concepts in Financial Intermediation
tags:
  - risk-aversion
  - utility-theory
...
key_concepts:
  - Risk preferences (risk neutral, risk averse, risk preferring)
  - Utility functions and nonsatiation
  - Jensen's inequality for concave and convex functions
  - Certainty equivalent and risk premium
  - Portfolio diversification and correlation
  - Idiosyncratic vs systematic risk
  - Riskless arbitrage and no-arbitrage pricing
  - Call and put options
  - European vs American options
  - Option value and volatility relationship
  - Market efficiency (weak-form, semistrong-form, strong-form)
  - Market completeness and Arrow-Debreu securities
  - Primitive state-contingent claims
  - Asymmetric information and adverse selection
  - Akerlof's lemons problem and market failure
  - Signaling theory and incentive compatibility
  - Dissipative vs nondissipative signals
  - Agency theory and moral hazard
  - Shareholder-bondholder conflicts
  - Time consistency and renegotiation-proofness
  - Nash equilibrium concept
  - Prisoners' dilemma
  - Bayesian updating and belief revision
  - Liquidity dimensions (price discount, time, cost)
  - Systemic risk and interconnectedness
  - Rational disagreement and nonstationary beliefs
...
\hline
 & \multicolumn{2}{c|}{Payoff in State} & Current Price \\ \hline
Security & H & L & Price \\ \hline
R1 & \$100 & \$0 & \$40 \\ \hline
R2 & \$0 & \$100 & \$40 \\ \hline
B & \$50 & \$50 & \$43 \\ \hline
\end{tabular}
...
\begin{tabular}{|l|c|c|c|}
\hline
 & \multicolumn{3}{c|}{States of Nature} \\ \hline
Security & 1 & 2 & 3 \\ \hline
Security 1 payoffs & 10 & 20 & 15 \\ \hline
Security 2 payoffs & 15 & 0 & 25 \\ \hline
\end{tabular}
\end{document}
```  
...
\begin{tabular}{|l|c|c|}
\hline
Strategy & Boom (prob 0.5) & Bust (prob 0.5) \\ \hline
No investment, \$100 dividend at $t=0$ & \$110 & \$70 \\ \hline
\$30 investment, \$70 dividend at $t=0$ & \$200 & \$5 \\ \hline
\end{tabular}
\end{document}
```
...
FIGURE 1.4 Strategic Form for Prisoners' Dilemma Game

```latex
\begin{document}
\begin{tabular}{|l|c|c|}
\hline
 & \multicolumn{2}{c|}{Prisoner 2} \\ \hline
Prisoner 1 & Confess & Remain silent \\ \hline
Confess & 1,1 & 4,0 \\ \hline
Remain silent & 0,4 & 5,5 \\ \hline
\end{tabular}
\end{document}
```
