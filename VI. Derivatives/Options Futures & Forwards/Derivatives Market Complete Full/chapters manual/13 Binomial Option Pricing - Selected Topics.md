---
title: "Chapter 13 - Binomial Option Pricing: Selected Topics"
aliases:
...
Figure 2 performs the same experiment for put options with the same inputs. The picture is similar, as is the logic: The advantage of early exercise is receiving the strike
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-11-29/02abefd4-2dfe-4fd1-a4bc-6204fb633ac1/79d936449c470cf3717d5c332405757cc7f8a72735615860299abf1a741a4dd9.jpg) price sooner rather than later. The disadvantages are the dividends lost by giving up the stock, and the loss of insurance against the stock price exceeding the strike price.
...
$$ p = \frac {e ^ {0 . 1 5} - 0 . 8 0 2 5}{1 . 4 6 2 3 - 0 . 8 0 2 5} = 0. 5 4 4 6
$$

The expected payoff to the option in one period, from equation (5), is

$$
0. 5 4 4 6 \times \$ 1 9. 9 5 4 + (1 - 0. 5 4 4 6) \times \$ 0 = \$ 1 0. 8 6 7
$$
...
$$
\begin{array}{l} e ^ {\gamma h} = \frac {0 . 7 3 8 \times \$ 4 1}{0 . 7 3 8 \times \$ 4 1 - \$ 2 2 . 4 0 5} e ^ {0. 1 5} + \frac {- \$ 2 2 . 4 0 5}{0 . 7 3 8 \times \$ 4 1 - \$ 2 2 . 4 0 5} e ^ {0. 0 8} \\ = 1. 3 8 6 \\ \end{array}
$$
...
$T = 1.00$  years,  $\delta = 0.00$ and  $h = 1.000$
...
$$ e ^ {- 0. 3 2 6 4} \times \$ 1 0. 8 6 7 = \$ 7. 8 3 9
...
\frac {e ^ {0 . 1 5 \times 1 / 3} - 0 . 8 6 3 7}{1 . 2 2 1 2 - 0 . 8 6 3 7} = 0. 5 2 4 7
...
$$ e ^ {- 0. 2 6 9 \times 1 / 3} \left[ 0. 5 2 4 7 \times \\ (3 4. 6 7 8 + (1 - 0. 5 2 4 7) \times \\ \\ (1 2. 8 1 4 ] = \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \\ \end{array} \right]
$$

When the stock price is 43.246, the discount rate is 49.5\%, and the option price is

$$ e ^ {- 0. 4 9 5 \times 1 / 3} \left[ 0. 5 2 4 7 \times \$ 1 2. 8 1 4 + (1 - 0. 5 2 4 7) \times \$ 0 \right] = \$ 5. 7 0 0
...
$$
\text {H e a d s :} \quad Z _ {n} - Z _ {n - 1} = + 1 \tag {9}
$$

$$
\text {T a i l s :} \quad Z _ {n} - Z _ {n - 1} = - 1 \tag {10}
$$
...
$$
\text {N u m b e r o f w a y s t o r e a c h} i \text {t h n o d e} = \frac {n !}{(n - i) ! i !} = \binom {n} {i}
$$ where  $n! = n\times (n - 1)\times \dots \times 1$


We can construct the implied probability distribution in the binomial tree by plotting the stock price at each final period node,  $Su^{n - i}d^i$ , against the probability of reaching that

# FIGURE 8

Comparison of lognormal distribution with 25-period binomial approximation.

![](https://cdn-mineru.openxlab.org.cn/result/2025-11-29/02abefd4-2dfe-4fd1-a4bc-6204fb633ac1/873121506ff18203a2b789f8ac45454c6a840055ce19afd9f4c4ec8bbab8f408.jpg)
Lognormal Probability
Binomial Probability node. The probability of reaching any given node is the probability of one path reaching that node times the number of paths reaching that node:


$$

\text {P r o b a b i l i t y} i \text {t h n o d e} = p ^ {* n - i} \left(1 - p ^ {*}\right) ^ {i} \frac {n !}{(n - i) ! i !} \tag {12}
...
$$
\$ 41 e ^ {0. 0 8 \times 1 / 3 + 0. 3 \times \sqrt {1 / 3}} = \$ 5 0. 0 7 1
$$
