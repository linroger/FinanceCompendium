...
linter-yaml-title-alias: Technical Note No. 15 - Valuing Options on Coupon-Bearing Bonds in a One-Factor Interest Rate Model
---
...
$$
\sum_ {i = 1} ^ {n} c _ {i} \max \left[ 0, P (T, s _ {i}) - K _ {i} \right]
$$
...
$$
5 A (3, 3. 5) e ^ {- B (3, 3. 5) r} + 5 A (3, 4) e ^ {- B (3, 4) r} + 5 A (3, 4. 5) e ^ {- B (3, 4. 5) r} + 1 0 5 A (3, 5) e ^ {- B (3, 5) r}
$$

Using the expressions for  $A(t,T)$  and  $B(t,T)$ , this becomes

$$
5 \times 0. 9 9 8 8 e ^ {- 0. 4 8 7 7 r} + 5 \times 0. 9 9 5 2 e ^ {- 0. 9 5 1 6 r} + 5 \times 0. 9 8 9 5 e ^ {- 1. 3 9 2 9 r} + 1 0 5 \times 0. 9 8 1 9 e ^ {- 1. 8 1 2 7 r}
$$
