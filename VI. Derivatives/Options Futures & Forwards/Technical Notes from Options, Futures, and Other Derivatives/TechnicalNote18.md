...
$$
Q_{1} = Q_{0}[(1 + R_{0}\tau_{0})(1 + s_{c}\tau_{0})] + L(R_{0} + s_{p})\tau_{0}
$$
...
$$
Q_{2} = Q_{1}\left[(1 + R_{1}\tau_{1})(1 + s_{c}\tau_{1})\right] + L(R_{1} + s_{p})\tau_{1} \tag{1}
$$
...
$$
Q_{1}[(1 + F_{1}\tau_{1})(1 + s_{c}\tau_{1})] + L(F_{1} + s_{p})\tau_{1}
$$
...
$$
Q_{3} = Q_{2}\left[(1 + R_{2}\tau_{2})(1 + s_{c}\tau_{2})\right] + L(R_{2} + s_{p})\tau_{2} \tag{2}
$$
