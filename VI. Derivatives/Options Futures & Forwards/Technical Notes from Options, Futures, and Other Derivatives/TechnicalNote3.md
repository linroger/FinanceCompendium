...
tags:
  ...
  - derivatives_pricing
key_concepts:
  - Warrant valuation with equity dilution effects
  - Black-Scholes adjustment for warrant pricing
parent_directory: Technical Notes from Options, Futures, and Other Derivatives
cssclasses: academia
title: Technical Note 3 - Warrant Valuation When Value of Equity Plus Warrants Is Lognormal
linter-yaml-title-alias: Technical Note 3 - Warrant Valuation When Value of Equity Plus Warrants Is Lognormal
---

# Technical Note 3 - Warrant Valuation When Value of Equity Plus Warrants Is Lognormal
...
Define $V$ as the value of the company's equity (including the warrants) and $V_{T}$ as the value of $V$ at time $T$. If the warrant holders exercise, the company receives a cash inflow from the payment of the exercise price of $MK$ and the value of the company's equity increases to $V_{T} + MK$. This value is distributed among $N + M$ shares so that the share price immediately after exercise becomes
...
where $S_{0}$ is the stock price at time zero and $W$ is the warrant price at that time, so that

$$
\frac{V_{0}}{N} = S_{0} + \frac{M}{N}W
$$

The Black-Scholes formula in equation (15.20) of the book, therefore, gives the warrant price $W$ if

1. The stock price $S_{0}$ is replaced by $S_{0} + (M/N)W$.
