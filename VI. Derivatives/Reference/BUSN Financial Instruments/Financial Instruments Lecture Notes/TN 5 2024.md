...
New Portfolio Position = \(P_h = B_h + \Delta_h \times S_h = \$43.777 - 0.3821 \times 99 = \$5.941\)
...
$$
\begin{array}{l} \mathrm{Put Premium at 0,} p_{0} = P_{0} = B_{0} + \Delta_{0} \times S_{0} \\ = K \times e^{-r T} \times N(-d_{2,0}) - S_{0} \times N(-d_{1,0}) \\ \end{array}
$$
...
$$
d_{2} = d_{1} - \sigma \sqrt{T} = 0.3167 - 0.3 \sqrt{1} = 0.0167
$$
...
$$
c_{0} = S N(d_{1}) - K e^{-r T} N(d_{2}) = 100 \times 0.62425 - 100 \times e^{0.05 \times 1} \times 0.50665 = 14.2312
$$
...
$$
p_{0} = -S N(-d_{1}) + K e^{-r T} N(-d_{2}) = -100 \times 0.37575 + 100 \times e^{0.05 \times 1} \times 0.49335 = 9.3542
$$
...
$$
\begin{array}{l} c _ {0} = e ^ {- r \times T} E ^ {*} [ \max (S _ {1} - K, 0) ] \\ = e ^ {- r \times T} \times [ q ^ {*} \times \max (S _ {1, u} - K, 0) + (1 - q ^ {*}) \times \max (S _ {1, d} - K, 0) ] \\ = e ^ {- r \times T} \times q ^ {*} \times (S _ {1, u} - K) \\ = S _ {0} \times e ^ {- r \times T} \times q ^ {*} \times u - e ^ {- r \times T} \times K \times q ^ {*} \\ = S _ {0} \times N_{1} - e ^ {- r \times T} \times K \times N_{2} \\ \end{array}
$$

- where, defining by  $u_{cc}$  the annualized c.c. return from an up movement  $S_{1,u} / S_0 = e^{u_{cc}\times T} = u$

$$
N_{1} = e ^ {- r \times T} \times q ^ {*} \times u = e ^ {(u_{cc} - r) \times T} \times q ^ {*} \quad \mathrm {a n d} \quad N_{2} = q ^ {*}
$$
...
$$
\begin{array}{l} - N_{2} = N (d _ {2}) \mathrm {r i s k n e u t r a l p r o b a b i l i t y t o b e i n t h e m o n e y a t m a t u r i t y}; \\ - N_{1} = N (d _ {1}) \mathrm {r i s k n e u t r a l e x p e c t e d e x c e s s r e t u r n c o n d i t i o n a l o n e x e r c i s e a t} T. \\ \end{array}
$$
...
$$
\begin{array}{l} c _ {0} = e ^ {- r \times T} \sum_ {j = a} ^ {n} \left(\frac {n !}{j ! (n - j) !}\right) (S _ {T, j} - K) \\ = S _ {0} \times N_{1} - K \times e ^ {- r \times T} \times N_{2} \\ \end{array}
$$

$$
\mathrm {w i t h} N_{1} = \left(e ^ {- r \times T} \sum_ {j = a} ^ {n} \left(\frac {n !}{j ! (n - j) !}\right) \times u ^ {(n - j)} \times d ^ {j}\right) \quad \mathrm {a n d} N_{2} = \sum_ {j = a} ^ {n} \left(\frac {n !}{j ! (n - j) !}\right)
$$
...
* $\Longrightarrow$  Put payoff at  $T = K$  
...
![*The Capital Protected Note's Payoff*](https://cdn-mineru.openxlab.org.cn/result/2025-12-02/f0e60057-2959-4ddd-a00e-1944e3342895/0ccb0292c3157fef89cf6bc7ae909b0e6f548baf90b9ca15a34efb3b89f64e35.jpg)
...
![*Delta-Gamma Hedging: The Capital Protected Note*](https://cdn-mineru.openxlab.org.cn/result/2025-12-02/f0e60057-2959-4ddd-a00e-1944e3342895/5d2082e69439db83642e21b42a264b973cb4b0b732f9147643d9e91592b4ac56.jpg)
...
![*Example: Volatility of 4000 Call Expiring on 12/17/2021*](https://cdn-mineru.openxlab.org.cn/result/2025-12-02/f0e60057-2959-4ddd-a00e-1944e3342895/65b552763705b51c11382bed8587e4f842d621af954f88817db5d17378c58e0b.jpg)

![*Example: Volatility of 4000 Call Expiring on 12/17/2021*](https://cdn-mineru.openxlab.org.cn/result/2025-12-02/f0e60057-2959-4ddd-a00e-1944e3342895/4bac737f83943f8465e2b5f9fdd51ccdccd65753a34132a86dccb225befcc221.jpg)

![*Example: Volatility of 4000 Call Expiring on 12/17/2021*](https://cdn-mineru.openxlab.org.cn/result/2025-12-02/f0e60057-2959-4ddd-a00e-1944e3342895/5abada711ccf38e7caf54fcbef666fca0bfcc9ff810f3cd686f55e73ce54dbbd.jpg)
