...
$$
S_{0} = \frac{E[S_{1}]}{1 + R} = \frac{q \times S_{1,u} + (1 - q) \times S_{1,d}}{1 + R} = \frac{.7 \times 70 + .3 \times 35}{1.19} = 50
$$
...
$$
\begin{array}{l} E \left\{\left[ \frac{S_{1}}{S_{0}} - E \left(\frac{S_{1}}{S_{0}}\right) \right]^{2} \right\} = q \times \left(\frac{S_{1,u}}{S_{0}} - 1.19\right)^{2} + (1 - q) \times \left(\frac{S_{1,d}}{S_{0}} - 1.19\right)^{2} \\ = 0.7 \times \left(\frac{70}{50} - 1.19\right)^{2} + 0.3 \times \left(\frac{35}{50} - 1.19\right)^{2} \\ \begin{array}{rl} {{=}} & {{.1029}} \end{array} \\ \end{array}
$$
...
$$
\text{In the Up Node} = c_{1,u} = \max (S_{1,u} - K, 0) = \max (70 - 50, 0) = 20
$$

$$
\text{In the Down Node} = c_{1,d} = \max (S_{1,d} - K, 0) = \max (35 - 50, 0) = 0
$$
...
$$
\text{In the Up Node} = P_{1,u} = \Delta \times S_{1,u} + B_{0} \times e^{r} = 0.5714 \times 70 - 20 = 20
$$

$$
\text{In the Down Node} = P_{1,d} = \Delta \times S_{1,d} + B_{0} \times e^{r} = 0.5714 \times 35 - 20 = 0
$$
...
- $\Rightarrow$ its value at time $i = 0$ must then be the simple riskless present value $PV(\Pi_{1,u})$, i.e.:
...
$$
B_{0} = \Pi_{0} = e^{-rT} \Pi_{1,u} = e^{-rT} \left(c_{1,u} - \Delta \times S_{1,u}\right)
$$
...
$$
c_{1,u} = \max \left(70 - 50, 0\right) = 20
$$
...
$$
c_{1,d} = \max \left(35 - 50, 0\right) = 0
$$

$$
\Longrightarrow \Delta = \frac{c_{1,u} - c_{1,d}}{S_{1,u} - S_{1,d}} = \frac{20 - 0}{70 - 35} = 0.5714
$$
...
$$
- \Longrightarrow p_{1,u} = 0 \text{ and } p_{1,d} = \max (K - S_{1,d}, 0) = 15
$$
...
$$
\begin{array}{l} - \Rightarrow P_{1,u} = \Delta \times S_{1,u} + e^{r} B_{0} = 0, \text{or} \\ - \Longrightarrow P_{1,d} = \Delta \times S_{1,d} + e^{r} B_{0} = 15. \\ \end{array}
$$
...
$$
c_{0} = e^{-r \times T} \times E^{*} [ c_{1} ] = e^{-.11} \times [ q^{*} \times 20 + (1 - q^{*}) \times 0 ] = 10.6547
$$

3. Put Price:

$$
p_{0} = e^{-r \times T} \times E^{*} [ p_{1} ] = e^{-.11} \times [ q^{*} \times 0 + (1 - q^{*}) \times 15 ] = 5.4464
$$

4. Forward contract to deliver at $K = 50$

$$
f_{0} = e^{-r \times T} \times E^{*} [ K - S_{1} ] = e^{-.11} \times [ q^{*} \times (50 - 70) + (1 - q^{*}) \times (50 - 35) ] = -5.2083
$$
...
$$
\text{Cash Flow at } T_{i} = (S_{T_{i}} - K)
$$

- The value of the swap at time zero can be computed using the risk neutral pricing formula

$$
\begin{array}{l} V_{0}^{swap} = \text{Present Value (using } r) \text{ of Expected Future Cash Flows (using } q^*) \\ = e^{-r \times T_{1}} \times E^* [ S_{T_{1}} - K ] + e^{-r \times T_{2}} \times E^* [ S_{T_{2}} - K ] + \ldots + e^{-r \times T_{n}} \times E^* [ S_{T_{n}} - K ] \\ \end{array}
$$

- From Risk Neutral Pricing formula, we know $F_{0,T_i} = E^*[S_{T_i}]$

$$
V_{0}^{swap} = e^{-r \times T_{1}} \times [ F_{0, T_{1}} - K ] + e^{-r \times T_{2}} \times [ F_{0, T_{2}} - K ] + \ldots + e^{-r \times T_{n}} \times [ F_{0, T_{n}} - K ]
$$
...
- Current Exchange Rate $M_0 = 1.3375 = \text{USD} / \text{EUR}$
...
- Notice in fact that if the risk premium $\mu - r_{\$}$ is negative (e.g. if the Euro moves inversely with the US stock market) then we may well have

$$
F_{0, 1} = e^{-(\mu - r_{\$}) T} E [ M_{1} ] = 1.3506 > M_{0} \quad \text{but} \quad E [ M_{1} ] \leq M_{0}
$$
...
$$
\begin{array}{l} i = 0 \\ i = 1 \\ i = 2 \\ S_{2, uu} = 100 \\ \end{array}
$$
...
$$
\begin{array}{c} S_{2, ud} \\ S_{2, du} \end{array} = 50
$$
...
$$
\Delta_{1,u} = (50 - 0) / (100 - 50) = 1
$$

$$
B_{1,u} = e^{-r} \left(c_{2, uu} - \Delta_{1,u} S_{2, uu}\right) = -44.7917
$$

$$
c_{1,u} = \Delta_{1,u} \times S_{1,u} + B_{1,u} = 25.2083
$$
...
$$
\Delta_{1,d} = (0 - 0) / (50 - 25) = 0
$$

$$
B_{1,d} = e^{-r} \left(c_{2, dd} - \Delta_{1,d} S_{2, dd}\right) = 0
$$
...
$$
\Delta_{0} = (25.2083 - 0) / (70 - 35) = 0.7202
$$

$$
B_{0} = e^{-r} \times (c_{1,u} - \Delta_{0} \times S_{1,u}) = -22.5824
$$

$$
c_{0} = \Delta_{0} \times S_{0} + B_{0} = 13.4294
$$
...
$$
q_{1,u}^* = (70 e^{r} - 50) / (100 - 50) = 0.5628
$$

$$
c_{1,u} = e^{-r} \times q_{1,u}^* \times c_{2, uu} = 25.2083
$$
...
$$
V_{i, j} = e^{-r \times h} \times E^* [ V_{i + 1} | (\text{time}, \text{node}) = (i, j) ]
$$
...
$$
V_0 = e^{-r \times T} \times E^* [ \text{Payoff at} T ]
$$

- In previous example,

$$
\begin{array}{l} * \operatorname{Pr} (S_{2,uu}) = q_0^* \times q_{1,u}^* = 0.3347; \\ * \operatorname{Pr} (S_{2,ud}) = q_0^* \times (1 - q_{1,u}^*) + (1 - q_0^*) * q_{1,d} = 0.4881; \text{and} \\ * \operatorname{Pr} (S_{2,dd}) = 0.1772 \\ \end{array}
$$

- Thus, the price of the call option with strike  $K = 50$  is

$$
c_0 = e ^ {-. 1 1 \times 2} \times 0.3347 \times (1 0 0 - 5 0) = 13.4294
$$

- The price of a put is

$$
p_0 = e^{-0.11 \times 2} \times 0.1772 \times (5 0 - 2 5) = 3.555.
$$

- The price of a short forward

$$
f_0 = e^{-0.11 \times 2} \left[ 0.3347 \times (5 0 - 1 0 0) + 0.4881 \times (5 0 - 5 0) + 0.1772 \times (5 0 - 2 5) \right] = -9.8741
$$
...
$$
E \left[ \frac {S_{t+h}}{S_t} \right] = e ^ {\mu \times h}; \quad \text{and} \quad E \left[ \left(\frac {S_{t+h}}{S_t} - e \mu h\right) ^ {2} \right] = \sigma^2 \times h
$$
...
* $\Rightarrow$ $i \times h = \text{calendar time on the tree.}$
...
$$
S_{i+1} = \left\{ \begin{array}{l l} S_i \times u & \text {w i t h p r o b a b i l i t y} q \\ S_i \times d & \text {w i t h p r o b a b i l i t y} 1 - q \end{array} \right. \tag {1}
$$
...
$$
u = e ^ {\sigma \times \sqrt {h}}; d = 1 / u; \text{and} q = \frac {e ^ {\mu \times h} - d}{u - d}.
$$
...
<table><tr><td></td><td colspan="2">Stock Assumption</td><td colspan="3">Option Assumption</td><td colspan="3">Tree</td><td colspan="3">Risk Neutral Prob</td></tr><tr><td></td><td>mu</td><td>0.1</td><td>T</td><td colspan="2">0.1</td><td>n</td><td colspan="2">10</td><td>q*</td><td colspan="2">0.495834</td></tr><tr><td></td><td>sigma</td><td>0.3</td><td>K</td><td colspan="2">100</td><td>h</td><td colspan="2">0.01</td><td></td><td></td><td></td></tr><tr><td></td><td>r</td><td>0.02</td><td>Call or Put</td><td colspan="2">1 (=1 for call</td><td>u</td><td colspan="2">1.030455</td><td>Price Binomial</td><td colspan="2">3.787</td></tr><tr><td></td><td>q</td><td>0</td><td></td><td colspan="2"></td><td>d</td><td colspan="2">0.970446</td><td>Delta Binomial</td><td colspan="2">0.527</td></tr><tr><td></td><td>S0</td><td>100</td><td></td><td colspan="2"></td><td>p</td><td colspan="2">0.509173</td><td></td><td></td><td></td></tr><tr><td rowspan="2">time =&gt; i=&gt;</td><td>0</td><td>0.01</td><td>0.02</td><td>0.03</td><td>0.04</td><td>0.05</td><td>0.06</td><td>0.07</td><td>0.08</td><td>0.09</td><td>0.1</td></tr><tr><td>0</td><td>1</td><td>2</td><td>3</td><td>4</td><td>5</td><td>6</td><td>7</td><td>8</td><td>9</td><td>10</td></tr><tr><td>0</td><td>100.000</td><td>103.045</td><td>106.184</td><td>109.417</td><td>112.750</td><td>116.183</td><td>119.722</td><td>123.368</td><td>127.125</td><td>130.996</td><td>134.986</td></tr><tr><td>1</td><td></td><td>97.045</td><td>100.000</td><td>103.045</td><td>106.184</td><td>109.417</td><td>112.750</td><td>116.183</td><td>119.722</td><td>123.368</td><td>127.125</td></tr><tr><td>2</td><td></td><td></td><td>94.176</td><td>97.045</td><td>100.000</td><td>103.045</td><td>106.184</td><td>109.417</td><td>112.750</td><td>116.183</td><td>119.722</td></tr><tr><td>3</td><td></td><td></td><td></td><td>91.393</td><td>94.176</td><td>97.045</td><td>100.000</td><td>103.045</td><td>106.184</td><td>109.417</td><td>112.750</td></tr><tr><td>4</td><td></td><td></td><td></td><td></td><td>88.692</td><td>91.393</td><td>94.176</td><td>97.045</td><td>100.000</td><td>103.045</td><td>106.184</td></tr><tr><td>5</td><td></td><td></td><td></td><td></td><td></td><td>86.071</td><td>88.692</td><td>91.393</td><td>94.176</td><td>97.045</td><td>100.000</td></tr><tr><td>6</td><td></td><td></td><td></td><td></td><td></td><td></td><td>83.527</td><td>86.071</td><td>88.692</td><td>91.393</td><td>94.176</td></tr><tr><td>7</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>81.058</td><td>83.527</td><td>86.071</td><td>88.692</td></tr><tr><td>8</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>78.663</td><td>81.058</td><td>83.527</td></tr><tr><td>9</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>76.338</td><td>78.663</td></tr><tr><td>10</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td>74.082</td></tr></table>
...
$$
c_{n,j} = \max (S_{n,j} - K, 0) \quad \text{for} \quad j = 0, 1, \ldots , n
$$
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-02/f758450d-04ae-44e9-9aa5-2572b902ed6a/47a525dcceed6d9534aa33b092090c700acda3331b77a7f11c0da4cd3e32dbf6.jpg)  
BINOMIAL TREE MODEL
...
$$
\operatorname{Pr} \left(\text{node} = j \text{at} T = n \times h\right) = \left(\frac {n!}{j! (n - j) !}\right) \times (q^*) ^ {n - j} \times (1 - q^*) ^ {j}
$$
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-02/f758450d-04ae-44e9-9aa5-2572b902ed6a/126c0c42fbd815409bba541518568eee6037278bd5091d0eb6b7028e0454b827.jpg)

$$
\operatorname{Pr} \left(j = 0 \text{at} T = n \times h\right) = \left(\frac {3!}{0! \times 3!}\right) \times (q^*) ^ {3} \times (1 - q^*) ^ {0} = (q^*) ^ {3}
$$

$$
\operatorname{Pr} \left(j = 1 \text{at} T = n \times h\right) = \left(\frac {3 \times 2}{1 \times 2}\right) \times (q^*) ^ {2} \times (1 - q^*) = 3 (q^*) ^ {2} (1 - q^*)
$$
...
![](https://cdn-mineru.openxlab.org.cn/result/2025-12-02/f758450d-04ae-44e9-9aa5-2572b902ed6a/5b30605977f64896de7b883537f042cf63c42560cfe116c2de96eb3697cbef65.jpg)

## Multi Step Trees: Probability Distribution of  $S_T$

- Or, plotting the probability density with respect to  $\log(S_T)$ , we obtain

![](https://cdn-mineru.openxlab.org.cn/result/2025-12-02/f758450d-04ae-44e9-9aa5-2572b902ed6a/91281ec88f55d35b0fe291c686d294f76b880ce9400d315d6d3c7a7d2f6ef18d.jpg)  
Log Stock Price
...
$$
c = E^* \left[ e ^ {- r T} \max (S_T - K, 0) \right] = \sum_{j=1}^n e ^ {- r T} \max (S_{n,j} - K, 0) Q_{n,j}^*
$$
...
$$
c = \int_0^{\infty} e ^ {- r T} \max (S_T - K, 0) f (S_T) d S_T
$$
