...
$$
\begin{array}{l} \Rightarrow K / S <   1 \Rightarrow K <   S \Rightarrow \text{puts are OTM}, \text{calls are ITM} \\ \Rightarrow K / S > 1 \Rightarrow K > S \Rightarrow \text{puts are ITM}, \text{calls are OTM} \\ \end{array}
$$
...
$$
\sigma_ {I m p} \quad \text{is chosen such that} \quad p u t^{m k t} (K, T) = B S P (S_{0}, K, T, r, q, \sigma_ {I m p})
$$
...
$$
\log \left(\frac {S_{t , t + h}}{S_{t}}\right) = \mu h + S_{t}^{\alpha} \times \Sigma \times \epsilon_{t}
$$
...
$$
R_{t, t + h} = \mu h + \sqrt {v_{t}} \times \epsilon_{1, t}
$$
...
$$
R_{t, t + h} = \mu h + \sigma \times \epsilon_{t} + \omega \times Q_{t}
$$
...
$$
- S_{2,uu}, S_{2,ud} = S_{2,du} \text{and} S_{2,dd}.
$$
...
$$
p_{0}^{1} = 50.2 = p^{mkt} (1550,.21)
$$

$$
p_{0}^{2} = 14.65 = p^{mkt} (1450,.21)
$$
