...
$$
\mathrm {V a r} [ F ] = \mathrm {E} [ \Delta F ^ {2} ] = \frac {1 + 1 + 1 + 1 + 1 + 1 + 1 + 4 9}{8} = \frac {5 6}{8} = 7.
$$
...
$$
v (x _ {1}, x _ {2}) = A x _ {1} ^ {a} x _ {2} ^ {b}
$$
...
$$
M R S (c x _ {1}, x _ {2}) = - \frac {d x _ {2}}{d x _ {1}} = \frac {\frac {\partial v (x _ {1} , x _ {2})}{\partial x _ {1}}}{\frac {\partial v (x 1 , x _ {2})}{\partial x _ {1}}}.
$$
...
with probabilities  $(\frac{1}{6}, \frac{1}{3}, \frac{1}{4}, \frac{1}{4})$  which gives  $E[B \cdot \epsilon] = 0$ . In this case the two variables  $B$  and  $\epsilon$  are said to be orthogonal. Since  $E[\epsilon] = 0$ , the covariance is zero and  $B$  and  $\epsilon$  are uncorrelated.
