...
cssclasses:
  - academia
linter-yaml-title-alias: Exotic Options
---
...
$$
x \mathrm {I n t r i n s i c v a l u e} = \left\{ \begin{array}{l l} X - \min  [ S ^ {1}, S ^ {2} ] & \text {i f} \min  [ S ^ {1}, S ^ {2} ] \leq X \\ 0 & \text {i f} \min  [ S ^ {1}, S ^ {2} ] > X. \end{array} \right.
$$
