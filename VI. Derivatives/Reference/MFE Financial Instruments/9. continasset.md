...
formatted: "2025-12-20 18:55:00 PM"
formatter_model: "opencode"
cli-tool: "opencode"
primary_tags: ["asset price dynamics", "stochastic processes", "geometric brownian motion"]
secondary_tags: ["continuously compounded return", "wiener process", "ito calculus", "martingale", "markov property", "random walk", "lognormal distribution", "efficient markets hypothesis", "variance", "standard deviation"]
---
...
$$
\begin{array}{l} d F = \left(e ^ {r (T - t)} \mu S (t) - r S (t) e ^ {r (T - t)}\right) d t + \sigma S (t) e ^ {r (T - t)} d z \\ = (\mu - r) S (t) e ^ {r (T - t)} d t + \sigma S (t) e ^ {r (T - t)} d z \\ = (\mu - r) F (t) d t + \sigma F (t) d z. \\ \end{array}
$$
