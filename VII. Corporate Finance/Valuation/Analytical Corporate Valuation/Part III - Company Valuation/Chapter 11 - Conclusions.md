...
$$
W _ {F} = \sum_ {t = 1} ^ {\infty} \frac {C F _ {t}}{\left(1 + k\right) ^ {t}} \tag {11.1}
$$
...
$$
W _ {F} = \sum_ {t = 1} ^ {n} \frac {C F _ {t}}{(1 + K) ^ {t}} + \frac {T V _ {n}}{(1 + K) ^ {n}} \tag {11.2}
$$
...
$$
W _ {F} = \sum_ {t = 1} ^ {n} \frac {C F _ {t}}{(1 + K) ^ {t}} + \frac {T V _ {n}}{(1 + K) ^ {n}} \rightarrow\begin{array}{l}E q u i t y S i d e \rightarrow W _ {E} = \sum_ {t = 1} ^ {n} \frac {F C F E _ {t}}{\left(1 + K _ {E}\right) ^ {t}} + \frac {T V _ {n}}{\left(1 + K _ {E}\right) ^ {n}}\\A s s e t S i d e \rightarrow W _ {A} = \sum_ {t = 1} ^ {n} \frac {F C F O _ {t}}{\left(1 + K _ {A}\right) ^ {t}} + \frac {T V _ {n}}{\left(1 + K _ {A}\right) ^ {n}}\end{array}\tag {11.3}
$$
