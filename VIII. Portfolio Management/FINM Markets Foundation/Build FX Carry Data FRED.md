...
```
    ...
    Input In [2], in <cell line: 6>()
          3 TICKS_FX = ['DEXUSUK','DEXUSEU','DEXSZUS','DEXJPUS']
          4 TICKS_RF = ['USD1MTD156N','GBP1MTD156N','EUR1MTD156N','CHF1MTD156N','JPY1MTD156N']
    ----> 6 rfraw = pdr.DataReader(TICKS_RF,data_source='fred', start=START_DATE,end=END_DATE)
          7 fxraw = pdr.DataReader(TICKS_FX,data_source='fred', start=START_DATE,end=END_DATE)


    File ~/Projects/FINM/finm-portfolio-2022/venv/lib/python3.9/site-packages/pandas/util/_decorators.py:207, in deprecate_kwarg.<locals>._deprecate_kwarg.<locals>.wrapper(*args, **kwargs)
        205     else:
        206         kwargs[new_arg_name] = new_arg_value
    --> 207 return func(*args, **kwargs)


    File ~/Projects/FINM/finm-portfolio-2022/venv/lib/python3.9/site-packages/pandas_datareader/data.py:449, in DataReader(name, data_source, start, end, retry_count, pause, session, api_key)
        446     return EnigmaReader(dataset_id=name, api_key=api_key).read()
        448 elif data_source == "fred":
    --> 449     return FredReader(
        450         symbols=name,
        451         start=start,
        452         end=end,
        453         retry_count=retry_count,
        454         pause=pause,
        455         session=session,
        456     ).read()
        458 elif data_source == "famafrench":
        459     return FamaFrenchReader(
        460         symbols=name,
        461         start=start,
       (...)
        465         session=session,
    ...
    File ~/Projects/FINM/finm-portfolio-2022/venv/lib/python3.9/site-packages/pandas_datareader/fred.py:27, in FredReader.read(self)
         18 """Read data
         19 
         20 Returns
       (...)
    ...
    File ~/Projects/FINM/finm-portfolio-2022/venv/lib/python3.9/site-packages/pandas_datareader/fred.py:62, in FredReader._read(self)
         55             raise IOError(
    ...
    File ~/Projects/FINM/finm-portfolio-2022/venv/lib/python3.9/site-packages/pandas_datareader/fred.py:62, in <listcomp>(.0)
         55             raise IOError(
         56                 "Failed to get the data. Check that "
         57                 "{0!r} is a valid FRED series.".format(name)
         58             )
    ...
    File ~/Projects/FINM/finm-portfolio-2022/venv/lib/python3.9/site-packages/pandas_datareader/fred.py:41, in FredReader._read.<locals>.fetch_data(url, name)
    ...
    File ~/Projects/FINM/finm-portfolio-2022/venv/lib/python3.9/site-packages/pandas_datareader/base.py:119, in _BaseReader._read_url_as_StringIO(self, url, params)
