...
- `formatter_model`: model used to format document (e.g., claude-3-5-sonnet-20241022, gpt-4o, etc.)
- `cli-tool`: tool used for formatting (e.g., claude-code, github-copilot)
