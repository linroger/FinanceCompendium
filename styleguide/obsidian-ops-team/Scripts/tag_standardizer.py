...
class TagStandardizer:
    def __init__(self, vault_path):
        ...
        self.standard_mappings = {
            ...
            # Advanced financial concepts standardization
            # Mathematical Finance
            'stochastic-processes': 'mathematical-finance/stochastic-processes',
            'Stochastic Processes': 'mathematical-finance/stochastic-processes',
            'ito-calculus': 'mathematical-finance/ito-calculus',
            'Ito Calculus': 'mathematical-finance/ito-calculus',
            'girsanov-theorem': 'mathematical-finance/girsanov-theorem',
            'martingale-theory': 'mathematical-finance/martingale-theory',
            'risk-neutral-pricing': 'mathematical-finance/risk-neutral-pricing',
            
            # Quantitative Methods
            'monte-carlo': 'quantitative-methods/monte-carlo',
            'Monte Carlo': 'quantitative-methods/monte-carlo',
            'finite-difference': 'quantitative-methods/finite-difference',
            'binomial-trees': 'quantitative-methods/binomial-trees',
            'quantlib': 'quantitative-methods/quantlib',
            'QuantLib': 'quantitative-methods/quantlib',
            'pde-solving': 'quantitative-methods/pde-solving',
            'numerical-methods': 'quantitative-methods/numerical-methods',
            
            # Advanced Models
            'black-scholes-merton': 'models/black-scholes-merton',
            'heston-model': 'models/heston',
            'vasicek-model': 'models/vasicek',
            'cox-ingersoll-ross': 'models/cox-ingersoll-ross',
            'hull-white': 'models/hull-white',
            
            # Professional Standards
            'jp-morgan-training': 'professional/jp-morgan-training',
            'JP Morgan': 'professional/jp-morgan-training',
            'institutional-quality': 'professional/institutional-quality',
            'zero-tolerance-errors': 'professional/standards',
            'three-statement-modeling': 'professional/modeling',
            'gaap-considerations': 'professional/accounting',
            
            # Regulatory Frameworks
            'basel-iii': 'regulatory/basel-iii',
            'Basel III': 'regulatory/basel-iii',
            'dodd-frank': 'regulatory/dodd-frank',
            'mifid-ii': 'regulatory/mifid-ii',
            'post-libor': 'regulatory/post-libor',
            'sofr': 'regulatory/sofr',
            'sonia': 'regulatory/sonia',
            'ifrs-9': 'regulatory/ifrs-9',
            'cecl': 'regulatory/cecl',
            
            # Risk Management
            'value-at-risk': 'risk-management/var',
            'VaR': 'risk-management/var',
            'expected-shortfall': 'risk-management/expected-shortfall',
            'coherent-risk-measures': 'risk-management/coherent-measures',
            'crash-risk': 'risk-management/crash-risk',
            'stress-testing': 'risk-management/stress-testing',
            'ccar': 'risk-management/ccar',
            
            # Contemporary Markets
            'esg-integration': 'contemporary/esg',
            'ESG': 'contemporary/esg',
            'digital-currency': 'contemporary/digital-currency',
            'cryptocurrency': 'contemporary/cryptocurrency',
            'defi': 'contemporary/defi',
            'machine-learning-finance': 'contemporary/machine-learning',
            'behavioral-finance': 'contemporary/behavioral-finance',
            
            # Classic Finance
            'dcf': 'finance/valuation/dcf',
            'DCF': 'finance/valuation/dcf',
            'capm': 'finance/portfolio/capm',
            'CAPM': 'finance/portfolio/capm',
            'portfolio-theory': 'finance/portfolio/theory',
            'efficient-frontier': 'finance/portfolio/efficient-frontier',
            'sharpe-ratio': 'finance/portfolio/sharpe-ratio',
            
            # Case Studies
            'precision-castparts': 'case-study/precision-castparts',
            'warren-buffett': 'case-study/warren-buffett',
            'Warren Buffett': 'case-study/warren-buffett',
            'bmw-valuation': 'case-study/bmw-valuation',
            'BMW': 'case-study/bmw-valuation',
            'agency-theory': 'case-study/agency-theory',
            'debt-crisis': 'case-study/debt-crisis',
            'chinese-financial-system': 'case-study/chinese-financial-system',
            ...
            'course': 'course',
            'Course': 'course',
            'advanced-investments': 'course/advanced-investments',
            'financial-analysis': 'course/financial-analysis', 
            'international-finance': 'course/international-finance',
            'credit-markets': 'course/credit-markets',
            'financial-markets-institutions': 'course/financial-markets-institutions',
            'mathematical-finance': 'course/mathematical-finance',
            'quantitative-trading': 'course/quantitative-trading',
            
            'graduate-level': 'academic/graduate-level',
            'institutional-research': 'academic/institutional-research',
            'academic-rigor': 'academic/rigor',
            'pedagogical-design': 'academic/pedagogical-design',
            'top-tier-business-school': 'academic/top-tier',
            
            'professional-training': 'professional/training',
            'analyst-training': 'professional/analyst-training',
            'industry-standard': 'professional/industry-standard',
            
            'case-study': 'case-study',
            'Case Study': 'case-study',
            'lecture': 'lecture',
            'Lecture': 'lecture',
            'primer': 'reference/primer',
            'Primer': 'reference/primer',
...
def main():
    ...
    parser.add_argument('--vault', default='/Users/rogerlin/Reserve/VoyageNotes',
    ...
    parser.add_argument('--output', 
                       default='/Users/rogerlin/Reserve/VoyageNotes/obsidian-ops-team/Tag_Analysis_Report.md',
